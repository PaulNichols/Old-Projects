...
<System.Web.Services.WebService(Namespace:="http://www.Accuride.com/SalesMarketCodeService")> _
Public Class SalesMarketCodeService
...
#Region " Web Services Designer Generated Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.SqlDataAdapter1.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "ps_Select_SalesMarketCode", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("MarketDescription", "MarketDescription"), New System.Data.Common.DataColumnMapping("MarketCode", "MarketCode"), New System.Data.Common.DataColumnMapping("Inactive", "Inactive"), New System.Data.Common.DataColumnMapping("ModifiedBy", "ModifiedBy"), New System.Data.Common.DataColumnMapping("ModifiedDate", "ModifiedDate"), New System.Data.Common.DataColumnMapping("SalesMarketCodeId", "SalesMarketCodeId")}), New System.Data.Common.DataTableMapping("Table1", "Table1", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("MarketDescription", "MarketDescription"), New System.Data.Common.DataColumnMapping("MarketCode", "MarketCode"), New System.Data.Common.DataColumnMapping("Inactive", "Inactive"), New System.Data.Common.DataColumnMapping("ModifiedBy", "ModifiedBy"), New System.Data.Common.DataColumnMapping("ModifiedDate", "ModifiedDate"), New System.Data.Common.DataColumnMapping("SalesMarketCodeId", "SalesMarketCodeId")})})
        Me.SqlDataAdapter1.UpdateCommand = Me.SqlUpdateCommand1
        '
        'SqlSelectCommand1
        '
        Me.SqlSelectCommand1.CommandText = "[ps_Select_SalesMarketCode]"
        ...
        Me.SqlSelectCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Select_SalesMarketCodeId", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input,True, CType(10, Byte), CType(0, Byte),"SalesMarketCodeId",System.Data.DataRowVersion.Current, Nothing))
        Me.SqlSelectCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@LoadCombo", System.Data.SqlDbType.Bit, 1))
        '
        'SqlInsertCommand1
        '
        Me.SqlInsertCommand1.CommandText = "[ps_Insert_SalesMarketCode]"
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@MarketCode", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input, True, CType(10, Byte), CType(10, Byte), "MarketCode", System.Data.DataRowVersion.Current, Nothing))
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@MarketDescription", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input, True, CType(10, Byte), CType(10, Byte), "MarketDescription", System.Data.DataRowVersion.Current, Nothing))
        ...
        'SqlUpdateCommand1
        '
        Me.SqlUpdateCommand1.CommandText = "[ps_Update_SalesMarketCode]"
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@MarketCode", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input, True, CType(10, Byte), CType(10, Byte), "MarketCode", System.Data.DataRowVersion.Current, Nothing))
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@MarketDescription", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input, True, CType(10, Byte), CType(10, Byte), "MarketDescription", System.Data.DataRowVersion.Current, Nothing))
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_MarketCode", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input,True, CType(10, Byte), CType(10, Byte),"MarketCode",System.Data.DataRowVersion.Original, Nothing))
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_MarketDescription", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input,True, CType(10, Byte), CType(10, Byte),"MarketDescription",System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Select_SalesMarketCodeId", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input,True, CType(10, Byte), CType(0, Byte),"SalesMarketCodeId",System.Data.DataRowVersion.Current, Nothing))
        '
        'SqlDeleteCommand1
        '
        Me.SqlDeleteCommand1.CommandText = "[ps_Delete_SalesMarketCode]"
        ...
        Me.SqlDeleteCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_MarketCode", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "MarketCode", System.Data.DataRowVersion.Original, Nothing))
        Me.SqlDeleteCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_MarketDescription", System.Data.SqlDbType.VarChar, 250, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "MarketDescription", System.Data.DataRowVersion.Original, Nothing))
        Me.SqlDeleteCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Select_SalesMarketCodeId", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, True, CType(10, Byte), CType(0, Byte), "SalesMarketCodeId", System.Data.DataRowVersion.Current, Nothing))
        '
        'SqlConnection1
        '
...
#End Region
    ...
    Public Function LoadData(ByVal pudtParams() As System.Object) As System.Data.DataSet Implements IEPS_Service_Data.LoadData
        SqlDataAdapter1.SelectCommand.Parameters("@Select_SalesMarketCodeId").Value = CType(pudtParams(0), Int32)
	...
	Public Overrides Sub AssignFields()
		With Fields
			.Add("MarketDescription", New FieldInfoStructure("MarketDescription", 250, False, False))
			.Add("MarketCode", New FieldInfoStructure("MarketCode", 250, False, False))
			...
			.Add("SalesMarketCodeId", New FieldInfoStructure("SalesMarketCodeId", 10, False, False))
		End With
	End Sub
End Class
