...
namespace Grid_Demo
{
	...
	/// </summary>
	[Serializable]
	public class SomethingCollection : ICollection, IList, IEnumerable, ICloneable
	{
		...
		#region SomethingCollection

		/// <summary>
		/// Fund collection constructor
		/// </summary>
		public SomethingCollection()
		{ }

		/// <summary>
		/// Fund collection overloaded constructor
		/// </summary>
		public SomethingCollection(SomethingCollection collection)
		{ 
			AddRange(collection); 
		}
		...
		/// Fund collection overloaded constructor
		/// </summary>
		public SomethingCollection(T[] array)
		{ 
			AddRange(array); 
		}

		#endregion SomethingCollection
		...
		/// <summary>
		/// Copies all the SomethingCollection in the collection to the specified target object
		/// </summary>
		...
		/// </summary>
		/// <returns></returns>
		public SomethingCollection Clone()
		{
			SomethingCollection tc = new SomethingCollection();
			tc.AddRange(this);
		...
		/// <summary>
		/// Add a new range of SomethingCollection from a SomethingCollection collection
		/// </summary>
		/// <param name="collection"></param>
		public void AddRange(SomethingCollection collection)
		{
		...
		/// <summary>
		/// Add a new range of SomethingCollection from an array
		/// AddRange Overload
		/// </summary>
		/// <param name="array"></param>
		...
		*/
		...
		{
			private SomethingCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(SomethingCollection tc)
			{
				m_collection = tc;
				m_index = -1;
