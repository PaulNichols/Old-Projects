...
namespace HBOS.FS.AMP.Windows.Controls
{
	...
	public class DataGridBool1ClickColumn : DataGridBoolColumn, ICustomDataGridColumn
	{
		...
		{
			get { return m_canCheck; }
			set { m_canCheck = value; }
		}
		...
		{
			get { return m_canUnCheck; }
			set { m_canUnCheck = value; }
		}
		...
		protected override void SetColumnValueAtRow(CurrencyManager source, int rowNum, object cellValue)
		{
			try
			{
				...
				if (this.ReadOnly == false)
				{
					...
					if (currentValue == true)
					{
						if (this.CanUnCheck)
						{
							CheckBoxEventArgs checkBoxEventArgs = new CheckBoxEventArgs(rowNum, columnNumber, System.Windows.Forms.DataGrid.HitTestType.Cell, currentValue, !currentValue);
		...
		{
			get { return m_toolTipProperty; }
			set { m_toolTipProperty = value; }
		}
