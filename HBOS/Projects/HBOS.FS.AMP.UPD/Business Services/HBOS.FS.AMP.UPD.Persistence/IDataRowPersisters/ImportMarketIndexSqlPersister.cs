...
namespace HBOS.FS.AMP.UPD.Persistence
{
	...
	public class ImportMarketIndexSqlPersister : SqlWithParentPersister
	{
		...
		public ImportMarketIndexSqlPersister( string connectionString , string persistingStoredProcedure , string parentParameterName , Snapshot snapshot , string companyCode , DateTime valuationPoint ) : base( connectionString , persistingStoredProcedure , parentParameterName , snapshot.Id  )
		{
