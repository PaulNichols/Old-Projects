...
[assembly: AssemblyTitle("Unit Pricing and Distribution Exception Source Setup")]
[assembly: AssemblyDescription("Unit Pricing and Distribution Exception Source Setup")]
#if (DEBUG)
...
// Needed to setup the registry entries for the event log sources
[assembly:RegistryPermission(SecurityAction.RequestMinimum, Unrestricted=true)]
// Needed to write the log files
