...
{
	/// <summary>
	/// Summary description for AssetFundStaticDataBuilder.
	/// </summary>
	public class AssetFundStaticDataBuilder : IStaticDataBuilder
	{
		/// <summary>
		/// Creates a new <see cref="AssetFundStaticDataBuilder"/> instance.
		/// </summary>
		public AssetFundStaticDataBuilder()
		{
			T.E();
			T.X();
		}
		...
		{
			T.E();
			editor = new AssetFundStaticDataEditor();
			T.X();
			return editor;
		}

		private AssetFundStaticDataEditor editor;
		...
		{
			T.E();
			IList assetFunds = AssetFundController.LoadAssetFundLookupsByCompany(GlobalRegistry.ConnectionString,GlobalRegistry.CompanyCode);
			listManager.RefreshContents(assetFunds);

			if (assetFunds.Count==0)
			{
				editor.newExecuted(null,null);
			}
			T.X();
		}
