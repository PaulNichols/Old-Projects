...
namespace HBOS.FS.AMP.UPD.WinUI.Reports.Schemas {
    ...
    public class FundDriftDataset : DataSet {
        ...
        public class AssetFundDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private DataColumn columnCurrentValuationDate;
            ...
            internal DataColumn CurrentValuationDateColumn {
                get {
                    return this.columnCurrentValuationDate;
                }
            }
            ...
            internal void InitVars() {
                ...
                this.columnCurrentValuationDate = this.Columns["CurrentValuationDate"];
            }
            ...
            private void InitClass() {
                ...
                this.columnCurrentValuationDate = new DataColumn("CurrentValuationDate", typeof(string), null, System.Data.MappingType.Attribute);
                this.Columns.Add(this.columnCurrentValuationDate);
                ...
                this.columnCurrentValuationDate.Namespace = "http://tempuri.org/Dataset1.xsd";
            }
        ...
        public class AssetFundRow : DataRow {
            ...
            public string CurrentValuationDate {
                get {
                    try {
                        return ((string)(this[this.tableAssetFund.CurrentValuationDateColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableAssetFund.CurrentValuationDateColumn] = value;
                }
            }
            ...
            public bool IsCurrentValuationDateNull() {
                return this.IsNull(this.tableAssetFund.CurrentValuationDateColumn);
            }
            
            public void SetCurrentValuationDateNull() {
                this[this.tableAssetFund.CurrentValuationDateColumn] = System.Convert.DBNull;
            }
        }
