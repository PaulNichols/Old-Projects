...
namespace HBOS.FS.AMP.UPD.Types.AssetFunds
{
	...
	/// </summary>
	[Serializable]
	public class PriceFileCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
	{
		...
		#region PriceFileCollection

		/// <summary>
		/// Asset Fund collection constructor
		/// </summary>
		public PriceFileCollection()
		{
		}
		...
		/// </summary>
		public PriceFileCollection(PriceFileCollection collection)
		{
			AddRange(collection);
		}
		...
		/// </summary>
		public PriceFileCollection(T[] array)
		{
			AddRange(array);
		}

		#endregion PriceFileCollection
		...
		/// </summary>
		/// <returns></returns>
		public PriceFileCollection Clone()
		{
			PriceFileCollection tc = new PriceFileCollection();
			tc.AddRange(this);
		...
		public void AddRange(PriceFileCollection collection)
		{
...
//        }
        ...
        */
		...
		{
			private PriceFileCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(PriceFileCollection tc)
			{
				m_collection = tc;
				m_index = -1;
