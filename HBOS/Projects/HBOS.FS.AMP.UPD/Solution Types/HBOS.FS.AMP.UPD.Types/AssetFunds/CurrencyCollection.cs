...
namespace HBOS.FS.AMP.UPD.Types.AssetFunds
{
    ...
    // Create the template
    using T = HBOS.FS.AMP.UPD.Types.AssetFunds.Currency;
    
    /// <summary>
    /// Collection of Currency objects
    /// </summary>
    [Serializable]
    public class CurrencyCollection  : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        #region CurrencyCollection constructor
		/// <summary>
		/// Creates a new <see cref="CurrencyCollection"/> instance.
		/// </summary>
        ...
        {
            CurrencyCollection tc = new CurrencyCollection();
            tc.AddRange(this);
        ...
        public void AddRange(CurrencyCollection collection)
        {
...
//		/// <param name="array"></param>
//		/// <param name="start"></param>
//		/// <remarks>Implementation removed and replaced as it was defective.</remarks>
...
//        }
        ...
        */
        ...
        {
            private CurrencyCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(CurrencyCollection tc)
            {
                m_collection = tc;
                m_index = -1;
