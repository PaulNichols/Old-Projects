...
{
	// create the template
	using T = HBOS.FS.AMP.UPD.Types.AssetFunds.AssetFundLight;

	/// <summary>
	/// AssetFundLight Collection.
	/// </summary>
	public class AssetFundLightCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
	{
		...
		#region AssetFundLightCollection

		/// <summary>
		/// Asset Fund collection constructor
		/// </summary>
		public AssetFundLightCollection()
		{ }

		/// <summary>
		/// Asset Fun collection overloaded constructor
		/// </summary>
		public AssetFundLightCollection(AssetFundLightCollection collection)
		{ 
			AddRange(collection); 
		}
		...
		/// </summary>
		public AssetFundLightCollection(T[] array)
		{ 
			AddRange(array); 
		}

		#endregion AssetFundLightCollection
		...
		/// <summary>
		/// Copies all the AssetFundLightCollection in the collection to the specified target object
		/// </summary>
		...
		/// </summary>
		/// <returns></returns>
		public AssetFundLightCollection Clone()
		{
			AssetFundLightCollection tc = new AssetFundLightCollection();
			tc.AddRange(this);
		...
		/// <summary>
		/// Add a new range of AssetFundLightCollection from a AssetFundLightCollection collection
		/// </summary>
		/// <param name="collection"></param>
		public void AddRange(AssetFundLightCollection collection)
		{
		...
		/// <summary>
		/// Add a new range of AssetFundLightCollection from an array
		/// AddRange Overload
		/// </summary>
		/// <param name="array"></param>
...
//		}
		...
		*/
		...
		{
			private AssetFundLightCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(AssetFundLightCollection tc)
			{
				m_collection = tc;
				m_index = -1;
