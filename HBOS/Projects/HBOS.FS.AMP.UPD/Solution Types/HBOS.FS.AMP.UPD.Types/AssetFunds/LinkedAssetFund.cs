...
namespace HBOS.FS.AMP.UPD.Types.AssetFunds
{
	...
	{		
        ...
        private long m_currencyRateSnapshotID;        // (from db)
        private long m_indexValueSnapshotID;          // (from db)
        private long m_indexWeightingSnapshotID;      // (from db)

        private bool m_currencyRateSnapshotIDSet;
        private bool m_indexValueSnapshotIDSet;
        private bool m_indexWeightingSnapshotIDSet;
