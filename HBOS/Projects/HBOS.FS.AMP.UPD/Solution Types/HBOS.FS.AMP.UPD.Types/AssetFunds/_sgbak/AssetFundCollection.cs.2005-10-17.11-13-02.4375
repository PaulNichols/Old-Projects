...
{
    // create the template
    using T = HBOS.FS.AMP.UPD.Types.AssetFunds.AssetFund;

	/// <summary>
	/// Summary description for AssetFundCollection.
	/// </summary>
    public class AssetFundCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        #region AssetFundCollection

        /// <summary>
        /// Asset Fund collection constructor
        /// </summary>
        public AssetFundCollection()
        { }

        /// <summary>
        /// Asset Fun collection overloaded constructor
        /// </summary>
        public AssetFundCollection(AssetFundCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// </summary>
        public AssetFundCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion AssetFundCollection
        ...
        /// </summary>
        public T this[string assetFundCode]
        {
            get
            {
				T returnItem=null;
				if (this.Count >0)
				{
					...
					{
						if (m_array[i].AssetFundCode==assetFundCode)
						{
							returnItem=m_array[i];
							break;
						}
					}
            }
        ...
        /// </summary>
        /// <returns></returns>
        public AssetFundCollection Clone()
        {
            AssetFundCollection tc = new AssetFundCollection();
            tc.AddRange(this);
        ...
        public void AddRange(AssetFundCollection collection)
        {
		...
		// IB - No longer required as the collections can databind directly to the DataGrid comboBox.
...
//
        ...
        */
        ...
        {
            private AssetFundCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(AssetFundCollection tc)
            {
                m_collection = tc;
                m_index = -1;
