...
namespace HBOS.FS.AMP.UPD.Types.Users
{
    ...
    using T = HBOS.FS.AMP.UPD.Types.Users.User;
    ...
    /// </summary>
    [Serializable]
    public class UserCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        /// </summary>
        public UserCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion UserCollection
        ...
        {
            UserCollection tc = new UserCollection();
            tc.AddRange(this);
        ...
        public void AddRange(UserCollection collection)
        {
...
//        }
        ...
        */
        ...
        {
            private UserCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(UserCollection tc)
            {
                m_collection = tc;
                m_index = -1;
