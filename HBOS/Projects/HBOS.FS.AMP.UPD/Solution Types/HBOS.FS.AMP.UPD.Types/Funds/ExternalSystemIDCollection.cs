...
{
	// create the template
	using T = HBOS.FS.AMP.UPD.Types.Funds.ExternalSystemID;
	...
	/// </summary>
	[Serializable]
	public class ExternalSystemIDCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
	{
		...
		#region ExternalSystemIDCollection

		/// <summary>
		/// Fund collection constructor
		/// </summary>
		public ExternalSystemIDCollection()
		{ }

		/// <summary>
		/// Fund collection overloaded constructor
		/// </summary>
		public ExternalSystemIDCollection(ExternalSystemIDCollection collection)
		{ 
			AddRange(collection); 
		}
		...
		/// Fund collection overloaded constructor
		/// </summary>
		public ExternalSystemIDCollection(T[] array)
		{ 
			AddRange(array); 
		}

		#endregion ExternalSystemIDCollection
		...
		/// </summary>
		/// <returns></returns>
		public ExternalSystemIDCollection Clone()
		{
			ExternalSystemIDCollection tc = new ExternalSystemIDCollection();
			tc.AddRange(this);
		...
		public void AddRange(ExternalSystemIDCollection collection)
		{
		...
		*/
		...
		{
			private ExternalSystemIDCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(ExternalSystemIDCollection tc)
			{
				m_collection = tc;
				m_index = -1;
