...
{
    // create the template
    using T = HBOS.FS.AMP.UPD.Types.Funds.Fund;
    ...
    /// </summary>
    [Serializable]
    public class FundCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        /// </summary>
        public FundCollection(FundCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// Fund collection overloaded constructor
        /// </summary>
        public FundCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion FundCollection
        ...
        /// </summary>
        /// <returns></returns>
        public FundCollection Clone()
        {
            FundCollection tc = new FundCollection();
            tc.AddRange(this);
        ...
        public void AddRange(FundCollection collection)
        {
...
//
        ...
        */
        ...
        {
            private FundCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(FundCollection tc)
            {
                m_collection = tc;
                m_index = -1;
