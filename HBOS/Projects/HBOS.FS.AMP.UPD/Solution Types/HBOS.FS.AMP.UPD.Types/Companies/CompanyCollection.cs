...
{
    using T = HBOS.FS.AMP.UPD.Types.Companies.Company;
    /// <summary>
    /// Summary description for CompanyCollection.
    /// </summary>	
    [Serializable]
    public class CompanyCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        /// </summary>
        public CompanyCollection(CompanyCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// FundGroup collection overloaded constructor
        /// </summary>
        public CompanyCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion CompanyCollection
        ...
        {
            CompanyCollection tc = new CompanyCollection();
            tc.AddRange(this);
        ...
        public void AddRange(CompanyCollection collection)
        {
        ...
        */
        ...
        {
            private CompanyCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(CompanyCollection tc)
            {
                m_collection = tc;
                m_index = -1;
