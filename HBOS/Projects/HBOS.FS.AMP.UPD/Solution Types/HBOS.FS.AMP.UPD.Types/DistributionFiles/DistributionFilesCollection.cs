...
{
	using T = HBOS.FS.AMP.UPD.Types.DistributionFiles.DistributionFile;
	/// <summary>
	/// Summary description for DistributionFileCollection.
	/// </summary>	
	[Serializable]
	public class DistributionFileCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
	{
		...
		private int m_count;        // permits thread safe operations
		[NonSerialized] private int m_version;

		#endregion Private variables

		#region DistributionFileCollection

		/// <summary>
		/// DistributionFile collection constructor
		/// </summary>
		public DistributionFileCollection()
		{ }

		/// <summary>
		/// DistributionFile collection overloaded constructor
		/// </summary>
		public DistributionFileCollection(DistributionFileCollection collection)
		{ 
			AddRange(collection); 
		}
		...
		/// DistributionFile collection overloaded constructor
		/// </summary>
		public DistributionFileCollection(T[] array)
		{ 
			AddRange(array); 
		}

		#endregion DistributionFileCollection
		...
		/// </summary>
		/// <returns></returns>
		public DistributionFileCollection Clone()
		{
			DistributionFileCollection tc = new DistributionFileCollection();
			tc.AddRange(this);
		...
		public void AddRange(DistributionFileCollection collection)
		{
		...
		*/
		...
		{
			private DistributionFileCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(DistributionFileCollection tc)
			{
				m_collection = tc;
				m_index = -1;
