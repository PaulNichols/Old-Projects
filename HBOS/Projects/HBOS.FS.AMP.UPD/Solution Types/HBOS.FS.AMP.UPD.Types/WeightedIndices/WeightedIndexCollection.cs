...
{
    // create the template
    using T = HBOS.FS.AMP.UPD.Types.WeightedIndices.WeightedIndex;
    ...
    /// </summary>
    [Serializable]
    public class WeightedIndexCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        #region WeightedIndexCollection

        /// <summary>
        /// Fund collection constructor
        /// </summary>
        public WeightedIndexCollection()
        { }

        /// <summary>
        /// Fund collection overloaded constructor
        /// </summary>
        public WeightedIndexCollection(WeightedIndexCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// Fund collection overloaded constructor
        /// </summary>
        public WeightedIndexCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion WeightedIndexCollection
        ...
        /// <summary>
        /// Copies all the WeightedIndexCollection in the collection to the specified target object
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public WeightedIndexCollection Clone()
        {
            WeightedIndexCollection tc = new WeightedIndexCollection();
            tc.AddRange(this);
        ...
        /// <summary>
        /// Add a new range of WeightedIndexCollection from a WeightedIndexCollection collection
        /// </summary>
        /// <param name="collection"></param>
        public void AddRange(WeightedIndexCollection collection)
        {
        ...
        /// <summary>
        /// Add a new range of WeightedIndexCollection from an array
        /// AddRange Overload
        /// </summary>
        /// <param name="array"></param>
...
//        }
        ...
        */
        ...
        {
            private WeightedIndexCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(WeightedIndexCollection tc)
            {
                m_collection = tc;
                m_index = -1;
