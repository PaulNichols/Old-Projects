...
{
    // create the template
    using T = HBOS.FS.AMP.UPD.Types.WeightedIndices.IWeightedMovement;

    //
    // TODO: Add fund collection description comments
    //
    ...
    /// </summary>
    [Serializable]
    public class WeightedMovementCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        #region WeightedMovementCollection

        /// <summary>
        /// Fund collection constructor
        /// </summary>
        public WeightedMovementCollection()
        { }

        /// <summary>
        /// Fund collection overloaded constructor
        /// </summary>
        public WeightedMovementCollection(WeightedMovementCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// Fund collection overloaded constructor
        /// </summary>
        public WeightedMovementCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion WeightedMovementCollection
        ...
        /// <summary>
        /// Copies all the WeightedMovementCollection in the collection to the specified target object
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public WeightedMovementCollection Clone()
        {
            WeightedMovementCollection tc = new WeightedMovementCollection();
            tc.AddRange(this);
        ...
        /// <summary>
        /// Add a new range of WeightedMovementCollection from a WeightedMovementCollection collection
        /// </summary>
        /// <param name="collection"></param>
        public void AddRange(WeightedMovementCollection collection)
        {
        ...
        /// <summary>
        /// Add a new range of WeightedMovementCollection from an array
        /// AddRange Overload
        /// </summary>
        /// <param name="array"></param>
...
//        }
        ...
        */
        ...
        {
            private WeightedMovementCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(WeightedMovementCollection tc)
            {
                m_collection = tc;
                m_index = -1;
