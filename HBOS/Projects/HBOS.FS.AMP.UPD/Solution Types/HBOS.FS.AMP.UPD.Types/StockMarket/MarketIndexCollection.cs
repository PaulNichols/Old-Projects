...
namespace HBOS.FS.AMP.UPD.Types.AssetFunds
{
    ...
    // Create the template
    using T = HBOS.FS.AMP.UPD.Types.AssetFunds.MarketIndex;
    
    /// <summary>
	/// Summary description for MarketIndexCollection.
	/// </summary>
    [Serializable]
    public class MarketIndexCollection  : ICollection, IList, ITypedList, IEnumerable, ICloneable
	{
		...
		/// </summary>
		public MarketIndexCollection()
		{ }

		/// <summary>
		/// Fund collection overloaded constructor
		/// </summary>
		public MarketIndexCollection(MarketIndexCollection collection)
		{ 
			AddRange(collection); 
		}
		...
		/// Fund collection overloaded constructor
		/// </summary>
		public MarketIndexCollection(T[] array)
		{ 
			AddRange(array); 
		}
		...
		/// </summary>
		/// <returns></returns>
		public MarketIndexCollection Clone()
		{
			MarketIndexCollection tc = new MarketIndexCollection();
			tc.AddRange(this);
		...
		public void AddRange(MarketIndexCollection collection)
		{
		...
		*/
		...
		{
			private MarketIndexCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(MarketIndexCollection tc)
			{
				m_collection = tc;
				m_index = -1;
