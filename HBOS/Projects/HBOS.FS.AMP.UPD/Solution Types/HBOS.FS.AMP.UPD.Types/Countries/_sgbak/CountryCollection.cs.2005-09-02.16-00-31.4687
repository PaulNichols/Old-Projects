...
{
    // create the template
    using T = HBOS.FS.AMP.UPD.Types.Countries.Country;

    /// <summary>
    /// Summary description for CountryCollection.
    /// </summary>
     [Serializable]
    public class CountryCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
    {
        ...
        /// </summary>
        public CountryCollection(CountryCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// </summary>
        public CountryCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion CountryCollection
        ...
        {
            CountryCollection tc = new CountryCollection();
            tc.AddRange(this);
        ...
        public void AddRange(CountryCollection collection)
        {
...
//        }
        ...
        */
        ...
        {
            private CountryCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(CountryCollection tc)
            {
                m_collection = tc;
                m_index = -1;
