...
{
	// create the template
	using T = HBOS.FS.AMP.UPD.Types.Status.ImportDetails;

	//
	// TODO: Add ImportDetails collection description comments
	//
	...
	/// </summary>
	[Serializable]
	public class ImportDetailsCollection : ICollection, IList, ITypedList, IEnumerable, ICloneable
	{
		...
		#region ImportDetailsCollection

		/// <summary>
		/// ImportDetails collection constructor
		/// </summary>
		public ImportDetailsCollection()
		{ }

		/// <summary>
		/// ImportDetails collection overloaded constructor
		/// </summary>
		public ImportDetailsCollection(ImportDetailsCollection collection)
		{ 
			AddRange(collection); 
		}
		...
		/// ImportDetails collection overloaded constructor
		/// </summary>
		public ImportDetailsCollection(T[] array)
		{ 
			AddRange(array); 
		}

		#endregion ImportDetailsCollection
		...
		/// </summary>
		/// <returns></returns>
		public ImportDetailsCollection Clone()
		{
			ImportDetailsCollection tc = new ImportDetailsCollection();
			tc.AddRange(this);
		...
		public void AddRange(ImportDetailsCollection collection)
		{
		...
		*/
		...
		{
			private ImportDetailsCollection m_collection;
			private int m_index;
			private int m_version;

			// Construction

			internal Enumerator(ImportDetailsCollection tc)
			{
				m_collection = tc;
				m_index = -1;
