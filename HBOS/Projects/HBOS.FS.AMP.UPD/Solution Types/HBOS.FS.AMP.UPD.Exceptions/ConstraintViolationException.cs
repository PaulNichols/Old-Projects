...
namespace HBOS.FS.AMP.UPD.Exceptions
{
	...
	public class ConstraintViolationException : DatabaseException
	{
		...
		private const string m_procedureNameKey = "ConstraintViolationExceptionProcedure";
		private const string m_parametersKey = "ConstraintViolationExceptionParameters";
		...
		/// <summary>
		/// Creates a new <see cref="ConstraintViolationException"/> instance. This is the
		/// default constructor.
		/// </summary>
		...
		/// <summary>
		/// Creates a new <see cref="ConstraintViolationException"/> instance. This is the equivalent
		...
		public ConstraintViolationException(string databaseInfo, string procedureName,
		...
		/// <summary>
		/// Creates a new <see cref="ConstraintViolationException"/> instance. This enforces the
		...
		/// <param name="procedureName">The name of the stored procedure causing the violation.</param>
		/// <param name="parameters">The parameters passed to the stored procedure.</param>
		public ConstraintViolationException(string message, string databaseInfo,
		...
		/// <summary>
		/// Creates a new <see cref="ConstraintViolationException"/> instance. This ensures that the
