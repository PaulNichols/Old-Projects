...
namespace UT_HBOS.FS.AMP.Entities
{
    ...
    using T = UT_HBOS.FS.AMP.Entities.TestEntity;
    ...
    /// </summary>
    [Serializable]
    public class TestEntityCollection : ICollection, IList, IEnumerable, ICloneable
    {
        ...
        /// </summary>
        public TestEntityCollection(TestEntityCollection collection)
        { 
            AddRange(collection); 
        }
        ...
        /// Fund collection overloaded constructor
        /// </summary>
        public TestEntityCollection(T[] array)
        { 
            AddRange(array); 
        }

        #endregion TestEntityCollection
        ...
        /// <summary>
        /// Copies all the TestEntityCollection in the collection to the specified target object
        /// </summary>
        ...
        {
            TestEntityCollection tc = new TestEntityCollection();
            tc.AddRange(this);
        ...
        /// <summary>
        /// Add a new range of TestEntityCollection from a TestEntityCollection collection
        /// </summary>
        /// <param name="collection"></param>
        public void AddRange(TestEntityCollection collection)
        {
        ...
        /// <summary>
        /// Add a new range of TestEntityCollection from an array
        /// AddRange Overload
        /// </summary>
        /// <param name="array"></param>
        ...
        */
        ...
        {
            private TestEntityCollection m_collection;
            private int m_index;
            private int m_version;

            // Construction

            internal Enumerator(TestEntityCollection tc)
            {
                m_collection = tc;
                m_index = -1;
