<%@ Page language="c#" Codebehind="WebForm_tblCategory.aspx.cs" AutoEventWireup="false" Inherits="OlymarsDemo.Web.Forms.WebForm_tblCategory" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_tblCategory" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					<tr>
						...
						<td>
							<asp:TextBox id="txt_Cat_StrName" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="1" ></asp:TextBox>
						</td>
						<td>
							<asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_Cat_StrName" CssClass="ErrorStyle"></asp:Label>
						</td>
					</tr>
					<tr>
					</tr>
