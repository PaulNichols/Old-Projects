...
namespace OlymarsDemo.BusinessComponents {
	...
	/// <summary>
	/// This class is an abstract class that represents the [tblCategory] table. With this class
	/// you can load or update a record from the database. If you need to add or delete a record,
	/// you must use the <see cref="OlymarsDemo.BusinessComponents.Categories"/> class to do so.
	/// </summary>
...
#endif
	public class Category : IBusinessComponentRecord {
		...
		/// <summary>
		/// Initializes a new instance of the Category class. Use this contructor to add
		/// a new record. Then call the Add method of the OlymarsDemo.BusinessComponents.Categories class to actually
		...
		public Category(string connectionString, System.Data.SqlTypes.SqlInt32 col_Cat_LngID) {
			...
			this.col_Cat_LngID = col_Cat_LngID;
		}
		...
		/// <param name="col_Cat_LngID">[To be supplied.]</param>
		public Category(SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 col_Cat_LngID) {
		...
		/// <param name="col_Cat_LngID">[To be supplied.]</param>
		public Category(SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 col_Cat_LngID) {
		...
		internal System.Data.SqlTypes.SqlInt32 col_Cat_LngID = System.Data.SqlTypes.SqlInt32.Null;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public System.Data.SqlTypes.SqlInt32 Col_Cat_LngID {
		...
		internal bool col_Cat_StrNameWasSet = false;
		private bool col_Cat_StrNameWasUpdated = false;
		internal System.Data.SqlTypes.SqlString col_Cat_StrName = System.Data.SqlTypes.SqlString.Null;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public System.Data.SqlTypes.SqlString Col_Cat_StrName {
			...
			set {
				...
				this.col_Cat_StrNameWasUpdated = true;
				this.col_Cat_StrNameWasSet = true;
		...
		public bool Refresh() {
			...
			this.col_Cat_StrNameWasSet = false;
			this.col_Cat_StrName = System.Data.SqlTypes.SqlString.Null;
			...
			SPs.spS_tblCategory Sp = new SPs.spS_tblCategory(false);
			if (Sp.Execute(ref Param, out sqlDataReader)) {

				if (sqlDataReader.Read()) {

					if (!sqlDataReader.IsDBNull(SPs.spS_tblCategory.Resultset1.Fields.Column_Cat_StrName.ColumnIndex)) {

						this.col_Cat_StrName = sqlDataReader.GetSqlString(SPs.spS_tblCategory.Resultset1.Fields.Column_Cat_StrName.ColumnIndex);
					}
				...
				throw new OlymarsDemo.DataClasses.CustomException(Param, "OlymarsDemo.BusinessComponents.Category", "Refresh");
			}
		}
		...
		private Products internal_Products = null;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public Products Products {
			...
			get {
				...
				if (this.internal_Products == null) {

					switch (this.lastKnownConnectionType) {

						case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
							this.internal_Products = new Products(this.connectionString);
							break;

						case OlymarsDemo.DataClasses.ConnectionType.SqlConnection:
							this.internal_Products = new Products(this.sqlConnection);
							break;

						case OlymarsDemo.DataClasses.ConnectionType.SqlTransaction:
							this.internal_Products = new Products(this.sqlTransaction);
							break;

					}
					this.internal_Products.LoadFrom_Pro_LngCategoryID(this.col_Cat_LngID, this);
				}
			...
			if (this.displayName == null) {
				...
				if (Sp.Execute(ref Param, out sqlDataReader)) {
					...
					if (sqlDataReader.Read()) {
						...
						if (!sqlDataReader.IsDBNull(SPs.spS_tblCategory_Display.Resultset1.Fields.Column_Display.ColumnIndex)) {

							if (sqlDataReader.GetFieldType(SPs.spS_tblCategory_Display.Resultset1.Fields.Column_Display.ColumnIndex) == typeof(string)) {

								this.displayName = sqlDataReader.GetString(SPs.spS_tblCategory_Display.Resultset1.Fields.Column_Display.ColumnIndex);
							}
							else {

								this.displayName = sqlDataReader.GetValue(SPs.spS_tblCategory_Display.Resultset1.Fields.Column_Display.ColumnIndex).ToString();
							}
						}
					}
					...
					throw new OlymarsDemo.DataClasses.CustomException(Param, "OlymarsDemo.BusinessComponents.Category", "ToString");
				}				
			}
		...
		/// [To be supplied.]
		/// </summary>
		public new Category MemberwiseClone() {
			...
			newRecord.col_Cat_LngID = this.col_Cat_LngID;


			newRecord.col_Cat_StrNameWasSet = this.col_Cat_StrNameWasSet;
			newRecord.col_Cat_StrNameWasUpdated = this.col_Cat_StrNameWasUpdated;
			newRecord.col_Cat_StrName = this.col_Cat_StrName;
