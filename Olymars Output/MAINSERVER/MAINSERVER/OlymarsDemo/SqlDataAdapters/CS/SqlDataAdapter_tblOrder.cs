...
namespace OlymarsDemo.SqlDataAdapters {
	...
	/// used against the [tblOrder] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public sealed class SqlDataAdapter_tblOrder {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_tblOrder class.
		...
		public SqlDataAdapter_tblOrder(string connectionString) {
		...
		public SqlDataAdapter_tblOrder(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_tblOrder(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_tblOrder class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_tblOrder(string connectionString, System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID, string tableName) : this(connectionString) {

			this.Configure(FK_Ord_LngCustomerID, tableName);
		}
		...
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblOrder(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblOrder(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_tblOrder class.
		/// The table name in the DataSet will be: tblOrder
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		public SqlDataAdapter_tblOrder(string connectionString, System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID) : this(connectionString) {

			this.Configure(FK_Ord_LngCustomerID, "tblOrder");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		public SqlDataAdapter_tblOrder(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		public SqlDataAdapter_tblOrder(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID) {
		...
		/// <param name="FK_Ord_LngCustomerID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_Ord_LngCustomerID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrder)");
					}
			...
			sqlSelectCommand.CommandText = "spS_tblOrder";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_Ord_LngCustomerID.IsNull) {

				sqlParameter.Value = FK_Ord_LngCustomerID;
			}
			...
			sqlInsertCommand.CommandText = "spI_tblOrder";
			...
			sqlUpdateCommand.CommandText = "spU_tblOrder";
			...
			sqlDeleteCommand.CommandText = "spD_tblOrder";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Ord_GuidID", "Ord_GuidID")
							,new System.Data.Common.DataColumnMapping("Ord_DatOrderedOn", "Ord_DatOrderedOn")
							,new System.Data.Common.DataColumnMapping("Ord_LngCustomerID", "Ord_LngCustomerID")
							,new System.Data.Common.DataColumnMapping("Ord_CurTotal", "Ord_CurTotal")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: tblOrder.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "tblOrder", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "tblOrder", startRecord, maxRecords);
		}
