...
namespace OlymarsDemo.SqlDataAdapters {
	...
	/// used against the [tblOrderItem] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public sealed class SqlDataAdapter_tblOrderItem {
		...
		public SqlDataAdapter_tblOrderItem(string connectionString) {
		...
		public SqlDataAdapter_tblOrderItem(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_tblOrderItem(string connectionString, System.Data.SqlTypes.SqlGuid FK_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid FK_Oit_GuidProductID, string tableName) : this(connectionString) {
		...
		/// <param name="FK_Oit_GuidProductID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblOrderItem(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid FK_Oit_GuidProductID, string tableName) : this(sqlTransaction) {
		...
		/// <param name="FK_Oit_GuidOrderID">Value for this foreign key.</param>
		/// <param name="FK_Oit_GuidProductID">Value for this foreign key.</param>
		public SqlDataAdapter_tblOrderItem(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid FK_Oit_GuidProductID) : this(sqlConnection) {
		...
		/// <param name="FK_Oit_GuidProductID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid FK_Oit_GuidProductID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrderItem)");
					}
			...
			sqlSelectCommand.CommandText = "spS_tblOrderItem";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_Oit_GuidOrderID.IsNull) {

				sqlParameter.Value = FK_Oit_GuidOrderID;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_Oit_GuidProductID.IsNull) {

				sqlParameter.Value = FK_Oit_GuidProductID;
			}
			...
			sqlInsertCommand.CommandText = "spI_tblOrderItem";
			...
			sqlUpdateCommand.CommandText = "spU_tblOrderItem";
			...
			sqlDeleteCommand.CommandText = "spD_tblOrderItem";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Oit_GuidID", "Oit_GuidID")
							,new System.Data.Common.DataColumnMapping("Oit_GuidOrderID", "Oit_GuidOrderID")
							,new System.Data.Common.DataColumnMapping("Oit_GuidProductID", "Oit_GuidProductID")
							,new System.Data.Common.DataColumnMapping("Oit_LngAmount", "Oit_LngAmount")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: tblOrderItem.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "tblOrderItem", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "tblOrderItem", startRecord, maxRecords);
		}
