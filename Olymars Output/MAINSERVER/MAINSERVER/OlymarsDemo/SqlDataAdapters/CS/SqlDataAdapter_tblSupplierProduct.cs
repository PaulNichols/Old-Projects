...
namespace OlymarsDemo.SqlDataAdapters {
	...
	/// used against the [tblSupplierProduct] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public sealed class SqlDataAdapter_tblSupplierProduct {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_tblSupplierProduct class.
		...
		public SqlDataAdapter_tblSupplierProduct(string connectionString) {
		...
		public SqlDataAdapter_tblSupplierProduct(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_tblSupplierProduct(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		public SqlDataAdapter_tblSupplierProduct(string connectionString, System.Data.SqlTypes.SqlGuid FK_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid FK_Spr_GuidSupplierID, string tableName) : this(connectionString) {
		...
		/// <param name="FK_Spr_GuidSupplierID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblSupplierProduct(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid FK_Spr_GuidSupplierID, string tableName) : this(sqlTransaction) {
		...
		/// <param name="FK_Spr_GuidProductID">Value for this foreign key.</param>
		/// <param name="FK_Spr_GuidSupplierID">Value for this foreign key.</param>
		public SqlDataAdapter_tblSupplierProduct(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid FK_Spr_GuidSupplierID) : this(sqlConnection) {
		...
		///the populated table name in the DataSet will be: tblSupplierProduct.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "tblSupplierProduct", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "tblSupplierProduct", startRecord, maxRecords);
		}
