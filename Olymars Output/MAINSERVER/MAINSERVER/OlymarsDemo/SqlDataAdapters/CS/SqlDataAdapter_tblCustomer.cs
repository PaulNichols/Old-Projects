...
namespace OlymarsDemo.SqlDataAdapters {
	...
	/// used against the [tblCustomer] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public sealed class SqlDataAdapter_tblCustomer {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_tblCustomer class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_tblCustomer(string connectionString) {
		...
		public SqlDataAdapter_tblCustomer(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_tblCustomer(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_tblCustomer class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblCustomer(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblCustomer(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblCustomer(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: tblCustomer
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblCustomer)");
					}
			...
			sqlSelectCommand.CommandText = "spS_tblCustomer";
			...
			sqlInsertCommand.CommandText = "spI_tblCustomer";
			...
			sqlUpdateCommand.CommandText = "spU_tblCustomer";
			...
			sqlDeleteCommand.CommandText = "spD_tblCustomer";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Cus_LngID", "Cus_LngID")
							,new System.Data.Common.DataColumnMapping("Cus_StrLastName", "Cus_StrLastName")
							,new System.Data.Common.DataColumnMapping("Cus_StrFirstName", "Cus_StrFirstName")
							,new System.Data.Common.DataColumnMapping("Cus_StrEmail", "Cus_StrEmail")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: tblCustomer.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "tblCustomer", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "tblCustomer", startRecord, maxRecords);
		}
