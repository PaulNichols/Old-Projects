...
namespace OlymarsDemo.SqlDataAdapters {
	...
	/// used against the [tblSupplier] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public sealed class SqlDataAdapter_tblSupplier {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_tblSupplier class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_tblSupplier(string connectionString) {
		...
		public SqlDataAdapter_tblSupplier(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_tblSupplier(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		public SqlDataAdapter_tblSupplier(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblSupplier(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: tblSupplier
		/// </summary>
		...
		///the populated table name in the DataSet will be: tblSupplier.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "tblSupplier", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "tblSupplier", startRecord, maxRecords);
		}
