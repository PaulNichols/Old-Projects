...
namespace OlymarsDemo.SqlDataAdapters {
	...
	/// used against the [tblCategory] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public sealed class SqlDataAdapter_tblCategory {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_tblCategory class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_tblCategory(string connectionString) {
		...
		public SqlDataAdapter_tblCategory(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_tblCategory(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		public SqlDataAdapter_tblCategory(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_tblCategory(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// The table name in the DataSet will be: tblCategory
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblCategory)");
					}
			...
			sqlSelectCommand.CommandText = "spS_tblCategory";
			...
			sqlInsertCommand.CommandText = "spI_tblCategory";
			...
			sqlUpdateCommand.CommandText = "spU_tblCategory";
			...
			sqlDeleteCommand.CommandText = "spD_tblCategory";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Cat_LngID", "Cat_LngID")
							,new System.Data.Common.DataColumnMapping("Cat_StrName", "Cat_StrName")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: tblCategory.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "tblCategory", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "tblCategory", startRecord, maxRecords);
		}
