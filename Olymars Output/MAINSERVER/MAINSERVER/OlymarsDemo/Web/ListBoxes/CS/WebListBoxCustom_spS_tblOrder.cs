...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBoxCustom_spS_tblOrder), "WebListBox.bmp")]
	public class WebListBoxCustom_spS_tblOrder : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WebListBoxCustom_spS_tblOrder class.
		/// </summary>
		public WebListBoxCustom_spS_tblOrder() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebListBoxCustom_spS_tblOrder", "RefreshData");
			}
