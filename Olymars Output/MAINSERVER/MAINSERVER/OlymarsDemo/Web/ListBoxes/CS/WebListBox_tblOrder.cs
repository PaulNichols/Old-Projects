...
namespace OlymarsDemo.Web.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.ListBox class and was built to display the 'tblOrder' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBox_tblOrder), "WebListBox.bmp")]
	public sealed class WebListBox_tblOrder : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.ListBoxes.WebListBox_tblOrder class.
		/// </summary>
		public WebListBox_tblOrder() : base() {
