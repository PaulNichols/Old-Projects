...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBoxCustom_spS_tblCategory), "WebListBox.bmp")]
	public class WebListBoxCustom_spS_tblCategory : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WebListBoxCustom_spS_tblCategory class.
		/// </summary>
		public WebListBoxCustom_spS_tblCategory() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebListBoxCustom_spS_tblCategory", "RefreshData");
			}
