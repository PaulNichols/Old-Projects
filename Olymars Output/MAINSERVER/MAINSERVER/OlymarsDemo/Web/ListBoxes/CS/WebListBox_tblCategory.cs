...
namespace OlymarsDemo.Web.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.ListBox class and was built to display the 'tblCategory' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBox_tblCategory), "WebListBox.bmp")]
	public sealed class WebListBox_tblCategory : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.ListBoxes.WebListBox_tblCategory class.
		/// </summary>
		public WebListBox_tblCategory() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_Cat_LngID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebListBox_tblCategory : System.Web.UI.WebControls.ListBox", "RefreshData");
			}
