...
namespace OlymarsDemo.Web.ListBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:00", SqlObjectDependancyName="spS_tblSupplierProduct", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBoxCustom_spS_tblSupplierProduct), "WebListBox.bmp")]
	public class WebListBoxCustom_spS_tblSupplierProduct : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WebListBoxCustom_spS_tblSupplierProduct class.
		/// </summary>
		public WebListBoxCustom_spS_tblSupplierProduct() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebListBoxCustom_spS_tblSupplierProduct", "RefreshData");
			}
