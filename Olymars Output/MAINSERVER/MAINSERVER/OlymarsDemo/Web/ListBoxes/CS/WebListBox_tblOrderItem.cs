...
namespace OlymarsDemo.Web.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.ListBox class and was built to display the 'tblOrderItem' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBox_tblOrderItem), "WebListBox.bmp")]
	public sealed class WebListBox_tblOrderItem : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.ListBoxes.WebListBox_tblOrderItem class.
		/// </summary>
		public WebListBox_tblOrderItem() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Oit_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebListBox_tblOrderItem : System.Web.UI.WebControls.ListBox", "RefreshData");
			}
