...
namespace OlymarsDemo.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_tblCategory.
	/// </summary>
	public class WebForm_tblCategory : System.Web.UI.Page {

		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_Cat_StrName;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_Cat_StrName;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_Cat_StrName;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void RefreshRecord() {
			...
			OlymarsDemo.AbstractClasses.Abstract_tblCategory oAbstract_tblCategory = new OlymarsDemo.AbstractClasses.Abstract_tblCategory(ConnectionString);

			if (!oAbstract_tblCategory.Refresh(CurrentID)) {
			...
			if (!oAbstract_tblCategory.Col_Cat_StrName.IsNull) {
				...
				txt_Cat_StrName.Text = oAbstract_tblCategory.Col_Cat_StrName.Value.ToString();
			}
			else {

				txt_Cat_StrName.Text = String.Empty;
			}
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_tblCategory.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_tblCategory.aspx?Action=Add");
			}
		}
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_tblCategory Param = null;
			SPs.spD_tblCategory SP = null;

			Param = new Params.spD_tblCategory();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Cat_LngID = CurrentID;

			SP = new SPs.spD_tblCategory();
