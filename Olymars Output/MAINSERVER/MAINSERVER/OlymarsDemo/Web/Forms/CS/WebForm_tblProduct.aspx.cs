...
namespace OlymarsDemo.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_tblProduct.
	/// </summary>
	public class WebForm_tblProduct : System.Web.UI.Page {

		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_Pro_StrName;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_Pro_StrName;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_Pro_StrName;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_Pro_CurPrice;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_Pro_CurPrice;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_Pro_CurPrice;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_Pro_LngCategoryID;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			*/
			...
			labError_Pro_CurPrice.Visible = false;
		...
		private void RefreshForeignTables() {
			...
			try {
				...
				com_Pro_LngCategoryID.RefreshData(System.Data.SqlTypes.SqlInt32.Null);
			}
		...
		private void RefreshRecord() {
			...
			OlymarsDemo.AbstractClasses.Abstract_tblProduct oAbstract_tblProduct = new OlymarsDemo.AbstractClasses.Abstract_tblProduct(ConnectionString);

			if (!oAbstract_tblProduct.Refresh(CurrentID)) {
			...
			if (!oAbstract_tblProduct.Col_Pro_StrName.IsNull) {
				...
				txt_Pro_StrName.Text = oAbstract_tblProduct.Col_Pro_StrName.Value.ToString();
			}
			else {

				txt_Pro_StrName.Text = String.Empty;
			}

			if (!oAbstract_tblProduct.Col_Pro_CurPrice.IsNull) {

				txt_Pro_CurPrice.Text = oAbstract_tblProduct.Col_Pro_CurPrice.Value.ToString();
			}
			else {

				txt_Pro_CurPrice.Text = String.Empty;
			}

			com_Pro_LngCategoryID.Items.FindByValue(Convert.ToString(oAbstract_tblProduct.Col_Pro_LngCategoryID)).Selected = true;
		...
		private void EmptyControls() {
			...
			txt_Pro_StrName.Text = String.Empty;
			txt_Pro_CurPrice.Text = String.Empty;
			com_Pro_LngCategoryID.SelectedIndex = 0;
		}
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_tblProduct.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_tblProduct.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_tblProduct Param = null;
				SPs.spU_tblProduct SP = null;

				Param = new Params.spU_tblProduct();

				Param.SetUpConnection(ConnectionString);

				Param.Param_Pro_GuidID = CurrentID;

				if (txt_Pro_StrName.Text.Trim() != String.Empty) {

					Param.Param_Pro_StrName = new System.Data.SqlTypes.SqlString(txt_Pro_StrName.Text);
				}

				if (txt_Pro_CurPrice.Text.Trim() != String.Empty) {

					Param.Param_Pro_CurPrice = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_Pro_CurPrice.Text));
				}

				Param.Param_Pro_LngCategoryID = Convert.ToInt32(com_Pro_LngCategoryID.SelectedItem.Value);

				SP = new SPs.spU_tblProduct();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_tblProduct.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_tblProduct.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_tblProduct Param = null;
				SPs.spI_tblProduct SP = null;

				Param = new Params.spI_tblProduct();
				...
				SP = new SPs.spI_tblProduct();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_tblProduct.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Pro_GuidID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_tblProduct.aspx?Action=Edit&ID={0}", Param.Param_Pro_GuidID.ToString()));
					}
					return;
				}
				else {
