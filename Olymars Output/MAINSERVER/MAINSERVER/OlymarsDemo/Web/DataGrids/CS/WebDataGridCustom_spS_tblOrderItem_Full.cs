...
namespace OlymarsDemo.Web.DataGrids {
	...
	/// 'spS_tblOrderItem_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:01", SqlObjectDependancyName="spS_tblOrderItem_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_tblOrderItem_Full), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_tblOrderItem_Full : System.Web.UI.WebControls.DataGrid {

		private string tableName;
		private Params.spS_tblOrderItem_Full param;
		...
		/// </summary>
		public Params.spS_tblOrderItem_Full SP_Parameter {
		...
		/// WebDataGridCustom_spS_tblOrderItem_Full class.
		/// </summary>
		public WebDataGridCustom_spS_tblOrderItem_Full() : base() {
		...
		/// You also need to supply the spS_tblOrderItem_Full stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Oit_GuidID, System.Data.SqlTypes.SqlGuid param_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid param_Oit_GuidProductID) {
		...
		/// <param name="param_Oit_GuidOrderID">Value for the parameter @Oit_GuidOrderID.</param>
		/// <param name="param_Oit_GuidProductID">Value for the parameter @Oit_GuidProductID.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Oit_GuidID, System.Data.SqlTypes.SqlGuid param_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid param_Oit_GuidProductID) {
			...
			this.connectionString = connectionString;
			this.LastKnownConnectionType = OlymarsDemo.DataClasses.ConnectionType.ConnectionString;
			this.tableName = "spS_tblOrderItem_Full";
		...
		/// <param name="param_Oit_GuidOrderID">Value for the parameter @Oit_GuidOrderID.</param>
		/// <param name="param_Oit_GuidProductID">Value for the parameter @Oit_GuidProductID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Oit_GuidID, System.Data.SqlTypes.SqlGuid param_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid param_Oit_GuidProductID) {
		...
		/// <param name="param_Oit_GuidOrderID">Value for the parameter @Oit_GuidOrderID.</param>
		/// <param name="param_Oit_GuidProductID">Value for the parameter @Oit_GuidProductID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Oit_GuidID, System.Data.SqlTypes.SqlGuid param_Oit_GuidOrderID, System.Data.SqlTypes.SqlGuid param_Oit_GuidProductID) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblOrderItem_Full();
			...
			SPs.spS_tblOrderItem_Full SP = new SPs.spS_tblOrderItem_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_tblOrderItem_Full", "RefreshData");
			}
		}
	}
}
