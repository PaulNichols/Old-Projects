...
namespace OlymarsDemo.Web.DataGrids {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:01", SqlObjectDependancyName="spS_tblOrderItem_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_tblOrderItem_SelectDisplay), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_tblOrderItem_SelectDisplay : System.Web.UI.WebControls.DataGrid {
		...
		/// WebDataGridCustom_spS_tblOrderItem_SelectDisplay class.
		/// </summary>
		public WebDataGridCustom_spS_tblOrderItem_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_tblOrderItem_SelectDisplay", "RefreshData");
			}
		}
	}
}
