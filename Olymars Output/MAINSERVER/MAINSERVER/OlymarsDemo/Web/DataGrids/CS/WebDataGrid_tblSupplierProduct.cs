...
namespace OlymarsDemo.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'tblSupplierProduct' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_tblSupplierProduct), "WebDataGrid.bmp")]
	public sealed class WebDataGrid_tblSupplierProduct : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataGrids.WebDataGrid_tblSupplierProduct class.
		/// </summary>
		public WebDataGrid_tblSupplierProduct() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGrid_tblSupplierProduct : System.Web.UI.WebControls.DataGrid", "RefreshData");
			}
		}
	}
}
