...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_tblSupplierProduct_Full), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_tblSupplierProduct_Full : System.Web.UI.WebControls.DataGrid {
		...
		/// WebDataGridCustom_spS_tblSupplierProduct_Full class.
		/// </summary>
		public WebDataGridCustom_spS_tblSupplierProduct_Full() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_tblSupplierProduct_Full", "RefreshData");
			}
		}
	}
}
