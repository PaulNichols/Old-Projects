...
namespace OlymarsDemo.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'tblCustomer' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_tblCustomer), "WebDataGrid.bmp")]
	public sealed class WebDataGrid_tblCustomer : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataGrids.WebDataGrid_tblCustomer class.
		/// </summary>
		public WebDataGrid_tblCustomer() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGrid_tblCustomer : System.Web.UI.WebControls.DataGrid", "RefreshData");
			}
		}
	}
}
