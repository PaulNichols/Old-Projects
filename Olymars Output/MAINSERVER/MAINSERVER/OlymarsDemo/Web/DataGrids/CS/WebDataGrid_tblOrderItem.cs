...
namespace OlymarsDemo.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'tblOrderItem' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_tblOrderItem), "WebDataGrid.bmp")]
	public sealed class WebDataGrid_tblOrderItem : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataGrids.WebDataGrid_tblOrderItem class.
		/// </summary>
		public WebDataGrid_tblOrderItem() : base() {
