...
namespace OlymarsDemo.Web.DataGrids {
	...
	/// 'spS_xReadOrderDateAmount' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:01", SqlObjectDependancyName="spS_xReadOrderDateAmount", SqlObjectDependancyRevision=64)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_xReadOrderDateAmount), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_xReadOrderDateAmount : System.Web.UI.WebControls.DataGrid {

		private string tableName;
		private Params.spS_xReadOrderDateAmount param;
		private System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID = System.Data.SqlTypes.SqlInt32.Null;
		private System.Data.SqlTypes.SqlBoolean param_ReturnXML = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		public Params.spS_xReadOrderDateAmount SP_Parameter {
		...
		/// WebDataGridCustom_spS_xReadOrderDateAmount class.
		/// </summary>
		public WebDataGridCustom_spS_xReadOrderDateAmount() : base() {
		...
		public void Initialize(string connectionString, string primaryKey, string tableName, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(string connectionString, string primaryKey, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string primaryKey, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_xReadOrderDateAmount();
			...
			if (!this.param_ReturnXML.IsNull) {

				this.param.Param_ReturnXML = this.param_ReturnXML;
			}

			System.Data.DataSet DS = null;
			
			SPs.spS_xReadOrderDateAmount SP = new SPs.spS_xReadOrderDateAmount();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_xReadOrderDateAmount", "RefreshData");
			}
		}
	}
}
