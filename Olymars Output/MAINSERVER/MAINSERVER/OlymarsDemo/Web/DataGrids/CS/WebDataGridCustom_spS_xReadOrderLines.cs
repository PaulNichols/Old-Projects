...
namespace OlymarsDemo.Web.DataGrids {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:01", SqlObjectDependancyName="spS_xReadOrderLines", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_xReadOrderLines), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_xReadOrderLines : System.Web.UI.WebControls.DataGrid {
		...
		/// WebDataGridCustom_spS_xReadOrderLines class.
		/// </summary>
		public WebDataGridCustom_spS_xReadOrderLines() : base() {
		...
		public void Initialize(string connectionString, string primaryKey, string tableName, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		/// <param name="primaryKey">The field that represents a primary key.</param>
		/// <param name="param_OrderID">Value for the parameter @OrderID.</param>
		public void Initialize(string connectionString, string primaryKey, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_OrderID">Value for the parameter @OrderID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string primaryKey, string tableName, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		/// <param name="primaryKey">The field that represents a primary key.</param>
		/// <param name="param_OrderID">Value for the parameter @OrderID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string primaryKey, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_xReadOrderLines", "RefreshData");
			}
		}
	}
}
