...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_xProductQuantityPerOrder), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_xProductQuantityPerOrder : System.Web.UI.WebControls.DataGrid {
		...
		/// WebDataGridCustom_spS_xProductQuantityPerOrder class.
		/// </summary>
		public WebDataGridCustom_spS_xProductQuantityPerOrder() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_xProductQuantityPerOrder", "RefreshData");
			}
		}
	}
}
