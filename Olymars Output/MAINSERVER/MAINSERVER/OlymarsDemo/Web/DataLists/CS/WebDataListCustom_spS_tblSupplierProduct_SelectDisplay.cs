...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_tblSupplierProduct_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_tblSupplierProduct_SelectDisplay : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_tblSupplierProduct_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_tblSupplierProduct_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataListCustom_spS_tblSupplierProduct_SelectDisplay", "RefreshData");
			}
		}
	}
}
