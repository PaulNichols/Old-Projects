...
namespace OlymarsDemo.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'tblSupplierProduct' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_tblSupplierProduct), "WebDataList.bmp")]
	public sealed class WebDataList_tblSupplierProduct : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataLists.WebDataList_tblSupplierProduct class.
		/// </summary>
		public WebDataList_tblSupplierProduct() : base() {
