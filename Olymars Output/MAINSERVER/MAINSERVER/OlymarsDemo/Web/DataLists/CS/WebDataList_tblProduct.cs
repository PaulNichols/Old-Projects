...
namespace OlymarsDemo.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'tblProduct' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:23", SqlObjectDependancyName="tblProduct", SqlObjectDependancyRevision=816)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_tblProduct), "WebDataList.bmp")]
	public sealed class WebDataList_tblProduct : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the OlymarsDemo.DataClasses.Parameters.spS_tblProduct class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataLists.WebDataList_tblProduct class.
		/// </summary>
		public WebDataList_tblProduct() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (!this.FK_Pro_LngCategoryID.IsNull) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_tblProduct"].DefaultView;
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataList_tblProduct : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
