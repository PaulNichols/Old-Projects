...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_tblOrderItem_Full), "WebDataList.bmp")]
	public class WebDataListCustom_spS_tblOrderItem_Full : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_tblOrderItem_Full class.
		/// </summary>
		public WebDataListCustom_spS_tblOrderItem_Full() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataListCustom_spS_tblOrderItem_Full", "RefreshData");
			}
		}
	}
}
