...
namespace OlymarsDemo.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'tblCategory' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:23", SqlObjectDependancyName="tblCategory", SqlObjectDependancyRevision=416)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_tblCategory), "WebDataList.bmp")]
	public sealed class WebDataList_tblCategory : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the OlymarsDemo.DataClasses.Parameters.spS_tblCategory class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataLists.WebDataList_tblCategory class.
		/// </summary>
		public WebDataList_tblCategory() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_tblCategory"].DefaultView;
				this.DataKeyField = "Cat_LngID";
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataList_tblCategory : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
