...
namespace OlymarsDemo.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'tblOrderItem' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:23", SqlObjectDependancyName="tblOrderItem", SqlObjectDependancyRevision=848)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_tblOrderItem), "WebDataList.bmp")]
	public sealed class WebDataList_tblOrderItem : System.Web.UI.WebControls.DataList {

		private Params.spS_tblOrderItem param;
		...
		/// <summary>
		/// Returns the OlymarsDemo.DataClasses.Parameters.spS_tblOrderItem class that was used to populate this control.
		/// </summary>
		public Params.spS_tblOrderItem SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataLists.WebDataList_tblOrderItem class.
		/// </summary>
		public WebDataList_tblOrderItem() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataList_tblOrderItem : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
