...
namespace OlymarsDemo.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'tblCustomer' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:23", SqlObjectDependancyName="tblCustomer", SqlObjectDependancyRevision=736)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_tblCustomer), "WebDataList.bmp")]
	public sealed class WebDataList_tblCustomer : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the OlymarsDemo.DataClasses.Parameters.spS_tblCustomer class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataLists.WebDataList_tblCustomer class.
		/// </summary>
		public WebDataList_tblCustomer() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_tblCustomer"].DefaultView;
				this.DataKeyField = "Cus_LngID";
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDataList_tblCustomer : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
