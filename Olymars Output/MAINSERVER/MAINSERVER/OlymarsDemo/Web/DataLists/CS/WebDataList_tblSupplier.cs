...
namespace OlymarsDemo.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'tblSupplier' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_tblSupplier), "WebDataList.bmp")]
	public sealed class WebDataList_tblSupplier : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DataLists.WebDataList_tblSupplier class.
		/// </summary>
		public WebDataList_tblSupplier() : base() {
