...
namespace OlymarsDemo.Web.Repeaters {
	...
	/// 'spS_tblSupplierProduct_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:01", SqlObjectDependancyName="spS_tblSupplierProduct_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_tblSupplierProduct_Full), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_tblSupplierProduct_Full : System.Web.UI.WebControls.Repeater {

		private string tableName;
		private Params.spS_tblSupplierProduct_Full param;
		...
		/// </summary>
		public Params.spS_tblSupplierProduct_Full SP_Parameter {
		...
		/// WebRepeaterCustom_spS_tblSupplierProduct_Full class.
		/// </summary>
		public WebRepeaterCustom_spS_tblSupplierProduct_Full() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid param_Spr_GuidSupplierID) {
		...
		/// <param name="param_Spr_GuidProductID">Value for the parameter @Spr_GuidProductID.</param>
		/// <param name="param_Spr_GuidSupplierID">Value for the parameter @Spr_GuidSupplierID.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid param_Spr_GuidSupplierID) {
		...
		/// <param name="param_Spr_GuidProductID">Value for the parameter @Spr_GuidProductID.</param>
		/// <param name="param_Spr_GuidSupplierID">Value for the parameter @Spr_GuidSupplierID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid param_Spr_GuidSupplierID) {
		...
		/// <param name="param_Spr_GuidProductID">Value for the parameter @Spr_GuidProductID.</param>
		/// <param name="param_Spr_GuidSupplierID">Value for the parameter @Spr_GuidSupplierID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Spr_GuidProductID, System.Data.SqlTypes.SqlGuid param_Spr_GuidSupplierID) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblSupplierProduct_Full();
			...
			SPs.spS_tblSupplierProduct_Full SP = new SPs.spS_tblSupplierProduct_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_tblSupplierProduct_Full", "RefreshData");
			}
		}
	}
}
