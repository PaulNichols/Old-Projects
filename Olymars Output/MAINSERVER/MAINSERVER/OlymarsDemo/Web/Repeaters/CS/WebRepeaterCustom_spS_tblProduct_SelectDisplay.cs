...
[assembly:System.Web.UI.TagPrefix("OlymarsDemo.Web.Repeaters", "OlymarsDemoRepeaters")]
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_tblProduct_SelectDisplay), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_tblProduct_SelectDisplay : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_tblProduct_SelectDisplay class.
		/// </summary>
		public WebRepeaterCustom_spS_tblProduct_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_tblProduct_SelectDisplay", "RefreshData");
			}
		}
	}
}
