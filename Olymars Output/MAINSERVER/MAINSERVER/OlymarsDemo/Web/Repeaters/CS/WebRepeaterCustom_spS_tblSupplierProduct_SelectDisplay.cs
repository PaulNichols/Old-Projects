...
namespace OlymarsDemo.Web.Repeaters {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:01", SqlObjectDependancyName="spS_tblSupplierProduct_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_tblSupplierProduct_SelectDisplay), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_tblSupplierProduct_SelectDisplay : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_tblSupplierProduct_SelectDisplay class.
		/// </summary>
		public WebRepeaterCustom_spS_tblSupplierProduct_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_tblSupplierProduct_SelectDisplay", "RefreshData");
			}
		}
	}
}
