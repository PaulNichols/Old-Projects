...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_xReadOrderLines), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_xReadOrderLines : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_xReadOrderLines class.
		/// </summary>
		public WebRepeaterCustom_spS_xReadOrderLines() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_xReadOrderLines", "RefreshData");
			}
		}
	}
}
