...
namespace OlymarsDemo.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'tblProduct' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_tblProduct), "WebRepeater.bmp")]
	public sealed class WebRepeater_tblProduct : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.Repeaters.WebRepeater_tblProduct class.
		/// </summary>
		public WebRepeater_tblProduct() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeater_tblProduct : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
