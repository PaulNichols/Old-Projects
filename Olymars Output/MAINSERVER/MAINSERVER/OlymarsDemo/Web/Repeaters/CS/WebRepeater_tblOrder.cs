...
namespace OlymarsDemo.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'tblOrder' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:23", SqlObjectDependancyName="tblOrder", SqlObjectDependancyRevision=800)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_tblOrder), "WebRepeater.bmp")]
	public sealed class WebRepeater_tblOrder : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Returns the OlymarsDemo.DataClasses.Parameters.spS_tblOrder class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.Repeaters.WebRepeater_tblOrder class.
		/// </summary>
		public WebRepeater_tblOrder() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeater_tblOrder : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
