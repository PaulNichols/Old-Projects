...
namespace OlymarsDemo.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'tblSupplier' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:23", SqlObjectDependancyName="tblSupplier", SqlObjectDependancyRevision=416)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_tblSupplier), "WebRepeater.bmp")]
	public sealed class WebRepeater_tblSupplier : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.Repeaters.WebRepeater_tblSupplier class.
		/// </summary>
		public WebRepeater_tblSupplier() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeater_tblSupplier : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
