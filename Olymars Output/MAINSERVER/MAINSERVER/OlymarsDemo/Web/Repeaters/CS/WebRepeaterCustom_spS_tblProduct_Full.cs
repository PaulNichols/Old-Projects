...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_tblProduct_Full), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_tblProduct_Full : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_tblProduct_Full class.
		/// </summary>
		public WebRepeaterCustom_spS_tblProduct_Full() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_tblProduct_Full", "RefreshData");
			}
		}
	}
}
