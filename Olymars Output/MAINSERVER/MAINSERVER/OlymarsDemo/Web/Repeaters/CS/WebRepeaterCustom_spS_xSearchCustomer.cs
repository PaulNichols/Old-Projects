...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_xSearchCustomer), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_xSearchCustomer : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_xSearchCustomer class.
		/// </summary>
		public WebRepeaterCustom_spS_xSearchCustomer() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlString param_LastName, System.Data.SqlTypes.SqlString param_FirstName) {
		...
		/// <param name="param_LastName">Value for the parameter @LastName.</param>
		/// <param name="param_FirstName">Value for the parameter @FirstName.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlString param_LastName, System.Data.SqlTypes.SqlString param_FirstName) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_xSearchCustomer", "RefreshData");
			}
		}
	}
}
