...
namespace OlymarsDemo.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'tblOrderItem' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_tblOrderItem), "WebRepeater.bmp")]
	public sealed class WebRepeater_tblOrderItem : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.Repeaters.WebRepeater_tblOrderItem class.
		/// </summary>
		public WebRepeater_tblOrderItem() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeater_tblOrderItem : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
