...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_xReadOrderItems), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_xReadOrderItems : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_xReadOrderItems class.
		/// </summary>
		public WebRepeaterCustom_spS_xReadOrderItems() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_xReadOrderItems", "RefreshData");
			}
		}
	}
}
