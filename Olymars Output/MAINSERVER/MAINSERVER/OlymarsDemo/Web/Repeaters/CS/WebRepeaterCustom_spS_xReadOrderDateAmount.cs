...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_xReadOrderDateAmount), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_xReadOrderDateAmount : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_xReadOrderDateAmount class.
		/// </summary>
		public WebRepeaterCustom_spS_xReadOrderDateAmount() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_xReadOrderDateAmount", "RefreshData");
			}
		}
	}
}
