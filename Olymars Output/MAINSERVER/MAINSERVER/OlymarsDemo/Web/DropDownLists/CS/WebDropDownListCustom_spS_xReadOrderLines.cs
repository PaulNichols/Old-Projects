...
namespace OlymarsDemo.Web.DropDownLists {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:59", SqlObjectDependancyName="spS_xReadOrderLines", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_xReadOrderLines), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_xReadOrderLines : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_xReadOrderLines class.
		/// </summary>
		public WebDropDownListCustom_spS_xReadOrderLines() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_xReadOrderLines", "RefreshData");
			}
