...
namespace OlymarsDemo.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'tblCustomer' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_tblCustomer), "WebDropDownList.bmp")]
	public sealed class WebDropDownList_tblCustomer : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DropDownLists.WebDropDownList_tblCustomer class.
		/// </summary>
		public WebDropDownList_tblCustomer() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_Cus_LngID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownList_tblCustomer : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
