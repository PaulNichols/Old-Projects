...
namespace OlymarsDemo.Web.DropDownLists {
	...
	/// 'spS_tblOrderItem' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:59", SqlObjectDependancyName="spS_tblOrderItem", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_tblOrderItem), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_tblOrderItem : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_tblOrderItem class.
		/// </summary>
		public WebDropDownListCustom_spS_tblOrderItem() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_tblOrderItem", "RefreshData");
			}
