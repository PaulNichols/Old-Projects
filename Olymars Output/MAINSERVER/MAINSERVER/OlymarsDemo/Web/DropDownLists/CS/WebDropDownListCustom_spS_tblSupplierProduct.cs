...
namespace OlymarsDemo.Web.DropDownLists {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:59", SqlObjectDependancyName="spS_tblSupplierProduct", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_tblSupplierProduct), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_tblSupplierProduct : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_tblSupplierProduct class.
		/// </summary>
		public WebDropDownListCustom_spS_tblSupplierProduct() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_tblSupplierProduct", "RefreshData");
			}
