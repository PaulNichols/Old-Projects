...
namespace OlymarsDemo.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'tblProduct' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_tblProduct), "WebDropDownList.bmp")]
	public sealed class WebDropDownList_tblProduct : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DropDownLists.WebDropDownList_tblProduct class.
		/// </summary>
		public WebDropDownList_tblProduct() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Pro_GuidID) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Pro_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownList_tblProduct : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
