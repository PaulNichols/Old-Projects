...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_tblSupplierProduct_Full), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_tblSupplierProduct_Full : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_tblSupplierProduct_Full class.
		/// </summary>
		public WebDropDownListCustom_spS_tblSupplierProduct_Full() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_tblSupplierProduct_Full", "RefreshData");
			}
