...
namespace OlymarsDemo.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'tblSupplier' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_tblSupplier), "WebDropDownList.bmp")]
	public sealed class WebDropDownList_tblSupplier : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.DropDownLists.WebDropDownList_tblSupplier class.
		/// </summary>
		public WebDropDownList_tblSupplier() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Sup_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebDropDownList_tblSupplier : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
