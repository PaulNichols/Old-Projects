...
namespace OlymarsDemo.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'tblSupplier' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_tblSupplier), "WebCheckBoxList.bmp")]
	public sealed class WebCheckBoxList_tblSupplier : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.CheckBoxLists.WebCheckBoxList_tblSupplier class.
		/// </summary>
		public WebCheckBoxList_tblSupplier() : base() {
		...
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_Sup_GuidID, int startRecord, int maxRecords) {
			...
			if (ArrayOf_PK_Sup_GuidID != null && ArrayOf_PK_Sup_GuidID.Count > 0) {
				...
				System.Data.SqlTypes.SqlGuid[] typedArray = new System.Data.SqlTypes.SqlGuid[ArrayOf_PK_Sup_GuidID.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_Sup_GuidID) {
					...
					if (item is System.Data.SqlTypes.SqlGuid) {
						...
						throw new InvalidOperationException("ArrayOf_PK_Sup_GuidID does not contain ONLY System.Data.SqlTypes.SqlGuid or System.Guid elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Sup_GuidID">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Sup_GuidID) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Sup_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataValueField = SPs.spS_tblSupplier_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_tblSupplier_Display.Resultset1.Fields.Column_Display.ColumnName;
				if (this.doDataBindAfterRefreshData) {

					this.DataBind();
				}

				if (ArrayOf_PK_Sup_GuidID != null) {

					this.SetRecordsChecked(ArrayOf_PK_Sup_GuidID, true);
				}
			}
			else {

				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxList_tblSupplier : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		public void SetRecordsChecked(System.Collections.ArrayList ArrayOf_PK_Sup_GuidID, bool value) {
		...
		/// <param name="ArrayOf_PK_Sup_GuidID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Sup_GuidID, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Sup_GuidID != null) {

				foreach (System.Data.SqlTypes.SqlGuid PK_Sup_GuidID in ArrayOf_PK_Sup_GuidID) {

					System.Web.UI.WebControls.ListItem listItem = this.Items.FindByValue(PK_Sup_GuidID.Value.ToString());
					if (listItem != null) {
