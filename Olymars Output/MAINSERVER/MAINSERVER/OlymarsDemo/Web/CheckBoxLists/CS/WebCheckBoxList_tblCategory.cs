...
namespace OlymarsDemo.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'tblCategory' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_tblCategory), "WebCheckBoxList.bmp")]
	public sealed class WebCheckBoxList_tblCategory : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.CheckBoxLists.WebCheckBoxList_tblCategory class.
		/// </summary>
		public WebCheckBoxList_tblCategory() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cat_LngID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataValueField = SPs.spS_tblCategory_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_tblCategory_Display.Resultset1.Fields.Column_Display.ColumnName;
				if (this.doDataBindAfterRefreshData) {

					this.DataBind();
				}

				if (ArrayOf_PK_Cat_LngID != null) {

					this.SetRecordsChecked(ArrayOf_PK_Cat_LngID, true);
				}
			}
			else {

				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxList_tblCategory : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		public void SetRecordsChecked(System.Collections.ArrayList ArrayOf_PK_Cat_LngID, bool value) {
		...
		/// <param name="ArrayOf_PK_Cat_LngID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cat_LngID, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Cat_LngID != null) {

				foreach (System.Data.SqlTypes.SqlInt32 PK_Cat_LngID in ArrayOf_PK_Cat_LngID) {

					System.Web.UI.WebControls.ListItem listItem = this.Items.FindByValue(PK_Cat_LngID.Value.ToString());
					if (listItem != null) {
