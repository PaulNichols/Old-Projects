...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_tblOrderItem_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_tblOrderItem_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_tblOrderItem_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_tblOrderItem_SelectDisplay() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_tblOrderItem_SelectDisplay", "RefreshData");
			}
