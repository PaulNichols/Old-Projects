...
namespace OlymarsDemo.Web.CheckBoxLists {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:12:00", SqlObjectDependancyName="spS_xProductQuantityPerOrder", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_xProductQuantityPerOrder), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_xProductQuantityPerOrder : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_xProductQuantityPerOrder class.
		/// </summary>
		public WebCheckBoxListCustom_spS_xProductQuantityPerOrder() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_xProductQuantityPerOrder", "RefreshData");
			}
