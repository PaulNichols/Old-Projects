...
namespace OlymarsDemo.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'tblOrderItem' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_tblOrderItem), "WebCheckBoxList.bmp")]
	public sealed class WebCheckBoxList_tblOrderItem : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.CheckBoxLists.WebCheckBoxList_tblOrderItem class.
		/// </summary>
		public WebCheckBoxList_tblOrderItem() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Oit_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				if (ArrayOf_PK_Oit_GuidID != null) {

					this.SetRecordsChecked(ArrayOf_PK_Oit_GuidID, true);
				}
			}
			else {

				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxList_tblOrderItem : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		public void SetRecordsChecked(System.Collections.ArrayList ArrayOf_PK_Oit_GuidID, bool value) {
		...
		/// <param name="ArrayOf_PK_Oit_GuidID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Oit_GuidID, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Oit_GuidID != null) {

				foreach (System.Data.SqlTypes.SqlGuid PK_Oit_GuidID in ArrayOf_PK_Oit_GuidID) {
