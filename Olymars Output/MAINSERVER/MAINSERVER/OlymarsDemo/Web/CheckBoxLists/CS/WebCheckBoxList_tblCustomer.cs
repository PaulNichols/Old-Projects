...
namespace OlymarsDemo.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'tblCustomer' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_tblCustomer), "WebCheckBoxList.bmp")]
	public sealed class WebCheckBoxList_tblCustomer : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.CheckBoxLists.WebCheckBoxList_tblCustomer class.
		/// </summary>
		public WebCheckBoxList_tblCustomer() : base() {
		...
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_Cus_LngID, int startRecord, int maxRecords) {
			...
			if (ArrayOf_PK_Cus_LngID != null && ArrayOf_PK_Cus_LngID.Count > 0) {
				...
				System.Data.SqlTypes.SqlInt32[] typedArray = new System.Data.SqlTypes.SqlInt32[ArrayOf_PK_Cus_LngID.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_Cus_LngID) {
					...
					if (item is System.Data.SqlTypes.SqlInt32) {
						...
						throw new InvalidOperationException("ArrayOf_PK_Cus_LngID does not contain ONLY System.Data.SqlTypes.SqlInt32 or System.Int32 elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Cus_LngID">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cus_LngID) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cus_LngID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				if (ArrayOf_PK_Cus_LngID != null) {

					this.SetRecordsChecked(ArrayOf_PK_Cus_LngID, true);
				}
			}
			else {

				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxList_tblCustomer : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		public void SetRecordsChecked(System.Collections.ArrayList ArrayOf_PK_Cus_LngID, bool value) {
		...
		/// <param name="ArrayOf_PK_Cus_LngID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cus_LngID, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Cus_LngID != null) {

				foreach (System.Data.SqlTypes.SqlInt32 PK_Cus_LngID in ArrayOf_PK_Cus_LngID) {
