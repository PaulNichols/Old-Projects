...
namespace OlymarsDemo.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'tblProduct' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_tblProduct), "WebCheckBoxList.bmp")]
	public sealed class WebCheckBoxList_tblProduct : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_tblProduct_Display param;
		private OlymarsDemo.AbstractClasses.Abstract_tblProduct oAbstract_tblProduct;
		...
		/// </summary>
		public Params.spS_tblProduct_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'tblProduct' abstract class so that you can access any table
		...
		/// </summary>
		public OlymarsDemo.AbstractClasses.Abstract_tblProduct Abstract_tblProduct {

			get {

				return(this.oAbstract_tblProduct);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_tblProduct = null;
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Web.CheckBoxLists.WebCheckBoxList_tblProduct class.
		/// </summary>
		public WebCheckBoxList_tblProduct() : base() {
		...
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_Pro_GuidID, int startRecord, int maxRecords) {
			...
			if (ArrayOf_PK_Pro_GuidID != null && ArrayOf_PK_Pro_GuidID.Count > 0) {
				...
				System.Data.SqlTypes.SqlGuid[] typedArray = new System.Data.SqlTypes.SqlGuid[ArrayOf_PK_Pro_GuidID.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_Pro_GuidID) {
					...
					if (item is System.Data.SqlTypes.SqlGuid) {
						...
						throw new InvalidOperationException("ArrayOf_PK_Pro_GuidID does not contain ONLY System.Data.SqlTypes.SqlGuid or System.Guid elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Pro_GuidID">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Pro_GuidID) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Pro_GuidID, int startRecord, int maxRecords) {

			this.param = new Params.spS_tblProduct_Display(true);
			...
			this.param.Param_Pro_LngCategoryID = this.FK_Pro_LngCategoryID;
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_tblProduct_Display"].DefaultView;
				this.DataValueField = SPs.spS_tblProduct_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_tblProduct_Display.Resultset1.Fields.Column_Display.ColumnName;
				if (this.doDataBindAfterRefreshData) {

					this.DataBind();
				}

				if (ArrayOf_PK_Pro_GuidID != null) {

					this.SetRecordsChecked(ArrayOf_PK_Pro_GuidID, true);
				}
			}
			else {

				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WebCheckBoxList_tblProduct : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		public void SetRecordsChecked(System.Collections.ArrayList ArrayOf_PK_Pro_GuidID, bool value) {
		...
		/// <param name="ArrayOf_PK_Pro_GuidID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Pro_GuidID, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Pro_GuidID != null) {

				foreach (System.Data.SqlTypes.SqlGuid PK_Pro_GuidID in ArrayOf_PK_Pro_GuidID) {

					System.Web.UI.WebControls.ListItem listItem = this.Items.FindByValue(PK_Pro_GuidID.Value.ToString());
					if (listItem != null) {
		...
		/// <summary>
		/// Loads the tblProduct abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_tblProduct != null) {

					oAbstract_tblProduct.Reset();
				}
				return(false);
			}

			System.Data.SqlTypes.SqlGuid PK_Pro_GuidID = new Guid(this.SelectedItem.Value);

			if (this.oAbstract_tblProduct == null) {

				switch (this.LastKnownConnectionType) {

					case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_tblProduct = new OlymarsDemo.AbstractClasses.Abstract_tblProduct(this.connectionString);
						break;

					case OlymarsDemo.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_tblProduct = new OlymarsDemo.AbstractClasses.Abstract_tblProduct(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_tblProduct.Refresh(PK_Pro_GuidID));
		}
	}
}
