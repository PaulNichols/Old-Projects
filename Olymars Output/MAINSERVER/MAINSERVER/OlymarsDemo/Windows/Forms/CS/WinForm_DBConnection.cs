...
namespace OlymarsDemo.Windows.Forms {
	...
	public class WinForm_DBConnection: System.Windows.Forms.Form {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Windows.Forms.WinForm_DBConnection class.
		/// </summary>
		...
		private void InitializeComponent() {
			...
			this.Text = "\'OlymarsDemo\' connection";
		...
		public string ConnectionString {
			...
			get {
				...
				if (chkIntegratedSecurity.Checked) {
					...
					connectionString = OlymarsDemo.DataClasses.Information.BuildConnectionString(txtServerName.Text, txtDatabase.Text, this.TimeOut, this.Pooled);
				}
				else {

					connectionString = OlymarsDemo.DataClasses.Information.BuildConnectionString(txtServerName.Text, txtDatabase.Text, txtUserID.Text, txtPassword.Text, this.TimeOut, this.Pooled);
				}
