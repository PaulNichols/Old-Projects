...
namespace OlymarsDemo.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'tblSupplier' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_tblSupplier), "WinDataGrid.bmp")]
	public sealed class WinDataGrid_tblSupplier : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplier sqlDataAdapter = null;
		...
		/// </summary>
		public OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplier SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "tblSupplier");
		}
		...
		/// <summary>
		/// Initializes a new instance of the OlymarsDemo.Windows.DataGrids.WinDataGrid_tblSupplier class.
		/// </summary>
		public WinDataGrid_tblSupplier() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			switch (this.LastKnownConnectionType) {
 				...
 				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					this.sqlDataAdapter = new OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplier(this.connectionString, "tblSupplier");
					break;

 				case OlymarsDemo.DataClasses.ConnectionType.SqlConnection:
					this.sqlDataAdapter = new OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplier(this.sqlConnection, "tblSupplier");
					break;
			}
			...
			this.dataSet.Tables["tblSupplier"].Columns["Sup_GuidID"].Caption = "Sup_GuidID (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Sup_GuidID\" column)";
			this.dataSet.Tables["tblSupplier"].Columns["Sup_StrName"].Caption = "Sup_StrName (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Sup_StrName\" column)";

			this.bindingInProgress = true;
			this.DataSource = this.dataSet .Tables["tblSupplier"].DefaultView;
