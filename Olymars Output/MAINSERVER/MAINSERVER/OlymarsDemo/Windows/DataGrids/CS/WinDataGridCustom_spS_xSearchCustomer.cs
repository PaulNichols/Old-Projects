...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_xSearchCustomer), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_xSearchCustomer : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_xSearchCustomer class.
		/// </summary>
		public WinDataGridCustom_spS_xSearchCustomer() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_xSearchCustomer", "RefreshData");
			}
		}
	}
}
