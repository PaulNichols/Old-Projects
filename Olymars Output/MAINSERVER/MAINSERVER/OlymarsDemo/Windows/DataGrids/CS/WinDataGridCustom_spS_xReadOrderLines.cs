...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_xReadOrderLines), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_xReadOrderLines : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_xReadOrderLines class.
		/// </summary>
		public WinDataGridCustom_spS_xReadOrderLines() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_xReadOrderLines", "RefreshData");
			}
		}
	}
}
