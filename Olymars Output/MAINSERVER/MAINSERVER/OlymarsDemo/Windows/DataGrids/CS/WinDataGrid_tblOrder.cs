...
namespace OlymarsDemo.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'tblOrder' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_tblOrder), "WinDataGrid.bmp")]
	public sealed class WinDataGrid_tblOrder : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrder sqlDataAdapter = null;
		...
		/// </summary>
		public OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrder SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "tblOrder");
		}
		...
		/// <summary>
		/// Initializes a new instance of the OlymarsDemo.Windows.DataGrids.WinDataGrid_tblOrder class.
		/// </summary>
		public WinDataGrid_tblOrder() : base() {
