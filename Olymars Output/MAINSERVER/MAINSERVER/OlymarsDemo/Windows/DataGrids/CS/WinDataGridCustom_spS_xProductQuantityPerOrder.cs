...
namespace OlymarsDemo.Windows.DataGrids {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:59", SqlObjectDependancyName="spS_xProductQuantityPerOrder", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_xProductQuantityPerOrder), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_xProductQuantityPerOrder : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_xProductQuantityPerOrder class.
		/// </summary>
		public WinDataGridCustom_spS_xProductQuantityPerOrder() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_ProductID) {
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_ProductID">Value for the parameter @ProductID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_ProductID) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_xProductQuantityPerOrder", "RefreshData");
			}
		}
	}
}
