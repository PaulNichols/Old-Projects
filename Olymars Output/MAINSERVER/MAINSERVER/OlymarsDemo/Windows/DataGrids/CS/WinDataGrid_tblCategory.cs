...
namespace OlymarsDemo.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'tblCategory' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_tblCategory), "WinDataGrid.bmp")]
	public sealed class WinDataGrid_tblCategory : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblCategory sqlDataAdapter = null;
		...
		/// </summary>
		public OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblCategory SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "tblCategory");
		}
		...
		/// <summary>
		/// Initializes a new instance of the OlymarsDemo.Windows.DataGrids.WinDataGrid_tblCategory class.
		/// </summary>
		public WinDataGrid_tblCategory() : base() {
