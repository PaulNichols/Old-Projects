...
namespace OlymarsDemo.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'tblOrderItem' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_tblOrderItem), "WinDataGrid.bmp")]
	public sealed class WinDataGrid_tblOrderItem : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrderItem sqlDataAdapter = null;
		...
		/// </summary>
		public OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrderItem SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "tblOrderItem");
		}
		...
		/// <summary>
		/// Initializes a new instance of the OlymarsDemo.Windows.DataGrids.WinDataGrid_tblOrderItem class.
		/// </summary>
		public WinDataGrid_tblOrderItem() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			switch (this.LastKnownConnectionType) {
 				...
 				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					this.sqlDataAdapter = new OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrderItem(this.connectionString, this.FK_Oit_GuidOrderID, this.FK_Oit_GuidProductID, "tblOrderItem");
					break;

 				case OlymarsDemo.DataClasses.ConnectionType.SqlConnection:
					this.sqlDataAdapter = new OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblOrderItem(this.sqlConnection, this.FK_Oit_GuidOrderID, this.FK_Oit_GuidProductID, "tblOrderItem");
					break;
			}
			...
			this.dataSet.Tables["tblOrderItem"].Columns["Oit_GuidID"].Caption = "Oit_GuidID (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Oit_GuidID\" column)";
			this.dataSet.Tables["tblOrderItem"].Columns["Oit_GuidOrderID"].Caption = "Oit_GuidOrderID (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Oit_GuidOrderID\" column)";
			this.dataSet.Tables["tblOrderItem"].Columns["Oit_GuidProductID"].Caption = "Oit_GuidProductID (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Oit_GuidProductID\" column)";
			this.dataSet.Tables["tblOrderItem"].Columns["Oit_LngAmount"].Caption = "Oit_LngAmount (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Oit_LngAmount\" column)";

			this.bindingInProgress = true;
			this.DataSource = this.dataSet .Tables["tblOrderItem"].DefaultView;
