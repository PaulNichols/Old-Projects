...
namespace OlymarsDemo.Windows.DataGrids {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:59", SqlObjectDependancyName="spS_tblOrderItem_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_tblOrderItem_SelectDisplay), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_tblOrderItem_SelectDisplay : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_tblOrderItem_SelectDisplay class.
		/// </summary>
		public WinDataGridCustom_spS_tblOrderItem_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_tblOrderItem_SelectDisplay", "RefreshData");
			}
		}
	}
}
