...
namespace OlymarsDemo.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'tblSupplierProduct' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/11/28 15:05:22", SqlObjectDependancyName="tblSupplierProduct", SqlObjectDependancyRevision=544)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_tblSupplierProduct), "WinDataGrid.bmp")]
	public sealed class WinDataGrid_tblSupplierProduct : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplierProduct sqlDataAdapter = null;
		...
		/// </summary>
		public OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplierProduct SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "tblSupplierProduct");
		}
		...
		/// <summary>
		/// Initializes a new instance of the OlymarsDemo.Windows.DataGrids.WinDataGrid_tblSupplierProduct class.
		/// </summary>
		public WinDataGrid_tblSupplierProduct() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			switch (this.LastKnownConnectionType) {
 				...
 				case OlymarsDemo.DataClasses.ConnectionType.ConnectionString:
					this.sqlDataAdapter = new OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplierProduct(this.connectionString, this.FK_Spr_GuidProductID, this.FK_Spr_GuidSupplierID, "tblSupplierProduct");
					break;

 				case OlymarsDemo.DataClasses.ConnectionType.SqlConnection:
					this.sqlDataAdapter = new OlymarsDemo.SqlDataAdapters.SqlDataAdapter_tblSupplierProduct(this.sqlConnection, this.FK_Spr_GuidProductID, this.FK_Spr_GuidSupplierID, "tblSupplierProduct");
					break;
			}
			...
			this.dataSet.Tables["tblSupplierProduct"].Columns["Spr_GuidProductID"].Caption = "Spr_GuidProductID (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Spr_GuidProductID\" column)";
			this.dataSet.Tables["tblSupplierProduct"].Columns["Spr_GuidSupplierID"].Caption = "Spr_GuidSupplierID (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Spr_GuidSupplierID\" column)";

			this.bindingInProgress = true;
			this.DataSource = this.dataSet .Tables["tblSupplierProduct"].DefaultView;
