...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_xReadOrderDateAmount), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_xReadOrderDateAmount : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_xReadOrderDateAmount class.
		/// </summary>
		public WinDataGridCustom_spS_xReadOrderDateAmount() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_xReadOrderDateAmount", "RefreshData");
			}
		}
	}
}
