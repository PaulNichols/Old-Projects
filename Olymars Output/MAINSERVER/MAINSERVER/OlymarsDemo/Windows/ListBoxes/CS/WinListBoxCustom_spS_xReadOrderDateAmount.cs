...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBoxCustom_spS_xReadOrderDateAmount), "WinListBox.bmp")]
	public class WinListBoxCustom_spS_xReadOrderDateAmount : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WinListBoxCustom_spS_xReadOrderDateAmount class.
		/// </summary>
		public WinListBoxCustom_spS_xReadOrderDateAmount() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinListBoxCustom_spS_xReadOrderDateAmount", "RefreshData");
			}
