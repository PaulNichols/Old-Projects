...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBoxCustom_spS_tblCustomer), "WinListBox.bmp")]
	public class WinListBoxCustom_spS_tblCustomer : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WinListBoxCustom_spS_tblCustomer class.
		/// </summary>
		public WinListBoxCustom_spS_tblCustomer() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinListBoxCustom_spS_tblCustomer", "RefreshData");
			}
