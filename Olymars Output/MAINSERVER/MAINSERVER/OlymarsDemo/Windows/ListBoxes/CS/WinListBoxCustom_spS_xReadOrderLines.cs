...
namespace OlymarsDemo.Windows.ListBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:58", SqlObjectDependancyName="spS_xReadOrderLines", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBoxCustom_spS_xReadOrderLines), "WinListBox.bmp")]
	public class WinListBoxCustom_spS_xReadOrderLines : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WinListBoxCustom_spS_xReadOrderLines class.
		/// </summary>
		public WinListBoxCustom_spS_xReadOrderLines() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinListBoxCustom_spS_xReadOrderLines", "RefreshData");
			}
