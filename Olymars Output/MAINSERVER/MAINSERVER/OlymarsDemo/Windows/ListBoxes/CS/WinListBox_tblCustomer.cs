...
namespace OlymarsDemo.Windows.ListBoxes {
	...
	public sealed class WinListBox_tblCustomer : System.Windows.Forms.ListBox {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_Cus_LngID, int startRecord, int maxRecords) {
			...
			if (!PK_Cus_LngID.IsNull && this.SelectionMode == System.Windows.Forms.SelectionMode.None) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinListBox_tblCustomer : System.Windows.Forms.ListBox", "RefreshData");
			}
