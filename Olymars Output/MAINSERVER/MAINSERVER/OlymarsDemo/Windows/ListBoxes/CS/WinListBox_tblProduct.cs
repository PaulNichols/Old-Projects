...
namespace OlymarsDemo.Windows.ListBoxes {
	...
	public sealed class WinListBox_tblProduct : System.Windows.Forms.ListBox {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Pro_GuidID, int startRecord, int maxRecords) {
			...
			if (!PK_Pro_GuidID.IsNull && this.SelectionMode == System.Windows.Forms.SelectionMode.None) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinListBox_tblProduct : System.Windows.Forms.ListBox", "RefreshData");
			}
