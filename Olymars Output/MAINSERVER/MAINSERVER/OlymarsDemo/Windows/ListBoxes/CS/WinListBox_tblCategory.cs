...
namespace OlymarsDemo.Windows.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ListBox class and was built to display the 'tblCategory' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBox_tblCategory), "WinListBox.bmp")]
	public sealed class WinListBox_tblCategory : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Windows.ListBoxes.WinListBox_tblCategory class.
		/// </summary>
		public WinListBox_tblCategory() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_Cat_LngID, int startRecord, int maxRecords) {
			...
			if (!PK_Cat_LngID.IsNull && this.SelectionMode == System.Windows.Forms.SelectionMode.None) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinListBox_tblCategory : System.Windows.Forms.ListBox", "RefreshData");
			}
