...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'tblProduct' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_tblProduct), "WinComboBox.bmp")]
	public sealed class WinComboBox_tblProduct : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Windows.ComboBoxes.WinComboBox_tblProduct class.
		/// </summary>
		public WinComboBox_tblProduct() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Pro_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBox_tblProduct : System.Windows.Forms.ComboBox", "RefreshData");
			}
