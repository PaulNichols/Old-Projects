...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblSupplierProduct_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblSupplierProduct_Full), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblSupplierProduct_Full : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblSupplierProduct_Full class.
		/// </summary>
		public WinComboBoxCustom_spS_tblSupplierProduct_Full() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblSupplierProduct_Full", "RefreshData");
			}
