...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:58", SqlObjectDependancyName="spS_xSearchCustomer", SqlObjectDependancyRevision=64)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_xSearchCustomer), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_xSearchCustomer : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_xSearchCustomer class.
		/// </summary>
		public WinComboBoxCustom_spS_xSearchCustomer() : base() {
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_LastName, System.Data.SqlTypes.SqlString param_FirstName) {
		...
		/// <param name="param_LastName">Value for the parameter @LastName.</param>
		/// <param name="param_FirstName">Value for the parameter @FirstName.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_LastName, System.Data.SqlTypes.SqlString param_FirstName) {
		...
		/// <param name="param_LastName">Value for the parameter @LastName.</param>
		/// <param name="param_FirstName">Value for the parameter @FirstName.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_LastName, System.Data.SqlTypes.SqlString param_FirstName) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_xSearchCustomer", "RefreshData");
			}
