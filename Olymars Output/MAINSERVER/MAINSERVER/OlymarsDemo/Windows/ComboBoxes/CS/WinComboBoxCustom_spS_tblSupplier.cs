...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// 'spS_tblSupplier' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblSupplier", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblSupplier), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblSupplier : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_tblSupplier param;
		private System.Data.SqlTypes.SqlGuid param_Sup_GuidID = System.Data.SqlTypes.SqlGuid.Null;
		...
		protected override void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.param_Sup_GuidID = System.Data.SqlTypes.SqlGuid.Null;
				if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblSupplier class.
		/// </summary>
		public WinComboBoxCustom_spS_tblSupplier() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_tblSupplier' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_Sup_GuidID">Value for the parameter @Sup_GuidID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Sup_GuidID) {
			...
			this.param_Sup_GuidID = param_Sup_GuidID;
		}
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Sup_GuidID">Value for the parameter @Sup_GuidID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Sup_GuidID) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_tblSupplier";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_Sup_GuidID">Value for the parameter @Sup_GuidID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Sup_GuidID) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Sup_GuidID">Value for the parameter @Sup_GuidID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Sup_GuidID) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblSupplier", "RefreshData");
			}
