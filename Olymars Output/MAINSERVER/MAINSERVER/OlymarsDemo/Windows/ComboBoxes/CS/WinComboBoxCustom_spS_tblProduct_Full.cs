...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// 'spS_tblProduct_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblProduct_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblProduct_Full), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblProduct_Full : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_tblProduct_Full param;
		...
		/// </summary>
		public Params.spS_tblProduct_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblProduct_Full class.
		/// </summary>
		public WinComboBoxCustom_spS_tblProduct_Full() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_tblProduct_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Pro_GuidID, System.Data.SqlTypes.SqlInt32 param_Pro_LngCategoryID) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_tblProduct_Full";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblProduct_Full();
			...
			SPs.spS_tblProduct_Full SP = new SPs.spS_tblProduct_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblProduct_Full", "RefreshData");
			}
