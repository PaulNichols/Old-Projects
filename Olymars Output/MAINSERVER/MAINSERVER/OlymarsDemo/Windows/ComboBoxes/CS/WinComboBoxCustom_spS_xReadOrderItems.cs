...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_xReadOrderItems", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_xReadOrderItems), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_xReadOrderItems : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_xReadOrderItems class.
		/// </summary>
		public WinComboBoxCustom_spS_xReadOrderItems() : base() {
