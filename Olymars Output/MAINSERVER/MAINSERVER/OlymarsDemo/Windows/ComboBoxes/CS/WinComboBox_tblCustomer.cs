...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'tblCustomer' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_tblCustomer), "WinComboBox.bmp")]
	public sealed class WinComboBox_tblCustomer : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Windows.ComboBoxes.WinComboBox_tblCustomer class.
		/// </summary>
		public WinComboBox_tblCustomer() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_Cus_LngID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBox_tblCustomer : System.Windows.Forms.ComboBox", "RefreshData");
			}
