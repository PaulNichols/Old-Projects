...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_xReadOrderDateAmount", SqlObjectDependancyRevision=64)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_xReadOrderDateAmount), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_xReadOrderDateAmount : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_xReadOrderDateAmount class.
		/// </summary>
		public WinComboBoxCustom_spS_xReadOrderDateAmount() : base() {
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		/// <param name="param_ReturnXML">Value for the parameter @ReturnXML.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID, System.Data.SqlTypes.SqlBoolean param_ReturnXML) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_xReadOrderDateAmount", "RefreshData");
			}
