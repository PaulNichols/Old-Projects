...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// 'spS_tblProduct' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblProduct", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblProduct), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblProduct : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_tblProduct param;
		...
		/// </summary>
		public Params.spS_tblProduct SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblProduct class.
		/// </summary>
		public WinComboBoxCustom_spS_tblProduct() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_tblProduct' stored procedure parameters.
		/// </summary>
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblProduct();
			...
			SPs.spS_tblProduct SP = new SPs.spS_tblProduct();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblProduct", "RefreshData");
			}
