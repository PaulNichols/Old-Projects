/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 27/12/2004 14:11:57
...
namespace OlymarsDemo.Windows.ComboBoxes {

	/// <summary>
	/// This class is based on a System.Windows.Forms.ComboBox class and was built to display
	/// the resultset returned back by the
	/// 'spS_tblProduct_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblProduct_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblProduct_SelectDisplay), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblProduct_SelectDisplay : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_tblProduct_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Pro_GuidID = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlInt32 param_Pro_LngCategoryID = System.Data.SqlTypes.SqlInt32.Null;
		...
		/// </summary>
		public Params.spS_tblProduct_SelectDisplay SP_Parameter {
		...
		protected override void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.param_Pro_GuidID = System.Data.SqlTypes.SqlGuid.Null;
				this.param_Pro_LngCategoryID = System.Data.SqlTypes.SqlInt32.Null;
				if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblProduct_SelectDisplay class.
		/// </summary>
		public WinComboBoxCustom_spS_tblProduct_SelectDisplay() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_tblProduct_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_Pro_GuidID">Value for the parameter @Pro_GuidID.</param>
		/// <param name="param_Pro_LngCategoryID">Value for the parameter @Pro_LngCategoryID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Pro_GuidID, System.Data.SqlTypes.SqlInt32 param_Pro_LngCategoryID) {
			...
			this.param_Pro_GuidID = param_Pro_GuidID;
			this.param_Pro_LngCategoryID = param_Pro_LngCategoryID;
		}
		...
		/// <param name="param_Pro_GuidID">Value for the parameter @Pro_GuidID.</param>
		/// <param name="param_Pro_LngCategoryID">Value for the parameter @Pro_LngCategoryID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Pro_GuidID, System.Data.SqlTypes.SqlInt32 param_Pro_LngCategoryID) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_tblProduct_SelectDisplay";
		...
		/// <param name="param_Pro_GuidID">Value for the parameter @Pro_GuidID.</param>
		/// <param name="param_Pro_LngCategoryID">Value for the parameter @Pro_LngCategoryID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Pro_GuidID, System.Data.SqlTypes.SqlInt32 param_Pro_LngCategoryID) {
		...
		/// <param name="param_Pro_GuidID">Value for the parameter @Pro_GuidID.</param>
		/// <param name="param_Pro_LngCategoryID">Value for the parameter @Pro_LngCategoryID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Pro_GuidID, System.Data.SqlTypes.SqlInt32 param_Pro_LngCategoryID) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblProduct_SelectDisplay();
			...
			if (!this.param_Pro_GuidID.IsNull) {

				this.param.Param_Pro_GuidID = this.param_Pro_GuidID;
			}


			if (!this.param_Pro_LngCategoryID.IsNull) {

				this.param.Param_Pro_LngCategoryID = this.param_Pro_LngCategoryID;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_tblProduct_SelectDisplay SP = new SPs.spS_tblProduct_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblProduct_SelectDisplay", "RefreshData");
			}
