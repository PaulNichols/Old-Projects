...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// 'spS_tblOrder_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblOrder_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblOrder_Full), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblOrder_Full : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_tblOrder_Full param;
		...
		/// </summary>
		public Params.spS_tblOrder_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblOrder_Full class.
		/// </summary>
		public WinComboBoxCustom_spS_tblOrder_Full() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_tblOrder_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Ord_GuidID, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID) {
		...
		/// <param name="param_Ord_GuidID">Value for the parameter @Ord_GuidID.</param>
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Ord_GuidID, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_tblOrder_Full";
		...
		/// <param name="param_Ord_GuidID">Value for the parameter @Ord_GuidID.</param>
		/// <param name="param_Ord_LngCustomerID">Value for the parameter @Ord_LngCustomerID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Ord_GuidID, System.Data.SqlTypes.SqlInt32 param_Ord_LngCustomerID) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblOrder_Full();
			...
			SPs.spS_tblOrder_Full SP = new SPs.spS_tblOrder_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblOrder_Full", "RefreshData");
			}
