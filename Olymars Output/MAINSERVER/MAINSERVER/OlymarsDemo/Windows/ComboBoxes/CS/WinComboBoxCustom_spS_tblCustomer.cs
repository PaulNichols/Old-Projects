...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// 'spS_tblCustomer' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_tblCustomer", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_tblCustomer), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_tblCustomer : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_tblCustomer param;
		private System.Data.SqlTypes.SqlInt32 param_Cus_LngID = System.Data.SqlTypes.SqlInt32.Null;
		...
		/// </summary>
		public Params.spS_tblCustomer SP_Parameter {
		...
		protected override void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.param_Cus_LngID = System.Data.SqlTypes.SqlInt32.Null;
				if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_tblCustomer class.
		/// </summary>
		public WinComboBoxCustom_spS_tblCustomer() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_tblCustomer' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_Cus_LngID">Value for the parameter @Cus_LngID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_Cus_LngID) {
			...
			this.param_Cus_LngID = param_Cus_LngID;
		}
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Cus_LngID">Value for the parameter @Cus_LngID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_Cus_LngID) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_tblCustomer";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_Cus_LngID">Value for the parameter @Cus_LngID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_Cus_LngID) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Cus_LngID">Value for the parameter @Cus_LngID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_Cus_LngID) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_tblCustomer();
			...
			if (!this.param_Cus_LngID.IsNull) {

				this.param.Param_Cus_LngID = this.param_Cus_LngID;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_tblCustomer SP = new SPs.spS_tblCustomer();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_tblCustomer", "RefreshData");
			}
