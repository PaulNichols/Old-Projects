...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// 'spS_xReadOrderLines' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:57", SqlObjectDependancyName="spS_xReadOrderLines", SqlObjectDependancyRevision=48)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_xReadOrderLines), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_xReadOrderLines : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_xReadOrderLines param;
		...
		/// </summary>
		public Params.spS_xReadOrderLines SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_xReadOrderLines class.
		/// </summary>
		public WinComboBoxCustom_spS_xReadOrderLines() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_xReadOrderLines' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_OrderID">Value for the parameter @OrderID.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_OrderID) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_xReadOrderLines";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_OrderID">Value for the parameter @OrderID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_OrderID">Value for the parameter @OrderID.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_OrderID) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_xReadOrderLines", "RefreshData");
			}
