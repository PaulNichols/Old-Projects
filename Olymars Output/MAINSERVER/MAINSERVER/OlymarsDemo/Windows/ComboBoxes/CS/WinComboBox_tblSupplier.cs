...
namespace OlymarsDemo.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'tblSupplier' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_tblSupplier), "WinComboBox.bmp")]
	public sealed class WinComboBox_tblSupplier : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Windows.ComboBoxes.WinComboBox_tblSupplier class.
		/// </summary>
		public WinComboBox_tblSupplier() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Sup_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinComboBox_tblSupplier : System.Windows.Forms.ComboBox", "RefreshData");
			}
