...
namespace OlymarsDemo.Windows.CheckedListBoxes {
	...
	[OlymarsDemo.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 14:11:58", SqlObjectDependancyName="spS_tblProduct_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBoxCustom_spS_tblProduct_Full), "WinCheckedListBox.bmp")]
	public class WinCheckedListBoxCustom_spS_tblProduct_Full : System.Windows.Forms.CheckedListBox {
		...
		/// <summary>
		/// Create a new instance of the WinCheckedListBoxCustom_spS_tblProduct_Full class.
		/// </summary>
		public WinCheckedListBoxCustom_spS_tblProduct_Full() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinCheckedListBoxCustom_spS_tblProduct_Full", "RefreshData");
			}
