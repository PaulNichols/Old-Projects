	...
	public sealed class WinCheckedListBox_tblSupplier : System.Windows.Forms.CheckedListBox {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Sup_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				System.Data.DataView dataView = DS.Tables["spS_tblSupplier_Display"].DefaultView;
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinCheckedListBox_tblSupplier : System.Windows.Forms.CheckedListBox", "RefreshData");
			}
		...
		/// <param name="ArrayOf_PK_Sup_GuidID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Sup_GuidID, System.Windows.Forms.CheckState value) {
			...
			if (ArrayOf_PK_Sup_GuidID != null && ArrayOf_PK_Sup_GuidID.Length > 0) {
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlGuid CurrentPrimaryKey = new System.Data.SqlTypes.SqlGuid((Guid)dataRowView.Row[SPs.spS_tblSupplier_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_Sup_GuidID, CurrentPrimaryKey) != -1) {
