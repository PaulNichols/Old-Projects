...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBoxCustom_spS_xProductQuantityPerOrder), "WinCheckedListBox.bmp")]
	public class WinCheckedListBoxCustom_spS_xProductQuantityPerOrder : System.Windows.Forms.CheckedListBox {
		...
		/// <summary>
		/// Create a new instance of the WinCheckedListBoxCustom_spS_xProductQuantityPerOrder class.
		/// </summary>
		public WinCheckedListBoxCustom_spS_xProductQuantityPerOrder() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinCheckedListBoxCustom_spS_xProductQuantityPerOrder", "RefreshData");
			}
