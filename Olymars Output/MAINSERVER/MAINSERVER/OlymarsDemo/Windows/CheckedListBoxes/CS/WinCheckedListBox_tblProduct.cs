	...
	public sealed class WinCheckedListBox_tblProduct : System.Windows.Forms.CheckedListBox {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Pro_GuidID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.ValueMember = SPs.spS_tblProduct_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DisplayMember = SPs.spS_tblProduct_Display.Resultset1.Fields.Column_Display.ColumnName;
				this.bindingInProgress = false;

				System.Data.DataView dataView = DS.Tables["spS_tblProduct_Display"].DefaultView;
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinCheckedListBox_tblProduct : System.Windows.Forms.CheckedListBox", "RefreshData");
			}
		...
		/// <param name="ArrayOf_PK_Pro_GuidID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Pro_GuidID, System.Windows.Forms.CheckState value) {
			...
			if (ArrayOf_PK_Pro_GuidID != null && ArrayOf_PK_Pro_GuidID.Length > 0) {
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlGuid CurrentPrimaryKey = new System.Data.SqlTypes.SqlGuid((Guid)dataRowView.Row[SPs.spS_tblProduct_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_Pro_GuidID, CurrentPrimaryKey) != -1) {
		...
		public bool RefreshCurrentRecord() {
			...
			System.Data.SqlTypes.SqlGuid PK_Pro_GuidID = (System.Guid)this.SelectedValue;
