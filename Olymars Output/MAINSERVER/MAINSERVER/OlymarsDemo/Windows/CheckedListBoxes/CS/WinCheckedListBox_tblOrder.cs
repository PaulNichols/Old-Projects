...
namespace OlymarsDemo.Windows.CheckedListBoxes {
	...
	public sealed class WinCheckedListBox_tblOrder : System.Windows.Forms.CheckedListBox {
		...
		/// <param name="ArrayOf_PK_Ord_GuidID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Ord_GuidID, System.Windows.Forms.CheckState value) {
			...
			if (ArrayOf_PK_Ord_GuidID != null && ArrayOf_PK_Ord_GuidID.Length > 0) {
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlGuid CurrentPrimaryKey = new System.Data.SqlTypes.SqlGuid((Guid)dataRowView.Row[SPs.spS_tblOrder_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_Ord_GuidID, CurrentPrimaryKey) != -1) {
