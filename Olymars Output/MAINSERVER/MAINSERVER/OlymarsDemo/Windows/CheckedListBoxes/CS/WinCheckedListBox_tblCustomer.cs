	...
	public sealed class WinCheckedListBox_tblCustomer : System.Windows.Forms.CheckedListBox {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cus_LngID, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.ValueMember = SPs.spS_tblCustomer_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DisplayMember = SPs.spS_tblCustomer_Display.Resultset1.Fields.Column_Display.ColumnName;
				this.bindingInProgress = false;

				System.Data.DataView dataView = DS.Tables["spS_tblCustomer_Display"].DefaultView;
				...
				SP.Dispose();
				throw new OlymarsDemo.DataClasses.CustomException(this.param, "WinCheckedListBox_tblCustomer : System.Windows.Forms.CheckedListBox", "RefreshData");
			}
		...
		/// <param name="ArrayOf_PK_Cus_LngID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_Cus_LngID, System.Windows.Forms.CheckState value) {
			...
			if (ArrayOf_PK_Cus_LngID != null && ArrayOf_PK_Cus_LngID.Length > 0) {
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlInt32 CurrentPrimaryKey = new System.Data.SqlTypes.SqlInt32((Int32)dataRowView.Row[SPs.spS_tblCustomer_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_Cus_LngID, CurrentPrimaryKey) != -1) {
