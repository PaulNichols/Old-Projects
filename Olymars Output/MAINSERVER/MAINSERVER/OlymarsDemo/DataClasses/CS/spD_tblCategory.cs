...
namespace OlymarsDemo.DataClasses.Parameters {
	...
	/// stored procedure 'spD_tblCategory'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 16:08:22", SqlObjectDependancyName="spD_tblCategory", SqlObjectDependancyRevision=0)]
#endif
	public class spD_tblCategory : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spD_tblCategory class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spD_tblCategory() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spD_tblCategory class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spD_tblCategory(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spD_tblCategory'";
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spD_tblCategory'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spD_tblCategory");
			}
		}
...
namespace OlymarsDemo.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spD_tblCategory' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 16:08:22", SqlObjectDependancyName="spD_tblCategory", SqlObjectDependancyRevision=0)]
#endif
	public class spD_tblCategory : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spD_tblCategory() : this(false) {
		...
		public spD_tblCategory(bool throwExceptionOnExecute) {
