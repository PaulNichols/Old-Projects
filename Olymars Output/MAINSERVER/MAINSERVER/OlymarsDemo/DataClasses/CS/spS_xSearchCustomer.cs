...
namespace OlymarsDemo.DataClasses.Parameters {
	...
	/// stored procedure 'spS_xSearchCustomer'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 16:08:24", SqlObjectDependancyName="spS_xSearchCustomer", SqlObjectDependancyRevision=64)]
#endif
	public class spS_xSearchCustomer : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_xSearchCustomer class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_xSearchCustomer() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_xSearchCustomer class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_xSearchCustomer(bool useDefaultValue) {
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_xSearchCustomer'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_xSearchCustomer");
			}
		}
...
namespace OlymarsDemo.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_xSearchCustomer' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 16:08:24", SqlObjectDependancyName="spS_xSearchCustomer", SqlObjectDependancyRevision=64)]
#endif
	public class spS_xSearchCustomer : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_xSearchCustomer() : this(false) {
		...
		public spS_xSearchCustomer(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer)");
						}
				...
				sqlCommand.CommandText = "spS_xSearchCustomer";
		...
		private bool DeclareParameters(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@LastName", System.Data.SqlDbType.VarChar, 50);
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@FirstName", System.Data.SqlDbType.VarChar, 50);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
		...
		private bool RetrieveParameters(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_xSearchCustomer] stored procedure and retrieve back the data
		...
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_xSearchCustomer'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_xSearchCustomer", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_xSearchCustomer", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'spS_xSearchCustomer' class.
		/// </summary>
