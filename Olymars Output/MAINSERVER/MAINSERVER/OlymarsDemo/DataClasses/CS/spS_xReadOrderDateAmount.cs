...
namespace OlymarsDemo.DataClasses.Parameters {
	...
	/// stored procedure 'spS_xReadOrderDateAmount'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 16:08:24", SqlObjectDependancyName="spS_xReadOrderDateAmount", SqlObjectDependancyRevision=64)]
#endif
	public class spS_xReadOrderDateAmount : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_xReadOrderDateAmount class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_xReadOrderDateAmount() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_xReadOrderDateAmount class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_xReadOrderDateAmount(bool useDefaultValue) {
		...
		/// </summary>
		~spS_xReadOrderDateAmount() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_xReadOrderDateAmount'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_xReadOrderDateAmount");
			}
		}
...
namespace OlymarsDemo.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_xReadOrderDateAmount' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2004/12/27 16:08:24", SqlObjectDependancyName="spS_xReadOrderDateAmount", SqlObjectDependancyRevision=64)]
#endif
	public class spS_xReadOrderDateAmount : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_xReadOrderDateAmount() : this(false) {
		...
		public spS_xReadOrderDateAmount(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount)");
						}
				...
				sqlCommand.CommandText = "spS_xReadOrderDateAmount";
		...
		private bool DeclareParameters(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_xReadOrderDateAmount] stored procedure and retrieve back the data
		...
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_xReadOrderDateAmount'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_xReadOrderDateAmount", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_xReadOrderDateAmount", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref OlymarsDemo.DataClasses.Parameters.spS_xReadOrderDateAmount parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_xReadOrderDateAmount' class.
		/// </summary>
