...
namespace OlymarsDemo.DataClasses {
	...
	public class OlymarsInformationAttribute : System.Attribute {
	...
	public class Information {
		...
		public static string GetConnectionStringFromConfigurationFile {
			...
			get {
				...
				object ConnectionStringObject = ConfigurationSettings.AppSettings["OlymarsDemo ConnectionString"];
		...
		/// Key:HKLM/SOFTWARE/ConnectionStrings/OlymarsDemo, Entry:ConnectionString
		/// </summary>
		public static string GetConnectionStringFromRegistry {
			...
			get {
				...
				Microsoft.Win32.RegistryKey RK = Microsoft.Win32.Registry.LocalMachine.OpenSubKey("SOFTWARE\\ConnectionStrings\\OlymarsDemo", false);
				if (RK != null) {
