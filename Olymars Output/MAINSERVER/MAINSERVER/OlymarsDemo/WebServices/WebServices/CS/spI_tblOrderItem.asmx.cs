...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spI_tblOrderItem : System.Web.Services.WebService {


		public spI_tblOrderItem() {
		...
		[WebMethod()]
		public void Execute(WSGuid Oit_GuidID, WSGuid Oit_GuidOrderID, WSGuid Oit_GuidProductID, WSInt32 Oit_LngAmount) {
