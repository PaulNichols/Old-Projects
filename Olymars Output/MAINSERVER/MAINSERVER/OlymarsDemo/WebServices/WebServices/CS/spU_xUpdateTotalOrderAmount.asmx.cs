...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spU_xUpdateTotalOrderAmount : System.Web.Services.WebService {


		public spU_xUpdateTotalOrderAmount() {
		...
		[WebMethod()]
		public void Execute(WSGuid Ord_GuidID) {
		
			Params.spU_xUpdateTotalOrderAmount param = new Params.spU_xUpdateTotalOrderAmount(true);
			...
			using (SPs.spU_xUpdateTotalOrderAmount sp = new SPs.spU_xUpdateTotalOrderAmount(true)) {
