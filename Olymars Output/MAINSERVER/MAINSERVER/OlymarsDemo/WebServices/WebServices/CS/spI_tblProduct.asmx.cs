...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spI_tblProduct : System.Web.Services.WebService {


		public spI_tblProduct() {
		...
		[WebMethod()]
		public void Execute(WSGuid Pro_GuidID, WSString Pro_StrName, WSDecimal Pro_CurPrice, WSInt32 Pro_LngCategoryID) {
