...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spU_tblOrderItem : System.Web.Services.WebService {


		public spU_tblOrderItem() {
		...
		public void Execute(WSGuid Oit_GuidID, WSGuid Oit_GuidOrderID, WSBoolean ConsiderNull_Oit_GuidOrderID, WSGuid Oit_GuidProductID, WSBoolean ConsiderNull_Oit_GuidProductID, WSInt32 Oit_LngAmount, WSBoolean ConsiderNull_Oit_LngAmount) {
			...
			if (ConsiderNull_Oit_GuidOrderID == null || ConsiderNull_Oit_GuidOrderID.UseNull) {

				param.Param_ConsiderNull_Oit_GuidOrderID = SqlBoolean.Null;
			}
			else if (!ConsiderNull_Oit_GuidOrderID.UseDefault) {

				param.Param_ConsiderNull_Oit_GuidOrderID = ConsiderNull_Oit_GuidOrderID.Value;
			}
			...
			if (ConsiderNull_Oit_GuidProductID == null || ConsiderNull_Oit_GuidProductID.UseNull) {

				param.Param_ConsiderNull_Oit_GuidProductID = SqlBoolean.Null;
			}
			else if (!ConsiderNull_Oit_GuidProductID.UseDefault) {

				param.Param_ConsiderNull_Oit_GuidProductID = ConsiderNull_Oit_GuidProductID.Value;
			}

			if (Oit_LngAmount == null || Oit_LngAmount.UseNull) {

				param.Param_Oit_LngAmount = SqlInt32.Null;
			}
			else if (!Oit_LngAmount.UseDefault) {

				param.Param_Oit_LngAmount = Oit_LngAmount.Value;
			}

			if (ConsiderNull_Oit_LngAmount == null || ConsiderNull_Oit_LngAmount.UseNull) {

				param.Param_ConsiderNull_Oit_LngAmount = SqlBoolean.Null;
			}
			else if (!ConsiderNull_Oit_LngAmount.UseDefault) {

				param.Param_ConsiderNull_Oit_LngAmount = ConsiderNull_Oit_LngAmount.Value;
			}
