...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spX_xRebuildIndexes : System.Web.Services.WebService {


		public spX_xRebuildIndexes() {
		...
		public void Execute() {
			...
			Params.spX_xRebuildIndexes param = new Params.spX_xRebuildIndexes(true);
			param.SetUpConnection(string.Empty);

			using (SPs.spX_xRebuildIndexes sp = new SPs.spX_xRebuildIndexes(true)) {
