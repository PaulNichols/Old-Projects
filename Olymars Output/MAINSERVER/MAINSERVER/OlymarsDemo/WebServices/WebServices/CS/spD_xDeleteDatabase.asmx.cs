...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spD_xDeleteDatabase : System.Web.Services.WebService {


		public spD_xDeleteDatabase() {
		...
		public void Execute() {
			...
			Params.spD_xDeleteDatabase param = new Params.spD_xDeleteDatabase(true);
			param.SetUpConnection(string.Empty);

			using (SPs.spD_xDeleteDatabase sp = new SPs.spD_xDeleteDatabase(true)) {
