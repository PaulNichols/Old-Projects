...
namespace OlymarsDemo.WebServices {
	...
	/// [To be supplied.]
	/// </summary>
	public class spU_tblCustomer : System.Web.Services.WebService {


		public spU_tblCustomer() {
		...
		[WebMethod()]
		public void Execute(WSInt32 Cus_LngID, WSString Cus_StrLastName, WSBoolean ConsiderNull_Cus_StrLastName, WSString Cus_StrFirstName, WSBoolean ConsiderNull_Cus_StrFirstName, WSString Cus_StrEmail, WSBoolean ConsiderNull_Cus_StrEmail) {
			...
			if (ConsiderNull_Cus_StrLastName == null || ConsiderNull_Cus_StrLastName.UseNull) {

				param.Param_ConsiderNull_Cus_StrLastName = SqlBoolean.Null;
			}
			else if (!ConsiderNull_Cus_StrLastName.UseDefault) {

				param.Param_ConsiderNull_Cus_StrLastName = ConsiderNull_Cus_StrLastName.Value;
			}
			...
			if (ConsiderNull_Cus_StrFirstName == null || ConsiderNull_Cus_StrFirstName.UseNull) {

				param.Param_ConsiderNull_Cus_StrFirstName = SqlBoolean.Null;
			}
			else if (!ConsiderNull_Cus_StrFirstName.UseDefault) {

				param.Param_ConsiderNull_Cus_StrFirstName = ConsiderNull_Cus_StrFirstName.Value;
			}
			...
			if (ConsiderNull_Cus_StrEmail == null || ConsiderNull_Cus_StrEmail.UseNull) {

				param.Param_ConsiderNull_Cus_StrEmail = SqlBoolean.Null;
			}
			else if (!ConsiderNull_Cus_StrEmail.UseDefault) {

				param.Param_ConsiderNull_Cus_StrEmail = ConsiderNull_Cus_StrEmail.Value;
			}
