...
namespace OlymarsDemo.WebServices.Windows.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ListBox class and was built to display the 'tblOrderItem' table content.
	/// </summary>
	[System.Drawing.ToolboxBitmap(typeof(WinListBox_tblOrderItem), "WinListBox.bmp")]
	public sealed class WinListBox_tblOrderItem : System.Windows.Forms.ListBox {
		...
		public System.Collections.ArrayList SelectedRecordsID {
			...
			get {
				...
				foreach(object currentItem in this.SelectedItems) {
					...
					WS_tblOrderItem_Record.WSGuid currentID = new WS_tblOrderItem_Record.WSGuid();
		...
		/// <summary>
		/// Create a new instance of the OlymarsDemo.Windows.ListBoxes.WinListBox_tblOrderItem class.
		/// </summary>
		public WinListBox_tblOrderItem() : base() {
