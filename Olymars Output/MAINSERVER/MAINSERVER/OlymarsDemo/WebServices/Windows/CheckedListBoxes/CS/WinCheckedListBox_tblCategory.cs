...
namespace OlymarsDemo.WebServices.Windows.CheckedListBoxes {
	...
	public sealed class WinCheckedListBox_tblCategory : System.Windows.Forms.CheckedListBox {
		...
		public void RefreshData() {
			...
			this.RefreshData(new WS_Category.WSInt32[0], -1, -1);
		}
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.RefreshData(new WS_Category.WSInt32[0], startRecord, maxRecords);
		}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Cat_LngID">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(WS_Category.WSInt32[] ArrayOf_PK_Cat_LngID) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(WS_Category.WSInt32[] ArrayOf_PK_Cat_LngID, int startRecord, int maxRecords) {
			...
			System.Data.DataView dataView = dataSet.Tables["spS_tblCategory_Display"].DefaultView;
		...
		/// <param name="ArrayOf_PK_Cat_LngID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(WS_Category.WSInt32[] ArrayOf_PK_Cat_LngID, System.Windows.Forms.CheckState value) {
			...
			if (ArrayOf_PK_Cat_LngID != null && ArrayOf_PK_Cat_LngID.Length > 0) {
				...
				for (int index = 0; index < totalDataRowViewsNumber; index++) {
					...
					foreach (WS_Category.WSInt32 record in ArrayOf_PK_Cat_LngID) {
