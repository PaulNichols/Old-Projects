...
namespace Bob.SqlDataAdapters {
	...
	/// used against the [Customers] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public class SqlDataAdapter_Customers {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Customers class.
		...
		public SqlDataAdapter_Customers(string connectionString) {
		...
		public SqlDataAdapter_Customers(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Customers(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Customers class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Customers(string connectionString, System.Data.SqlTypes.SqlInt32 FK_TitleId, string tableName) : this(connectionString) {

			this.Configure(FK_TitleId, tableName);
		}
		...
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Customers(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_TitleId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Customers(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_TitleId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Customers class.
		/// The table name in the DataSet will be: Customers
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		public SqlDataAdapter_Customers(string connectionString, System.Data.SqlTypes.SqlInt32 FK_TitleId) : this(connectionString) {

			this.Configure(FK_TitleId, "Customers");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		public SqlDataAdapter_Customers(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_TitleId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		public SqlDataAdapter_Customers(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_TitleId) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_TitleId) {
		...
		/// <param name="FK_TitleId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_TitleId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Bob.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.SqlDataAdapters.SqlDataAdapter_Customers)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Customers";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TitleId.IsNull) {

				sqlParameter.Value = FK_TitleId;
			}
			...
			sqlInsertCommand.CommandText = "spI_Customers";
			...
			sqlUpdateCommand.CommandText = "spU_Customers";
			...
			sqlDeleteCommand.CommandText = "spD_Customers";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("TitleId", "TitleId")
							,new System.Data.Common.DataColumnMapping("Address", "Address")
							,new System.Data.Common.DataColumnMapping("City", "City")
							,new System.Data.Common.DataColumnMapping("PostalCode", "PostalCode")
							,new System.Data.Common.DataColumnMapping("Phone", "Phone")
							,new System.Data.Common.DataColumnMapping("Email", "Email")
							,new System.Data.Common.DataColumnMapping("WebAddress", "WebAddress")
		...
		///the populated table name in the DataSet will be: Customers.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Customers", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Customers", startRecord, maxRecords);
		}
