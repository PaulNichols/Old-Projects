...
namespace Bob.SqlDataAdapters {
	...
	/// used against the [JobPartType] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public class SqlDataAdapter_JobPartType {
		...
		public SqlDataAdapter_JobPartType(string connectionString) {
		...
		public SqlDataAdapter_JobPartType(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_JobPartType class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_JobPartType(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_JobPartType(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_JobPartType(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: JobPartType
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Bob.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.SqlDataAdapters.SqlDataAdapter_JobPartType)");
					}
			...
			sqlSelectCommand.CommandText = "spS_JobPartType";
			...
			sqlInsertCommand.CommandText = "spI_JobPartType";
			...
			sqlUpdateCommand.CommandText = "spU_JobPartType";
			...
			sqlDeleteCommand.CommandText = "spD_JobPartType";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("GeneralUnitCost", "GeneralUnitCost")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: JobPartType.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "JobPartType", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "JobPartType", startRecord, maxRecords);
		}
