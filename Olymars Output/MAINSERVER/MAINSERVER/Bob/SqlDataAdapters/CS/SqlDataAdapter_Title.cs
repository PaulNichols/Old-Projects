...
namespace Bob.SqlDataAdapters {
	...
	/// used against the [Title] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public class SqlDataAdapter_Title {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Title class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_Title(string connectionString) {
		...
		public SqlDataAdapter_Title(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Title(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Title class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Title(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Title(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Title(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: Title
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Bob.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.SqlDataAdapters.SqlDataAdapter_Title)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Title";
			...
			sqlInsertCommand.CommandText = "spI_Title";
			...
			sqlUpdateCommand.CommandText = "spU_Title";
			...
			sqlDeleteCommand.CommandText = "spD_Title";
		...
		///the populated table name in the DataSet will be: Title.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Title", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Title", startRecord, maxRecords);
		}
