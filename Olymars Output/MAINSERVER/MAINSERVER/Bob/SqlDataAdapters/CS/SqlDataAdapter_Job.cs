...
namespace Bob.SqlDataAdapters {
	...
	/// used against the [Job] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
...
#endif
	public class SqlDataAdapter_Job {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Job class.
		...
		public SqlDataAdapter_Job(string connectionString) {
		...
		public SqlDataAdapter_Job(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Job(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Job class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Job(string connectionString, System.Data.SqlTypes.SqlInt32 FK_CustomerId, string tableName) : this(connectionString) {

			this.Configure(FK_CustomerId, tableName);
		}
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Job(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_CustomerId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Job(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_CustomerId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Job class.
		/// The table name in the DataSet will be: Job
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		public SqlDataAdapter_Job(string connectionString, System.Data.SqlTypes.SqlInt32 FK_CustomerId) : this(connectionString) {

			this.Configure(FK_CustomerId, "Job");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		public SqlDataAdapter_Job(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_CustomerId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		public SqlDataAdapter_Job(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_CustomerId) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_CustomerId) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_CustomerId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Bob.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.SqlDataAdapters.SqlDataAdapter_Job)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Job";
			...
			sqlInsertCommand.CommandText = "spI_Job";
			...
			sqlUpdateCommand.CommandText = "spU_Job";
			...
			sqlDeleteCommand.CommandText = "spD_Job";
		...
		///the populated table name in the DataSet will be: Job.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Job", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Job", startRecord, maxRecords);
		}
