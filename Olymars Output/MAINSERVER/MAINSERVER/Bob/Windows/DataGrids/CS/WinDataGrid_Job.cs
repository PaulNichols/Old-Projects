...
namespace Bob.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'Job' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_Job), "WinDataGrid.bmp")]
	public class WinDataGrid_Job : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private Bob.SqlDataAdapters.SqlDataAdapter_Job sqlDataAdapter = null;
		...
		/// </summary>
		public Bob.SqlDataAdapters.SqlDataAdapter_Job SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "Job");
		}
		...
		/// <summary>
		/// Initializes a new instance of the Bob.Windows.DataGrids.WinDataGrid_Job class.
		/// </summary>
		public WinDataGrid_Job() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			switch (this.LastKnownConnectionType) {
 				...
 				case Bob.DataClasses.ConnectionType.ConnectionString:
					this.sqlDataAdapter = new Bob.SqlDataAdapters.SqlDataAdapter_Job(this.connectionString, this.FK_CustomerId, "Job");
					break;

 				case Bob.DataClasses.ConnectionType.SqlConnection:
					this.sqlDataAdapter = new Bob.SqlDataAdapters.SqlDataAdapter_Job(this.sqlConnection, this.FK_CustomerId, "Job");
					break;
			}
			...
			this.dataSet.Tables["Job"].Columns["JobId"].Caption = "JobId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"JobId\" column)";
			this.dataSet.Tables["Job"].Columns["Description"].Caption = "Description (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Description\" column)";
			this.dataSet.Tables["Job"].Columns["Price"].Caption = "Price (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Price\" column)";
			this.dataSet.Tables["Job"].Columns["StartDate"].Caption = "StartDate (update this label in the \"Olymars/ColumnLabel\" extended property of the \"StartDate\" column)";
			this.dataSet.Tables["Job"].Columns["EndDate"].Caption = "EndDate (update this label in the \"Olymars/ColumnLabel\" extended property of the \"EndDate\" column)";
			this.dataSet.Tables["Job"].Columns["CustomerId"].Caption = "CustomerId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"CustomerId\" column)";

			this.bindingInProgress = true;
			this.DataSource = this.dataSet .Tables["Job"].DefaultView;
