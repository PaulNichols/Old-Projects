...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_Customers_SelectDisplay), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_Customers_SelectDisplay : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_Customers_SelectDisplay class.
		/// </summary>
		public WinDataGridCustom_spS_Customers_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		/// <param name="param_CustomerID">Value for the parameter @CustomerID.</param>
		/// <param name="param_TitleId">Value for the parameter @TitleId.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		/// <param name="param_CustomerID">Value for the parameter @CustomerID.</param>
		/// <param name="param_TitleId">Value for the parameter @TitleId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		/// <param name="param_CustomerID">Value for the parameter @CustomerID.</param>
		/// <param name="param_TitleId">Value for the parameter @TitleId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_Customers_SelectDisplay", "RefreshData");
			}
		}
	}
}
