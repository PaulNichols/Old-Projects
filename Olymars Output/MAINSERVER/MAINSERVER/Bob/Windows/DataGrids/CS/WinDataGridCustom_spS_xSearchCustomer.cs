...
namespace Bob.Windows.DataGrids {
	...
	public class WinDataGridCustom_spS_xSearchCustomer : System.Windows.Forms.DataGrid {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlString param_CompanyName, System.Data.SqlTypes.SqlString param_ContactName) {
		...
		/// <param name="param_CompanyName">Value for the parameter @CompanyName.</param>
		/// <param name="param_ContactName">Value for the parameter @ContactName.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlString param_CompanyName, System.Data.SqlTypes.SqlString param_ContactName) {
		...
		/// <param name="param_CompanyName">Value for the parameter @CompanyName.</param>
		/// <param name="param_ContactName">Value for the parameter @ContactName.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlString param_CompanyName, System.Data.SqlTypes.SqlString param_ContactName) {
		...
		/// <param name="param_CompanyName">Value for the parameter @CompanyName.</param>
		/// <param name="param_ContactName">Value for the parameter @ContactName.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString param_CompanyName, System.Data.SqlTypes.SqlString param_ContactName) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_xSearchCustomer", "RefreshData");
			}
		}
	}
}
