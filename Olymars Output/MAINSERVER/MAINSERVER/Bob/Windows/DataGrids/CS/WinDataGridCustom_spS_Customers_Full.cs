...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGridCustom_spS_Customers_Full), "WinDataGrid.bmp")]
	public class WinDataGridCustom_spS_Customers_Full : System.Windows.Forms.DataGrid {
		...
		/// WinDataGridCustom_spS_Customers_Full class.
		/// </summary>
		public WinDataGridCustom_spS_Customers_Full() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinDataGridCustom_spS_Customers_Full", "RefreshData");
			}
		}
	}
}
