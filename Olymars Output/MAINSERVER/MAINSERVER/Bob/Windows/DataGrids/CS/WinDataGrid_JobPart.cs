...
namespace Bob.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'JobPart' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_JobPart), "WinDataGrid.bmp")]
	public class WinDataGrid_JobPart : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private Bob.SqlDataAdapters.SqlDataAdapter_JobPart sqlDataAdapter = null;
		...
		/// </summary>
		public Bob.SqlDataAdapters.SqlDataAdapter_JobPart SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "JobPart");
		}
		...
		/// <summary>
		/// Initializes a new instance of the Bob.Windows.DataGrids.WinDataGrid_JobPart class.
		/// </summary>
		public WinDataGrid_JobPart() : base() {
