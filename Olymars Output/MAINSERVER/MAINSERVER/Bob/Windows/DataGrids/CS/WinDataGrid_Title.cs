...
namespace Bob.Windows.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Windows.Forms.DataGrid class and was built to display the 'Title' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinDataGrid_Title), "WinDataGrid.bmp")]
	public class WinDataGrid_Title : System.Windows.Forms.DataGrid {

			private System.Data.DataSet dataSet = null;
		private Bob.SqlDataAdapters.SqlDataAdapter_Title sqlDataAdapter = null;
		...
		/// </summary>
		public Bob.SqlDataAdapters.SqlDataAdapter_Title SqlDataAdapter {
		...
		public void CommitChanges() {
			...
			this.sqlDataAdapter.SqlDataAdapter.Update(this.dataSet, "Title");
		}
		...
		/// <summary>
		/// Initializes a new instance of the Bob.Windows.DataGrids.WinDataGrid_Title class.
		/// </summary>
		public WinDataGrid_Title() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			switch (this.LastKnownConnectionType) {
 				...
 				case Bob.DataClasses.ConnectionType.ConnectionString:
					this.sqlDataAdapter = new Bob.SqlDataAdapters.SqlDataAdapter_Title(this.connectionString, "Title");
					break;

 				case Bob.DataClasses.ConnectionType.SqlConnection:
					this.sqlDataAdapter = new Bob.SqlDataAdapters.SqlDataAdapter_Title(this.sqlConnection, "Title");
					break;
			}
			...
			this.dataSet.Tables["Title"].Columns["TitleId"].Caption = "TitleId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"TitleId\" column)";
			this.dataSet.Tables["Title"].Columns["Title"].Caption = "Title";

			this.bindingInProgress = true;
			this.DataSource = this.dataSet .Tables["Title"].DefaultView;
