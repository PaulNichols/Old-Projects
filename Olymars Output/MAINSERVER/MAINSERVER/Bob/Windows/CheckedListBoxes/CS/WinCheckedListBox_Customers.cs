...
namespace Bob.Windows.CheckedListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.CheckedListBox class and was built to display the 'Customers' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBox_Customers), "WinCheckedListBox.bmp")]
	public class WinCheckedListBox_Customers : System.Windows.Forms.CheckedListBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.CheckedListBoxes.WinCheckedListBox_Customers class.
		/// </summary>
		public WinCheckedListBox_Customers() : base() {
		...
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_CustomerID) {

			this.RefreshData(ArrayOf_PK_CustomerID, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_CustomerID, int startRecord, int maxRecords) {

			if (ArrayOf_PK_CustomerID != null && ArrayOf_PK_CustomerID.Count > 0) {

				System.Data.SqlTypes.SqlInt32[] typedArray = new System.Data.SqlTypes.SqlInt32[ArrayOf_PK_CustomerID.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_CustomerID) {
					...
					if (item is System.Data.SqlTypes.SqlInt32) {
						...
						throw new InvalidOperationException("ArrayOf_PK_CustomerID does not contain ONLY System.Data.SqlTypes.SqlInt32 or System.Int32 elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_CustomerID">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_CustomerID) {
		...
		/// </summary>
		/// <param name="ArrayOf_PK_CustomerID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Collections.ArrayList ArrayOf_PK_CustomerID, System.Windows.Forms.CheckState value) {
		...
		/// <param name="ArrayOf_PK_CustomerID">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_CustomerID, System.Windows.Forms.CheckState value) {
		
			if (ArrayOf_PK_CustomerID != null && ArrayOf_PK_CustomerID.Length > 0) {

				int PrimaryKeysWereFound = 0;
				int TotalPrimaryKeysNumber = ArrayOf_PK_CustomerID.Length;
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlInt32 CurrentPrimaryKey = new System.Data.SqlTypes.SqlInt32((Int32)dataRowView.Row[SPs.spS_Customers_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_CustomerID, CurrentPrimaryKey) != -1) {
