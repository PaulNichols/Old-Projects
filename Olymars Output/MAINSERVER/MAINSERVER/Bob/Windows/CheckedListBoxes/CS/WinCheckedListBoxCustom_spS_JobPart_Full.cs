...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBoxCustom_spS_JobPart_Full), "WinCheckedListBox.bmp")]
	public class WinCheckedListBoxCustom_spS_JobPart_Full : System.Windows.Forms.CheckedListBox {
		...
		/// <summary>
		/// Create a new instance of the WinCheckedListBoxCustom_spS_JobPart_Full class.
		/// </summary>
		public WinCheckedListBoxCustom_spS_JobPart_Full() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinCheckedListBoxCustom_spS_JobPart_Full", "RefreshData");
			}
