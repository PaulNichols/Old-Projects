...
namespace Bob.Windows.CheckedListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.CheckedListBox class and was built to display the 'JobPartType' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBox_JobPartType), "WinCheckedListBox.bmp")]
	public class WinCheckedListBox_JobPartType : System.Windows.Forms.CheckedListBox {

		private Params.spS_JobPartType_Display param;
		private Bob.AbstractClasses.Abstract_JobPartType oAbstract_JobPartType;
		...
		/// </summary>
		public Params.spS_JobPartType_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'JobPartType' abstract class so that you can access any table
		...
		/// </summary>
		public Bob.AbstractClasses.Abstract_JobPartType Abstract_JobPartType {

			get {

				return(this.oAbstract_JobPartType);
			}
		}
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.CheckedListBoxes.WinCheckedListBox_JobPartType class.
		/// </summary>
		public WinCheckedListBox_JobPartType() : base() {
		...
		/// </summary>
		/// <param name="ArrayOf_PK_JobPartTypeId">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_JobPartTypeId) {

			this.RefreshData(ArrayOf_PK_JobPartTypeId, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_JobPartTypeId, int startRecord, int maxRecords) {

			if (ArrayOf_PK_JobPartTypeId != null && ArrayOf_PK_JobPartTypeId.Count > 0) {

				System.Data.SqlTypes.SqlInt32[] typedArray = new System.Data.SqlTypes.SqlInt32[ArrayOf_PK_JobPartTypeId.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_JobPartTypeId) {
					...
					if (item is System.Data.SqlTypes.SqlInt32) {
						...
						throw new InvalidOperationException("ArrayOf_PK_JobPartTypeId does not contain ONLY System.Data.SqlTypes.SqlInt32 or System.Int32 elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_JobPartTypeId">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_JobPartTypeId) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_JobPartTypeId, int startRecord, int maxRecords) {

		this.CreateControl();

			this.param = new Params.spS_JobPartType_Display(true);
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_JobPartType_Display"].DefaultView;
				this.ValueMember = SPs.spS_JobPartType_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DisplayMember = SPs.spS_JobPartType_Display.Resultset1.Fields.Column_Display.ColumnName;
				this.bindingInProgress = false;

				System.Data.DataView dataView = DS.Tables["spS_JobPartType_Display"].DefaultView;

				if (ArrayOf_PK_JobPartTypeId != null && ArrayOf_PK_JobPartTypeId.Length > 0) {

					this.SetRecordsCheckState(ArrayOf_PK_JobPartTypeId, System.Windows.Forms.CheckState.Checked);
				}
				else {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinCheckedListBox_JobPartType : System.Windows.Forms.CheckedListBox", "RefreshData");
			}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_JobPartTypeId">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Collections.ArrayList ArrayOf_PK_JobPartTypeId, System.Windows.Forms.CheckState value) {
		...
		/// <param name="ArrayOf_PK_JobPartTypeId">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_JobPartTypeId, System.Windows.Forms.CheckState value) {
		
			if (ArrayOf_PK_JobPartTypeId != null && ArrayOf_PK_JobPartTypeId.Length > 0) {

				int PrimaryKeysWereFound = 0;
				int TotalPrimaryKeysNumber = ArrayOf_PK_JobPartTypeId.Length;
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlInt32 CurrentPrimaryKey = new System.Data.SqlTypes.SqlInt32((Int32)dataRowView.Row[SPs.spS_JobPartType_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_JobPartTypeId, CurrentPrimaryKey) != -1) {
