...
namespace Bob.Windows.CheckedListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.CheckedListBox class and was built to display the 'Title' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:12", SqlObjectDependancyName="Title", SqlObjectDependancyRevision=1440)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBox_Title), "WinCheckedListBox.bmp")]
	public class WinCheckedListBox_Title : System.Windows.Forms.CheckedListBox {

		private Params.spS_Title_Display param;
		private Bob.AbstractClasses.Abstract_Title oAbstract_Title;
		...
		/// </summary>
		public Params.spS_Title_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'Title' abstract class so that you can access any table
		...
		/// </summary>
		public Bob.AbstractClasses.Abstract_Title Abstract_Title {

			get {

				return(this.oAbstract_Title);
			}
		}
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.CheckedListBoxes.WinCheckedListBox_Title class.
		/// </summary>
		public WinCheckedListBox_Title() : base() {
		...
		/// </summary>
		/// <param name="ArrayOf_PK_TitleId">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_TitleId) {

			this.RefreshData(ArrayOf_PK_TitleId, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_TitleId, int startRecord, int maxRecords) {

			if (ArrayOf_PK_TitleId != null && ArrayOf_PK_TitleId.Count > 0) {

				System.Data.SqlTypes.SqlInt32[] typedArray = new System.Data.SqlTypes.SqlInt32[ArrayOf_PK_TitleId.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_TitleId) {
					...
					if (item is System.Data.SqlTypes.SqlInt32) {
						...
						throw new InvalidOperationException("ArrayOf_PK_TitleId does not contain ONLY System.Data.SqlTypes.SqlInt32 or System.Int32 elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_TitleId">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_TitleId) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_TitleId, int startRecord, int maxRecords) {

		this.CreateControl();

			this.param = new Params.spS_Title_Display(true);
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_Title_Display"].DefaultView;
				this.ValueMember = SPs.spS_Title_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DisplayMember = SPs.spS_Title_Display.Resultset1.Fields.Column_Display.ColumnName;
				this.bindingInProgress = false;

				System.Data.DataView dataView = DS.Tables["spS_Title_Display"].DefaultView;

				if (ArrayOf_PK_TitleId != null && ArrayOf_PK_TitleId.Length > 0) {

					this.SetRecordsCheckState(ArrayOf_PK_TitleId, System.Windows.Forms.CheckState.Checked);
				}
				else {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinCheckedListBox_Title : System.Windows.Forms.CheckedListBox", "RefreshData");
			}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_TitleId">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Collections.ArrayList ArrayOf_PK_TitleId, System.Windows.Forms.CheckState value) {
		...
		/// <param name="ArrayOf_PK_TitleId">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_TitleId, System.Windows.Forms.CheckState value) {
		
			if (ArrayOf_PK_TitleId != null && ArrayOf_PK_TitleId.Length > 0) {

				int PrimaryKeysWereFound = 0;
				int TotalPrimaryKeysNumber = ArrayOf_PK_TitleId.Length;
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlInt32 CurrentPrimaryKey = new System.Data.SqlTypes.SqlInt32((Int32)dataRowView.Row[SPs.spS_Title_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_TitleId, CurrentPrimaryKey) != -1) {
