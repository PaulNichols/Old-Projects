...
namespace Bob.Windows.CheckedListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.CheckedListBox class and was built to display the 'Job' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:12", SqlObjectDependancyName="Job", SqlObjectDependancyRevision=512)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinCheckedListBox_Job), "WinCheckedListBox.bmp")]
	public class WinCheckedListBox_Job : System.Windows.Forms.CheckedListBox {

		private Params.spS_Job_Display param;
		private Bob.AbstractClasses.Abstract_Job oAbstract_Job;
		private System.Data.SqlTypes.SqlInt32 FK_CustomerId = System.Data.SqlTypes.SqlInt32.Null;
		...
		/// </summary>
		public Params.spS_Job_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'Job' abstract class so that you can access any table
		...
		/// </summary>
		public Bob.AbstractClasses.Abstract_Job Abstract_Job {

			get {

				return(this.oAbstract_Job);
			}
		}
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.CheckedListBoxes.WinCheckedListBox_Job class.
		/// </summary>
		public WinCheckedListBox_Job() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlInt32 FK_CustomerId) {
		...
		/// </param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_CustomerId) {
		...
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_JobId) {

			this.RefreshData(ArrayOf_PK_JobId, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_JobId, int startRecord, int maxRecords) {

			if (ArrayOf_PK_JobId != null && ArrayOf_PK_JobId.Count > 0) {

				System.Data.SqlTypes.SqlInt32[] typedArray = new System.Data.SqlTypes.SqlInt32[ArrayOf_PK_JobId.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_JobId) {
					...
					if (item is System.Data.SqlTypes.SqlInt32) {
						...
						throw new InvalidOperationException("ArrayOf_PK_JobId does not contain ONLY System.Data.SqlTypes.SqlInt32 or System.Int32 elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_JobId">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_JobId) {
		...
		/// </summary>
		/// <param name="ArrayOf_PK_JobId">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Collections.ArrayList ArrayOf_PK_JobId, System.Windows.Forms.CheckState value) {
		...
		/// <param name="ArrayOf_PK_JobId">Primary keys of the records to set the check state for.</param>
		/// <param name="value">One of the System.Windows.Forms.CheckState values.</param>
		public void SetRecordsCheckState(System.Data.SqlTypes.SqlInt32[] ArrayOf_PK_JobId, System.Windows.Forms.CheckState value) {
		
			if (ArrayOf_PK_JobId != null && ArrayOf_PK_JobId.Length > 0) {

				int PrimaryKeysWereFound = 0;
				int TotalPrimaryKeysNumber = ArrayOf_PK_JobId.Length;
				...
				for (int Index = 0; Index < TotalDataRowViewsNumber; Index++) {
					...
					System.Data.SqlTypes.SqlInt32 CurrentPrimaryKey = new System.Data.SqlTypes.SqlInt32((Int32)dataRowView.Row[SPs.spS_Job_Display.Resultset1.Fields.Column_ID1.ColumnName]);

					if (System.Array.IndexOf(ArrayOf_PK_JobId, CurrentPrimaryKey) != -1) {
