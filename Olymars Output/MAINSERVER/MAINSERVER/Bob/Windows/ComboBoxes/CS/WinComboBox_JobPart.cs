...
namespace Bob.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'JobPart' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_JobPart), "WinComboBox.bmp")]
	public class WinComboBox_JobPart : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ComboBoxes.WinComboBox_JobPart class.
		/// </summary>
		public WinComboBox_JobPart() : base() {
		...
		this.CreateControl();
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBox_JobPart : System.Windows.Forms.ComboBox", "RefreshData");
			}
