...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_Customers_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_Customers_SelectDisplay", SqlObjectDependancyRevision=112)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_Customers_SelectDisplay), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_Customers_SelectDisplay : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_Customers_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_Customers_SelectDisplay SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_Customers_SelectDisplay class.
		/// </summary>
		public WinComboBoxCustom_spS_Customers_SelectDisplay() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_Customers_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		/// <param name="param_CustomerID">Value for the parameter @CustomerID.</param>
		/// <param name="param_TitleId">Value for the parameter @TitleId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_Customers_SelectDisplay";
		...
		/// <param name="param_CustomerID">Value for the parameter @CustomerID.</param>
		/// <param name="param_TitleId">Value for the parameter @TitleId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		/// <param name="param_CustomerID">Value for the parameter @CustomerID.</param>
		/// <param name="param_TitleId">Value for the parameter @TitleId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_Customers_SelectDisplay();
			...
			SPs.spS_Customers_SelectDisplay SP = new SPs.spS_Customers_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_Customers_SelectDisplay", "RefreshData");
			}
