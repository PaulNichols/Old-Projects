...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_JobPart' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_JobPart", SqlObjectDependancyRevision=16)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_JobPart), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_JobPart : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_JobPart param;
		...
		/// </summary>
		public Params.spS_JobPart SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_JobPart class.
		/// </summary>
		public WinComboBoxCustom_spS_JobPart() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_JobPart();
			...
			SPs.spS_JobPart SP = new SPs.spS_JobPart();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_JobPart", "RefreshData");
			}
