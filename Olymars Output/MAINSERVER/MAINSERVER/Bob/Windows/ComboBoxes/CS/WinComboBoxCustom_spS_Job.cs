...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_Job' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_Job", SqlObjectDependancyRevision=16)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_Job), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_Job : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_Job param;
		...
		/// </summary>
		public Params.spS_Job SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_Job class.
		/// </summary>
		public WinComboBoxCustom_spS_Job() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_Job' stored procedure parameters.
		/// </summary>
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_Job", "RefreshData");
			}
