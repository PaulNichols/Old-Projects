...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_JobPartType' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_JobPartType", SqlObjectDependancyRevision=16)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_JobPartType), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_JobPartType : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_JobPartType param;
		...
		/// </summary>
		public Params.spS_JobPartType SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_JobPartType class.
		/// </summary>
		public WinComboBoxCustom_spS_JobPartType() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_JobPartType' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_JobPartTypeId) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_JobPartTypeId">Value for the parameter @JobPartTypeId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_JobPartTypeId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_JobPartType";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_JobPartTypeId">Value for the parameter @JobPartTypeId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_JobPartTypeId) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_JobPartTypeId">Value for the parameter @JobPartTypeId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_JobPartTypeId) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_JobPartType", "RefreshData");
			}
