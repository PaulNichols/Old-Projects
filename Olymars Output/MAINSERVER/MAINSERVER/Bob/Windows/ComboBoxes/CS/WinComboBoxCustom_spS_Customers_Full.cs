...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_Customers_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_Customers_Full", SqlObjectDependancyRevision=112)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_Customers_Full), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_Customers_Full : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_Customers_Full param;
		...
		/// </summary>
		public Params.spS_Customers_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_Customers_Full class.
		/// </summary>
		public WinComboBoxCustom_spS_Customers_Full() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_Customers_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_CustomerID, System.Data.SqlTypes.SqlInt32 param_TitleId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_Customers_Full";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_Customers_Full();
			...
			SPs.spS_Customers_Full SP = new SPs.spS_Customers_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_Customers_Full", "RefreshData");
			}
