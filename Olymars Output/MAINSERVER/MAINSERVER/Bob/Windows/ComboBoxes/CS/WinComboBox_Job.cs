...
namespace Bob.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'Job' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_Job), "WinComboBox.bmp")]
	public class WinComboBox_Job : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ComboBoxes.WinComboBox_Job class.
		/// </summary>
		public WinComboBox_Job() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_JobId) {

			this.RefreshData(PK_JobId, -1, -1);
		}
		...
		this.CreateControl();
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBox_Job : System.Windows.Forms.ComboBox", "RefreshData");
			}
