...
namespace Bob.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'JobPartType' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_JobPartType), "WinComboBox.bmp")]
	public class WinComboBox_JobPartType : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ComboBoxes.WinComboBox_JobPartType class.
		/// </summary>
		public WinComboBox_JobPartType() : base() {
		...
		this.CreateControl();
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBox_JobPartType : System.Windows.Forms.ComboBox", "RefreshData");
			}
