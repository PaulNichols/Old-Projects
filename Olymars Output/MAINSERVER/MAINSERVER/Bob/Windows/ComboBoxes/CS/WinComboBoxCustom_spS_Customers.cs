...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_Customers' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_Customers", SqlObjectDependancyRevision=112)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_Customers), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_Customers : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_Customers param;
		...
		/// </summary>
		public Params.spS_Customers SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_Customers class.
		/// </summary>
		public WinComboBoxCustom_spS_Customers() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_Customers' stored procedure parameters.
		/// </summary>
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_Customers();
			...
			SPs.spS_Customers SP = new SPs.spS_Customers();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_Customers", "RefreshData");
			}
