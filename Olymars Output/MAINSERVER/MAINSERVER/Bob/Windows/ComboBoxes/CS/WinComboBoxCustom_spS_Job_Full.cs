...
namespace Bob.Windows.ComboBoxes {
	...
	/// 'spS_Job_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Bob.DataClasses.OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:13", SqlObjectDependancyName="spS_Job_Full", SqlObjectDependancyRevision=16)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_Job_Full), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_Job_Full : System.Windows.Forms.ComboBox {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_Job_Full param;
		...
		/// </summary>
		public Params.spS_Job_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_Job_Full class.
		/// </summary>
		public WinComboBoxCustom_spS_Job_Full() : base() {

		}

		/// <summary>
		/// Initializes the control. You need to specify how to connect to the SQL Server database.
		/// You also need to supply the 'spS_Job_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_JobId, System.Data.SqlTypes.SqlInt32 param_CustomerId) {
		...
		/// <param name="param_JobId">Value for the parameter @JobId.</param>
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_JobId, System.Data.SqlTypes.SqlInt32 param_CustomerId) {
		...
		/// <param name="param_JobId">Value for the parameter @JobId.</param>
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlInt32 param_JobId, System.Data.SqlTypes.SqlInt32 param_CustomerId) {
		...
		/// <param name="param_JobId">Value for the parameter @JobId.</param>
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlInt32 param_JobId, System.Data.SqlTypes.SqlInt32 param_CustomerId) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_Job_Full();
			...
			SPs.spS_Job_Full SP = new SPs.spS_Job_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_Job_Full", "RefreshData");
			}
