...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBoxCustom_spS_Title), "WinComboBox.bmp")]
	public class WinComboBoxCustom_spS_Title : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the WinComboBoxCustom_spS_Title class.
		/// </summary>
		public WinComboBoxCustom_spS_Title() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBoxCustom_spS_Title", "RefreshData");
			}
