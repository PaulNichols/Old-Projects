...
namespace Bob.Windows.ComboBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ComboBox class and was built to display the 'Title' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinComboBox_Title), "WinComboBox.bmp")]
	public class WinComboBox_Title : System.Windows.Forms.ComboBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ComboBoxes.WinComboBox_Title class.
		/// </summary>
		public WinComboBox_Title() : base() {
		...
		this.CreateControl();
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinComboBox_Title : System.Windows.Forms.ComboBox", "RefreshData");
			}
