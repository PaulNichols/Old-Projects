...
namespace Bob.Windows.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ListBox class and was built to display the 'Job' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBox_Job), "WinListBox.bmp")]
	public class WinListBox_Job : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ListBoxes.WinListBox_Job class.
		/// </summary>
		public WinListBox_Job() : base() {
