...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBoxCustom_spS_Customers), "WinListBox.bmp")]
	public class WinListBoxCustom_spS_Customers : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WinListBoxCustom_spS_Customers class.
		/// </summary>
		public WinListBoxCustom_spS_Customers() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinListBoxCustom_spS_Customers", "RefreshData");
			}
