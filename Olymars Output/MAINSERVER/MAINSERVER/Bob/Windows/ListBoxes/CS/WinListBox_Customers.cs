...
namespace Bob.Windows.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ListBox class and was built to display the 'Customers' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBox_Customers), "WinListBox.bmp")]
	public class WinListBox_Customers : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ListBoxes.WinListBox_Customers class.
		/// </summary>
		public WinListBox_Customers() : base() {
