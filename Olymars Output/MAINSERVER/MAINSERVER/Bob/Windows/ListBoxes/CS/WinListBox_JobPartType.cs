...
namespace Bob.Windows.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Windows.Forms.ListBox class and was built to display the 'JobPartType' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WinListBox_JobPartType), "WinListBox.bmp")]
	public class WinListBox_JobPartType : System.Windows.Forms.ListBox {
		...
		/// <summary>
		/// Create a new instance of the Bob.Windows.ListBoxes.WinListBox_JobPartType class.
		/// </summary>
		public WinListBox_JobPartType() : base() {
		...
		/// </summary>
		/// <param name="PK_JobPartTypeId">Primary key of the record you want to be selected by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_JobPartTypeId) {

			this.RefreshData(PK_JobPartTypeId, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlInt32 PK_JobPartTypeId, int startRecord, int maxRecords) {

		this.CreateControl();

			if (!PK_JobPartTypeId.IsNull && this.SelectionMode == System.Windows.Forms.SelectionMode.None) {

				throw new ArgumentException("You cannot supply a value to this parameter when SelectionMode property is set to None.", "PK_JobPartTypeId");
			}
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				if (!PK_JobPartTypeId.IsNull) {

					this.SelectedValue = PK_JobPartTypeId.Value;
				}
				else {
				...
				SP.Dispose();
				throw new Bob.DataClasses.CustomException(this.param, "WinListBox_JobPartType : System.Windows.Forms.ListBox", "RefreshData");
			}
