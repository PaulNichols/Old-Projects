...
namespace Bob.DataClasses.Parameters {
	...
	/// stored procedure 'spS_Job_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:09", SqlObjectDependancyName="spS_Job_Full", SqlObjectDependancyRevision=16)]
#endif
	public class spS_Job_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_Job_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_Job_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_Job_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_Job_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_Job_Full'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_Job_Full", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_Job_Full'.
		/// </summary>
...
namespace Bob.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_Job_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:09", SqlObjectDependancyName="spS_Job_Full", SqlObjectDependancyRevision=16)]
#endif
	public class spS_Job_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_Job_Full() : this(false) {
		...
		public spS_Job_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Bob.DataClasses.Parameters.spS_Job_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_Job_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_Job_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_Job_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.DataClasses.Parameters.spS_Job_Full)");
						}
				...
				sqlCommand.CommandText = "spS_Job_Full";
		...
		private bool DeclareParameters(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_Job_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_Job_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_Job_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_Job_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["Price"].Caption = "Price (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Price\" column)";
				dataset.Tables[tableName].Columns["StartDate"].Caption = "StartDate (update this label in the \"Olymars/ColumnLabel\" extended property of the \"StartDate\" column)";
				dataset.Tables[tableName].Columns["EndDate"].Caption = "EndDate (update this label in the \"Olymars/ColumnLabel\" extended property of the \"EndDate\" column)";
				...
				dataset.Tables[tableName].Columns["CustomerId_CustomerID"].Caption = "Customer Number";
				dataset.Tables[tableName].Columns["CustomerId_CompanyName"].Caption = "Company Name";
				dataset.Tables[tableName].Columns["CustomerId_ContactName"].Caption = "Customer/Contact Name";
				dataset.Tables[tableName].Columns["CustomerId_TitleId"].Caption = "Title Id";
				dataset.Tables[tableName].Columns["CustomerId_Address"].Caption = "Customer/Contact Address";
				dataset.Tables[tableName].Columns["CustomerId_City"].Caption = "Customer/Contact City";
				dataset.Tables[tableName].Columns["CustomerId_PostalCode"].Caption = "Customer/Contact Post Code";
				dataset.Tables[tableName].Columns["CustomerId_Phone"].Caption = "Customer/Contact Phone";
				dataset.Tables[tableName].Columns["CustomerId_Email"].Caption = "Email Address";
				dataset.Tables[tableName].Columns["CustomerId_WebAddress"].Caption = "Web Address";
				dataset.Tables[tableName].Columns["CustomerId_Fax"].Caption = "Customer/Contact Fax";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Job_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_Job_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Price via shared members
				/// </summary>
				public class Column_Price {

					/// <summary>
					/// Returns "Price"
					/// </summary>
					public const System.String ColumnName = "Price";
					/// <summary>
					/// Returns 2
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field StartDate via shared members
				/// </summary>
				public class Column_StartDate {

					/// <summary>
					/// Returns "StartDate"
					/// </summary>
					public const System.String ColumnName = "StartDate";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field EndDate via shared members
				/// </summary>
				public class Column_EndDate {

					/// <summary>
					/// Returns "EndDate"
					/// </summary>
					public const System.String ColumnName = "EndDate";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_CustomerID via shared members
				/// </summary>
				public class Column_CustomerId_CustomerID {

					/// <summary>
					/// Returns "CustomerId_CustomerID"
					/// </summary>
					public const System.String ColumnName = "CustomerId_CustomerID";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_CompanyName via shared members
				/// </summary>
				public class Column_CustomerId_CompanyName {

					/// <summary>
					/// Returns "CustomerId_CompanyName"
					/// </summary>
					public const System.String ColumnName = "CustomerId_CompanyName";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_ContactName via shared members
				/// </summary>
				public class Column_CustomerId_ContactName {

					/// <summary>
					/// Returns "CustomerId_ContactName"
					/// </summary>
					public const System.String ColumnName = "CustomerId_ContactName";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_TitleId via shared members
				/// </summary>
				public class Column_CustomerId_TitleId {

					/// <summary>
					/// Returns "CustomerId_TitleId"
					/// </summary>
					public const System.String ColumnName = "CustomerId_TitleId";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_City via shared members
				/// </summary>
				public class Column_CustomerId_City {

					/// <summary>
					/// Returns "CustomerId_City"
					/// </summary>
					public const System.String ColumnName = "CustomerId_City";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_PostalCode via shared members
				/// </summary>
				public class Column_CustomerId_PostalCode {

					/// <summary>
					/// Returns "CustomerId_PostalCode"
					/// </summary>
					public const System.String ColumnName = "CustomerId_PostalCode";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_Phone via shared members
				/// </summary>
				public class Column_CustomerId_Phone {

					/// <summary>
					/// Returns "CustomerId_Phone"
					/// </summary>
					public const System.String ColumnName = "CustomerId_Phone";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_WebAddress via shared members
				/// </summary>
				public class Column_CustomerId_WebAddress {

					/// <summary>
					/// Returns "CustomerId_WebAddress"
					/// </summary>
					public const System.String ColumnName = "CustomerId_WebAddress";
					/// <summary>
					/// Returns 15
					/// </summary>
