...
namespace Bob.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Job'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:10", SqlObjectDependancyName="spU_Job", SqlObjectDependancyRevision=16)]
#endif
	public class spU_Job : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Job class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Job() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Job class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Job(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_Price_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_StartDate_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_StartDate_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_EndDate_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_EndDate_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Job'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_Job", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_Price = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_StartDate = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_StartDate = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_EndDate = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_EndDate = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Job'.
		/// </summary>
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Price;
		internal bool internal_Param_ConsiderNull_Price_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_StartDate;
		internal bool internal_Param_ConsiderNull_StartDate_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDateTime internal_Param_EndDate;
		internal bool internal_Param_EndDate_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_EndDate;
		internal bool internal_Param_ConsiderNull_EndDate_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Price'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Price_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Price {

			get {

				if (this.internal_Param_ConsiderNull_Price_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Price);
			}

			set {

				this.internal_Param_ConsiderNull_Price_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Price = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Price' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Price_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Price_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_StartDate'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_StartDate_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_StartDate {

			get {

				if (this.internal_Param_ConsiderNull_StartDate_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_StartDate);
			}

			set {

				this.internal_Param_ConsiderNull_StartDate_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_StartDate = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_StartDate' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_StartDate_UseDefaultValue() {

			this.internal_Param_ConsiderNull_StartDate_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_EndDate'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_EndDate_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_EndDate {

			get {

				if (this.internal_Param_ConsiderNull_EndDate_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_EndDate);
			}

			set {

				this.internal_Param_ConsiderNull_EndDate_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_EndDate = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_EndDate' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_EndDate_UseDefaultValue() {

			this.internal_Param_ConsiderNull_EndDate_UseDefaultValue = true;
		}
...
namespace Bob.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Job' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:10", SqlObjectDependancyName="spU_Job", SqlObjectDependancyRevision=16)]
#endif
	public class spU_Job : MarshalByRefObject, IDisposable {
		...
		public spU_Job(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Bob.DataClasses.Parameters.spU_Job parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Bob.DataClasses.Parameters.spU_Job parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spU_Job object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spU_Job object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spU_Job object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.DataClasses.Parameters.spU_Job)");
						}
				...
				sqlCommand.CommandText = "spU_Job";
		...
		private bool DeclareParameters(ref Bob.DataClasses.Parameters.spU_Job parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Price", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Price_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Price.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Price;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_StartDate", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_StartDate_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_StartDate.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_StartDate;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_EndDate", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_EndDate_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_EndDate.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_EndDate;
				}
				else {
		...
		private bool RetrieveParameters(ref Bob.DataClasses.Parameters.spU_Job parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Job] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Bob.DataClasses.Parameters.spU_Job parameters) {
