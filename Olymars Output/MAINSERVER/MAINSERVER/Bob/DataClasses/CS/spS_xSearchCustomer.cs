...
namespace Bob.DataClasses.Parameters {
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:10", SqlObjectDependancyName="spS_xSearchCustomer", SqlObjectDependancyRevision=112)]
#endif
...
namespace Bob.DataClasses.StoredProcedures {
	...
	public class spS_xSearchCustomer : MarshalByRefObject, IDisposable {
		...
		private void ResetParameter(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_xSearchCustomer object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_xSearchCustomer object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_xSearchCustomer object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.DataClasses.Parameters.spS_xSearchCustomer)");
						}
		...
		private bool DeclareParameters(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@CompanyName", System.Data.SqlDbType.VarChar, 50);
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ContactName", System.Data.SqlDbType.VarChar, 50);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
		...
		private bool RetrieveParameters(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		public bool Execute(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset) {
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_xSearchCustomer parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
