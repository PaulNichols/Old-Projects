...
namespace Bob.DataClasses.Parameters {
	...
	/// stored procedure 'spS_JobPart_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:10", SqlObjectDependancyName="spS_JobPart_Full", SqlObjectDependancyRevision=16)]
#endif
	public class spS_JobPart_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_JobPart_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_JobPart_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_JobPart_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_JobPart_Full(bool useDefaultValue) {
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_JobPart_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_JobPart_Full");
			}
		}
...
namespace Bob.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_JobPart_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:10", SqlObjectDependancyName="spS_JobPart_Full", SqlObjectDependancyRevision=16)]
#endif
	public class spS_JobPart_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_JobPart_Full() : this(false) {
		...
		public spS_JobPart_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_JobPart_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_JobPart_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_JobPart_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.DataClasses.Parameters.spS_JobPart_Full)");
						}
				...
				sqlCommand.CommandText = "spS_JobPart_Full";
		...
		private bool DeclareParameters(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_JobPart_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_JobPart_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_JobPart_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_JobPart_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["JobPartId"].Caption = "JobPartId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"JobPartId\" column)";
				dataset.Tables[tableName].Columns["JobId"].Caption = "JobId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"JobId\" column)";
				...
				dataset.Tables[tableName].Columns["JobPartTypeId"].Caption = "JobPartTypeId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"JobPartTypeId\" column)";
				dataset.Tables[tableName].Columns["Units"].Caption = "Units (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Units\" column)";
				dataset.Tables[tableName].Columns["PricePerUnit"].Caption = "PricePerUnit (update this label in the \"Olymars/ColumnLabel\" extended property of the \"PricePerUnit\" column)";
				dataset.Tables[tableName].Columns["TotalPrice"].Caption = "TotalPrice (update this label in the \"Olymars/ColumnLabel\" extended property of the \"TotalPrice\" column)";
				dataset.Tables[tableName].Columns["JobId_JobId"].Caption = "JobId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"JobId\" column)";
				dataset.Tables[tableName].Columns["JobId_Description"].Caption = "Description (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Description\" column)";
				dataset.Tables[tableName].Columns["JobId_Price"].Caption = "Price (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Price\" column)";
				dataset.Tables[tableName].Columns["JobId_StartDate"].Caption = "StartDate (update this label in the \"Olymars/ColumnLabel\" extended property of the \"StartDate\" column)";
				dataset.Tables[tableName].Columns["JobId_EndDate"].Caption = "EndDate (update this label in the \"Olymars/ColumnLabel\" extended property of the \"EndDate\" column)";
				dataset.Tables[tableName].Columns["JobId_CustomerId"].Caption = "CustomerId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"CustomerId\" column)";
				dataset.Tables[tableName].Columns["JobPartTypeId_JobPartTypeId"].Caption = "JobPartTypeId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"JobPartTypeId\" column)";
				dataset.Tables[tableName].Columns["JobPartTypeId_Description"].Caption = "Description (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Description\" column)";
				dataset.Tables[tableName].Columns["JobPartTypeId_GeneralUnitCost"].Caption = "GeneralUnitCost (update this label in the \"Olymars/ColumnLabel\" extended property of the \"GeneralUnitCost\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_JobPart_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_JobPart_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobPartId via shared members
				/// </summary>
				public class Column_JobPartId {

					/// <summary>
					/// Returns "JobPartId"
					/// </summary>
					public const System.String ColumnName = "JobPartId";
					/// <summary>
					/// Returns 0
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId via shared members
				/// </summary>
				public class Column_JobId {

					/// <summary>
					/// Returns "JobId"
					/// </summary>
					public const System.String ColumnName = "JobId";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// </summary>
				public class Column_Description {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobPartTypeId via shared members
				/// </summary>
				public class Column_JobPartTypeId {

					/// <summary>
					/// Returns "JobPartTypeId"
					/// </summary>
					public const System.String ColumnName = "JobPartTypeId";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Units via shared members
				/// </summary>
				public class Column_Units {

					/// <summary>
					/// Returns "Units"
					/// </summary>
					public const System.String ColumnName = "Units";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PricePerUnit via shared members
				/// </summary>
				public class Column_PricePerUnit {

					/// <summary>
					/// Returns "PricePerUnit"
					/// </summary>
					public const System.String ColumnName = "PricePerUnit";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TotalPrice via shared members
				/// </summary>
				public class Column_TotalPrice {

					/// <summary>
					/// Returns "TotalPrice"
					/// </summary>
					public const System.String ColumnName = "TotalPrice";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId_JobId via shared members
				/// </summary>
				public class Column_JobId_JobId {

					/// <summary>
					/// Returns "JobId_JobId"
					/// </summary>
					public const System.String ColumnName = "JobId_JobId";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId_Description via shared members
				/// </summary>
				public class Column_JobId_Description {

					/// <summary>
					/// Returns "JobId_Description"
					/// </summary>
					public const System.String ColumnName = "JobId_Description";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId_Price via shared members
				/// </summary>
				public class Column_JobId_Price {

					/// <summary>
					/// Returns "JobId_Price"
					/// </summary>
					public const System.String ColumnName = "JobId_Price";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId_StartDate via shared members
				/// </summary>
				public class Column_JobId_StartDate {

					/// <summary>
					/// Returns "JobId_StartDate"
					/// </summary>
					public const System.String ColumnName = "JobId_StartDate";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId_EndDate via shared members
				/// </summary>
				public class Column_JobId_EndDate {

					/// <summary>
					/// Returns "JobId_EndDate"
					/// </summary>
					public const System.String ColumnName = "JobId_EndDate";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobId_CustomerId via shared members
				/// </summary>
				public class Column_JobId_CustomerId {

					/// <summary>
					/// Returns "JobId_CustomerId"
					/// </summary>
					public const System.String ColumnName = "JobId_CustomerId";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobPartTypeId_JobPartTypeId via shared members
				/// </summary>
				public class Column_JobPartTypeId_JobPartTypeId {

					/// <summary>
					/// Returns "JobPartTypeId_JobPartTypeId"
					/// </summary>
					public const System.String ColumnName = "JobPartTypeId_JobPartTypeId";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobPartTypeId_Description via shared members
				/// </summary>
				public class Column_JobPartTypeId_Description {

					/// <summary>
					/// Returns "JobPartTypeId_Description"
					/// </summary>
					public const System.String ColumnName = "JobPartTypeId_Description";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field JobPartTypeId_GeneralUnitCost via shared members
				/// </summary>
				public class Column_JobPartTypeId_GeneralUnitCost {

					/// <summary>
					/// Returns "JobPartTypeId_GeneralUnitCost"
					/// </summary>
					public const System.String ColumnName = "JobPartTypeId_GeneralUnitCost";
					/// <summary>
					/// Returns 15
					/// </summary>
