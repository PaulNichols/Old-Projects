...
namespace Bob.DataClasses.Parameters {
	...
	/// stored procedure 'spS_Customers_SelectDisplay'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:09", SqlObjectDependancyName="spS_Customers_SelectDisplay", SqlObjectDependancyRevision=112)]
#endif
	public class spS_Customers_SelectDisplay : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_Customers_SelectDisplay class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_Customers_SelectDisplay() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_Customers_SelectDisplay class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_Customers_SelectDisplay(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_Customers_SelectDisplay'";
		...
		/// </summary>
		~spS_Customers_SelectDisplay() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_Customers_SelectDisplay'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_Customers_SelectDisplay");
			}
		}
...
namespace Bob.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_Customers_SelectDisplay' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2005/01/15 18:39:09", SqlObjectDependancyName="spS_Customers_SelectDisplay", SqlObjectDependancyRevision=112)]
#endif
	public class spS_Customers_SelectDisplay : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_Customers_SelectDisplay() : this(false) {
		...
		public spS_Customers_SelectDisplay(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_Customers_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_Customers_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Bob.DataClasses.Parameters.spS_Customers_SelectDisplay object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Bob.DataClasses.Parameters.spS_Customers_SelectDisplay)");
						}
				...
				sqlCommand.CommandText = "spS_Customers_SelectDisplay";
		...
		private bool DeclareParameters(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_Customers_SelectDisplay] stored procedure and retrieve back the data
		...
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_Customers_SelectDisplay'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_Customers_SelectDisplay", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_Customers_SelectDisplay", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["CustomerID"].Caption = "Customer Number";
				dataset.Tables[tableName].Columns["CompanyName"].Caption = "Company Name";
				dataset.Tables[tableName].Columns["ContactName"].Caption = "Customer/Contact Name";
				dataset.Tables[tableName].Columns["TitleId"].Caption = "Title Id";
				dataset.Tables[tableName].Columns["TitleId_Display"].Caption = "Title";
				dataset.Tables[tableName].Columns["Address"].Caption = "Customer/Contact Address";
				dataset.Tables[tableName].Columns["City"].Caption = "Customer/Contact City";
				dataset.Tables[tableName].Columns["PostalCode"].Caption = "Customer/Contact Post Code";
				dataset.Tables[tableName].Columns["Phone"].Caption = "Customer/Contact Phone";
				dataset.Tables[tableName].Columns["Email"].Caption = "Email Address";
				dataset.Tables[tableName].Columns["WebAddress"].Caption = "Web Address";
				dataset.Tables[tableName].Columns["Fax"].Caption = "Customer/Contact Fax";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Bob.DataClasses.Parameters.spS_Customers_SelectDisplay parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_Customers_SelectDisplay' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CompanyName via shared members
				/// </summary>
				public class Column_CompanyName {

					/// <summary>
					/// Returns "CompanyName"
					/// </summary>
					public const System.String ColumnName = "CompanyName";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ContactName via shared members
				/// </summary>
				public class Column_ContactName {

					/// <summary>
					/// Returns "ContactName"
					/// </summary>
					public const System.String ColumnName = "ContactName";
					/// <summary>
					/// Returns 2
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TitleId via shared members
				/// </summary>
				public class Column_TitleId {

					/// <summary>
					/// Returns "TitleId"
					/// </summary>
					public const System.String ColumnName = "TitleId";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TitleId_Display via shared members
				/// </summary>
				public class Column_TitleId_Display {

					/// <summary>
					/// Returns "TitleId_Display"
					/// </summary>
					public const System.String ColumnName = "TitleId_Display";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field City via shared members
				/// </summary>
				public class Column_City {

					/// <summary>
					/// Returns "City"
					/// </summary>
					public const System.String ColumnName = "City";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PostalCode via shared members
				/// </summary>
				public class Column_PostalCode {

					/// <summary>
					/// Returns "PostalCode"
					/// </summary>
					public const System.String ColumnName = "PostalCode";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Phone via shared members
				/// </summary>
				public class Column_Phone {

					/// <summary>
					/// Returns "Phone"
					/// </summary>
					public const System.String ColumnName = "Phone";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field WebAddress via shared members
				/// </summary>
				public class Column_WebAddress {

					/// <summary>
					/// Returns "WebAddress"
					/// </summary>
					public const System.String ColumnName = "WebAddress";
					/// <summary>
					/// Returns 10
					/// </summary>
