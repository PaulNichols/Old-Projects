...
.DESCRIPTION 
    ...
    This script will highlight any duplicates detected and allow users to manually go in and perform a clean up as required.
...
.LINK
    http://wiki.racqgroup.local/Confluence/display/tech/Validate-OctopusVariables+script
