Namespace ASPNET.StarterKit.Portal
    ...
    Public MustInherit Class LetterTemplates
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ModuleConfiguration.ModuleId = 34
            ModuleConfiguration.ModuleTitle = "Contact Templates"
        ...
        Function GetBrowsePath(ByVal url As String, ByVal size As Object, ByVal documentId As Integer, ByVal templatePage As String) As String
            Return "~/desktopmodules/" & templatePage & "?url=" & url & "&FriendlyName=" & "TestDoc" & "&Docid=" & documentId
