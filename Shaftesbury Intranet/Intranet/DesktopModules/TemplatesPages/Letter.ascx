<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Letter.ascx.vb" Inherits="LetterControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
