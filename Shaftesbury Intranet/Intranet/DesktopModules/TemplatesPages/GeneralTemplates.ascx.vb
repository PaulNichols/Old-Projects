Namespace ASPNET.StarterKit.Portal
    ...
    Public MustInherit Class GeneralTemplates
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Dim documents As New ASPNET.StarterKit.Portal.DocumentDB
                ...
                ModuleConfiguration.ModuleId = 40
                ModuleConfiguration.ModuleTitle = "General Templates"
                ModuleConfiguration.AuthorizedEditRoles = ""
        ...
        Function GetBrowsePath(ByVal url As String, ByVal size As Object, ByVal documentId As Integer, ByVal templatePage As String) As String
            Return "~/desktopmodules/" & templatePage & "?general=true&url=" & url & "&FriendlyName=" & "TestDoc" & "&Docid=" & documentId & " target=""_blank"""
