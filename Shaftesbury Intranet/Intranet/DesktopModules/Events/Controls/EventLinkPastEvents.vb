...
Public Class EventLinkPastEvents
    ...
    '*********************************************************************
    '
    ' EventLinkPastEvents Constructor
    '
    ' Assign a default css style (the user can override)
    '
    '*********************************************************************
    Public Sub New()
        CssClass = "eventLinkPastEvents"
    End Sub 'New
    ...
    Protected Overrides Sub Render(writer As HtmlTextWriter)
        ...
        If Not (Context Is Nothing) Then
            NavigateUrl = CommunityGlobals.CalculatePath("Events_PastEvents.aspx")
        End If
        MyBase.Render(writer)
    End Sub 'Render
End Class 'EventLinkPastEvents 
