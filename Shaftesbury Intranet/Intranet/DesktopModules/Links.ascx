...
<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.Links" CodeBehind="Links.ascx.vb" AutoEventWireup="false" targetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
