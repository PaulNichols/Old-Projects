...
Namespace ASPNET.StarterKit.Portal
    ...
    Public Class LinkDB
        ...
        Public Function AddLink(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userId As Int32, _
            ByVal title As String, ByVal url As String, ByVal mobileUrl As String, ByVal viewOrder As Integer, _
        ...
        Public Sub UpdateLink(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userId As Int32, _
            ByVal title As String, ByVal url As String, ByVal mobileUrl As String, ByVal viewOrder As Integer, _
