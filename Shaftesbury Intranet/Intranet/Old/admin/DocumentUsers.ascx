								...
								<td width="*">
									<table width="450" cellpadding="2" cellspacing="4" border="0" id="Table3">
											...
											<td>
												<table width="100%" cellspacing="0" cellpadding="0" id="Table5">
													<tr>
														...
														<td>
															<asp:linkbutton id="addExisting" cssclass="CommandButton" text="Link user to Document" runat="server" />
														</td>
										...
										<tr valign="top">
											...
											<td><br>The following users have permissions to view this document.<p></p>
												<asp:datalist id="DocumentUsers" repeatcolumns="2" datakeyfield="UserId" runat="server">
													<itemstyle width="225" />
													<itemtemplate>
														&nbsp;&nbsp;
														<asp:imagebutton imageurl="~/images/delete.gif" commandname="delete" alternatetext="Remove this user association" runat="server" />
