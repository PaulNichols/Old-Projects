<%@ Page Language="vb" AutoEventWireup="false" Codebehind="London.aspx.vb" Inherits="LondonLetter"%>

  <HEAD>
	<title>Private Letter for Brian (London)</title>
...
<TABLE height=642 cellSpacing=0 cellPadding=0 width=765 border=0 
ms_2d_layout="TRUE">
  <TR>
  ...
  <TR vAlign=top>
    ...
    <TD colSpan=4>
						<asp:textbox id="txtyourref" Width="208px" runat="server" CssClass="Normaltextbox"></asp:textbox></TD></TR>
  <TR vAlign=top>
  ...
  <TR vAlign=top>
    ...
    <TD colSpan=5 rowSpan=4><asp:listbox id="lstDeliveredBy" Height="248px" CssClass="Normaltextbox" runat="server" Width="264px"></asp:listbox></TD></TR>
  <TR vAlign=top>
  ...
  <TR vAlign=top>
    ...
    <TD colSpan=6><asp:textbox id="txtSalutation" CssClass="Normaltextbox" runat="server" Width="256px"></asp:textbox></TD></TR>
  <TR vAlign=top>
    <TD colSpan=6 height=32></TD>
    <TD colSpan=4><asp:label id="Label6" CssClass="NormalBold" runat="server">Heading:</asp:label></TD>
    <TD colSpan=6><asp:textbox id="txtHeading" CssClass="Normaltextbox" runat="server" Width="256px"></asp:textbox></TD></TR>
  <TR vAlign=top>
  ...
  <TR vAlign=top>
    ...
    <TD colSpan=2><asp:textbox id="txtTitle" CssClass="Normaltextbox" runat="server" Width="88px" Enabled="False"></asp:textbox></TD></TR>
  <TR vAlign=top>
  ...
  <TR vAlign=top>
    ...
    <TD></TD>
    <TD colSpan=3></TD>
    <TD><asp:button id="cmdNext" CssClass="Normal" runat="server" Text="Next >>"></asp:button></TD></TR>
  <TR vAlign=top>
    <TD colSpan=2 height=10></TD>
    <TD colSpan=21>
						<HR width="720">
    </TD></TR></TABLE></TABLE></TABLE></TABLE></TABLE></DIV>
	</form>
</BODY>
