...
Namespace ASPNET.StarterKit.Portal
    ...
    Public Class EditDocs
        ...
        Protected WithEvents txtDecription As System.Web.UI.WebControls.TextBox
        Protected WithEvents txtTemplatePage As System.Web.UI.WebControls.TextBox
        ...
        Protected WithEvents txtTemplatePath As System.Web.UI.WebControls.TextBox
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                ...
                If itemId <> 0 Then
                    ...
                    txtTemplatePage.Text = CStr(dr("TemplatePage"))
                    dr.Close()
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            If Page.IsValid = True Then
                ...
                documents.UpdateDocument(moduleId, itemId, CType(Session("User"), ASPNET.StarterKit.Portal.UserDetails).Id, _
                    NameField.Text, PathField.Text, CategoryField.Text, New Byte(0) {}, 0, "", txtDescription.Text, txtTemplatePage.Text)
