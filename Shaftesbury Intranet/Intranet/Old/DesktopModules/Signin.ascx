...
<br>
<asp:TextBox id="password" columns="9" width="130" textmode="password" cssclass="NormalTextBox"
	runat="server" />
<br>
...
<table width="100%" cellspacing="0" cellpadding="4" border="0">
	<tr>
		<td>
			...
			<br>
			<a href="Admin/Register.aspx"></a>&nbsp;
			<asp:label id="Message" class="NormalRed" runat="server" Visible="False" />
		</td>
	</tr>
</table>
<br>
