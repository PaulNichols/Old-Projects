        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            If Page.IsValid = True Then
                ...
                If itemId = 0 Then
                    ...
                    announcementDB.AddAnnouncement(moduleId, itemId, CType(Session("User"), ASPNET.StarterKit.Portal.UserDetails).Id, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, MoreLinkField.Text, "")

                Else

                    ' Update the announcement within the Announcements table
                    announcementDB.UpdateAnnouncement(moduleId, itemId, CType(Session("User"), ASPNET.StarterKit.Portal.UserDetails).Id, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, MoreLinkField.Text, "")
