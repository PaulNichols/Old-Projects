...
#End Region
        ...
        Private Sub AddTab_Click(ByVal Sender As Object, ByVal e As EventArgs) Handles addBtn.Click
			...
			Dim config As New Configuration()
			t.TabId = config.AddTab(_portalSettings.PortalId, t.TabName, t.TabOrder)

			' reload the _portalSettings from the database
			HttpContext.Current.Items("PortalSettings") = New PortalSettings(_portalSettings.PortalId, t.TabId)
