...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not PortalSecurity.IsInRoles("Admins") AndAlso Not PortalSecurity.IsInRoles("Shaftesbury Admin") Then
        ...
        Private Sub Apply_Click(ByVal sender As Object, ByVal e As EventArgs) Handles applyBtn.Click
			...
			config.UpdatePortalInfo(_portalSettings.PortalId, siteName.Text, showEdit.Checked)
