...
namespace Discovery.Integration.ExceptionHandling.Design
{
    ...
    public class EmailHandlerNode : ExceptionHandlerNode
    {
        ...
        public EmailHandlerNode(EmailHandlerData EmailExceptionHandlerData)
        {
...
namespace Discovery.Integration.ExceptionHandling
{
    ...
    public class EmailHandlerData : CustomHandlerData
    {
        ...
        [ConfigurationProperty(policyProperty, IsRequired = false)]
        public string Policy
        {
    ...
    public class EmailHandlerAssembler : IAssembler<IExceptionHandler, ExceptionHandlerData>
    {
        ...
        {
            EmailHandlerData castedObjectConfiguration
