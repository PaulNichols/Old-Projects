IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'Discovery_GetTDCShipmentLineByCode')
	BEGIN
		DROP  Procedure  Discovery_GetTDCShipmentLineByCode
		
	END

GO

CREATE Procedure Discovery_GetTDCShipmentLineByCode
	(
		@lineCode int, 
		@opcoCode varchar(3), 
