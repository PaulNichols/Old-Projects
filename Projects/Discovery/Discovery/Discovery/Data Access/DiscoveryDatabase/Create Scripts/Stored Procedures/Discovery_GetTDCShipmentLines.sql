IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'Discovery_GetTDCShipmentLines')
	BEGIN
		DROP  Procedure  Discovery_GetTDCShipmentLines
	END

GO

CREATE Procedure Discovery_GetTDCShipmentLines
