<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="OptrakRegion.aspx.cs" Inherits="Discovery.UI.Web.ReferenceData.OptrakRegion" Title="Mangement Server - Region Maintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
        ShowSummary="False" />
    <asp:ObjectDataSource ID="RegionDataSource" runat="server" DataObjectTypeName="Discovery.BusinessObjects.OptrakRegion"
        DeleteMethod="DeleteRegion" InsertMethod="SaveRegion" SelectMethod="GetRegion"
        TypeName="Discovery.BusinessObjects.Controllers.OptrakRegionController" UpdateMethod="SaveRegion" >
