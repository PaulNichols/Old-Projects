...
Namespace RPT
    ...
    Public Class DFA_OnlineRefund
        ...
        Friend Overrides Function Process(ByVal reportCriteria As ReportCriteria.ReportCriteria, ByVal reportPrintJobId As Int32, ByRef printSequence As Int32, ByVal saveReport As Boolean) As BOReportResults()
            ...
            Dim rptCriteria As ReportCriteria.DFA_OnlineRefundCriteria = CType(reportCriteria, ReportCriteria.DFA_OnlineRefundCriteria)

            Dim reportDataset As DataSet

            reportDataset = GetDataset(rptCriteria)

            Dim crystalRPT As New DFA_Online_Refund_RPT
        ...
        Public Function GetDataset(ByVal rptCriteria As ReportCriteria.DFA_OnlineRefundCriteria) As DFA_Online_RefundData

            Dim aDataset As New DFA_Online_RefundData
            Dim aRow As DFA_Online_RefundData.BODFA_Online_RefundRow
            Dim subTotal As DFA_Online_RefundData.BODFA_Online_RefundRow

            ' DFA_Online_Refund - Row 
            aRow = aDataset.BODFA_Online_Refund.NewBODFA_Online_RefundRow
            aRow.RowId = 1
            aRow.BoldRow = True
            ...
            aRow.Details = ""
            aRow.Notes = ""
            aDataset.BODFA_Online_Refund.AddBODFA_Online_RefundRow(aRow)
            ...
            Dim payments As ReportDFA.BOReportOnlineRefund
            Dim detailRefunds(-1) As ReportDFA.BOReportOnlineRefund
            detailRefunds = payments.getReportOnlineRefund(rptCriteria.FromDate, rptCriteria.ToDate)
            ...
            For Each detailRefund As ReportDFA.BOReportOnlineRefund In detailRefunds
                ...
                If transDate <> prevTransDate Then ' Do we have a change in transaction date
                    If prevTransDate.Length <> 0 Then
                        ...
                        rowId += 1
                        subTotal = aDataset.BODFA_Online_Refund.NewBODFA_Online_RefundRow
                        subTotal.RowId = rowId
                        subTotal.BoldRow = True
                        subTotal.ColumnData = "Refund Sub Total: " & transDate
                        ...
                        subTotal.Details = " "
                        subTotal.Notes = " "
                        aDataset.BODFA_Online_Refund.AddBODFA_Online_RefundRow(subTotal)
