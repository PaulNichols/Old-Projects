...
Namespace RPT
    ...
    Public Class Article10
        ...
        Friend Overrides Function Process(ByVal reportCriteria As ReportCriteria.ReportCriteria, ByVal reportPrintJobId As Int32, ByRef printSequence As Int32, ByVal saveReport As Boolean) As BOReportResults()
            Dim article10ReportCriteria As ReportCriteria.Article10ReportCriteria = CType(reportCriteria, ReportCriteria.Article10ReportCriteria)

            Dim reportDataResults As ReportDataResults = GetReportDataResults(article10ReportCriteria.PermitInfoId, article10ReportCriteria.Duplicate)

            Dim article10_RPT As New article10_RPT
            Dim reportResults(0) As BOReportResults
            reportResults(0) = DoReport(reportCriteria.Description, reportDataResults.SearchReference, article10ReportCriteria.PermitInfoId, reportDataResults.ReportData, article10ReportCriteria, saveReport, _
