Namespace Application.ProgressStatus
    Public Class BOProgressStatusReIssued
        ...
        Public Sub New(ByVal id As Int32, ByVal tran As SqlClient.SqlTransaction)
            Dim entity As DataObjects.Entity.ProgressStatusReIssued = DataObjects.Entity.ProgressStatusReIssued.GetById(id, tran)
