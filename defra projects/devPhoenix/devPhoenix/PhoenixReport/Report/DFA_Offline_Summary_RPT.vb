...
Public Class DFA_Offline_Summary_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "DFA_Offline_Summary_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDFA_Offline_Summary_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DFA_Offline_Summary_RPT = New DFA_Offline_Summary_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
