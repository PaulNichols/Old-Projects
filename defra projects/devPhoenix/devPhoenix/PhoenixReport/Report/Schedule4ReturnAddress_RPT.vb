...
Public Class Schedule4ReturnAddress_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Schedule4ReturnAddress_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSchedule4ReturnAddress_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Schedule4ReturnAddress_RPT = New Schedule4ReturnAddress_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
