...
Public Class Schedule4InspectorSig_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Schedule4InspectorSig_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Pm_MaxSignatures As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedSchedule4InspectorSig_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Schedule4InspectorSig_RPT = New Schedule4InspectorSig_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
