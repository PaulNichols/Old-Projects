...
Public Class CITESConsignmentPermits_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CITESConsignmentPermits_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_HideDraftCopy As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedCITESConsignmentPermits_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CITESConsignmentPermits_RPT = New CITESConsignmentPermits_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
