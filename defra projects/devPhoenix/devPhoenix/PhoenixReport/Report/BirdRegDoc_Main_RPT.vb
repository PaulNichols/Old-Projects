...
Public Class BirdRegDoc_Main_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "BirdRegDoc_Main_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBirdRegDoc_Main_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BirdRegDoc_Main_RPT = New BirdRegDoc_Main_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
