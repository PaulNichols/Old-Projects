...
Public Class Schedule4ReplacementRings_Main_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Schedule4ReplacementRings_Main_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Schedule4InspectorSig_RPTrpt_Pm_MaxSignatures As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedSchedule4ReplacementRings_Main_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Schedule4ReplacementRings_Main_RPT = New Schedule4ReplacementRings_Main_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
