...
Public Class Schedule4Birds_Main_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Schedule4Birds_Main_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSchedule4Birds_Main_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Schedule4Birds_Main_RPT = New Schedule4Birds_Main_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
