...
Public Class RemittanceAdvice_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RemittanceAdvice_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemittanceAdvice_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemittanceAdvice_RPT = New RemittanceAdvice_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
