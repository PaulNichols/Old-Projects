...
Public Class LimisRunningTotals_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "LimisRunningTotals_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FinancialYear As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedLimisRunningTotals_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LimisRunningTotals_RPT = New LimisRunningTotals_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
