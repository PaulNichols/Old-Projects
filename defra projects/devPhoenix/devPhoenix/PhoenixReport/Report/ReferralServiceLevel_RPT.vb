...
Public Class ReferralServiceLevel_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "ReferralServiceLevel_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReferralServiceLevel_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReferralServiceLevel_RPT = New ReferralServiceLevel_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
