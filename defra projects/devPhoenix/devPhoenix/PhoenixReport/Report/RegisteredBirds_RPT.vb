...
Public Class RegisteredBirds_RPT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RegisteredBirds_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegisteredBirds_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegisteredBirds_RPT = New RegisteredBirds_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
