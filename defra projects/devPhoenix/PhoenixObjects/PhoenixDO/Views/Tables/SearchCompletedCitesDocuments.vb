...
Namespace DataObjects.Views.Entity
    ...
    'Entity implementation for table 'vSearchCompletedCitesDocuments'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class SearchCompletedCitesDocuments
        Inherits Base.SearchCompletedCitesDocumentsBase
