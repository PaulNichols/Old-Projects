...
Namespace DataObjects.Views.Entity
    ...
    'Entity implementation for table 'vDisplayAnimalDelegationAuthority'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class DisplayAnimalDelegationAuthority
        Inherits Base.DisplayAnimalDelegationAuthorityBase
