...
Namespace DataObjects.Views.Entity
    ...
    'Entity implementation for table 'vSearchTaxonomyAnimalLicensing'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class SearchTaxonomyAnimalLicensing
        Inherits Base.SearchTaxonomyAnimalLicensingBase
