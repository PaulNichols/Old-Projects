...
Namespace DataObjects.Views.Entity
    ...
    'Entity implementation for table 'vTaxonomyPermittedListingValuesEU'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyPermittedListingValuesEU
        Inherits Base.TaxonomyPermittedListingValuesEUBase
