...
Namespace DataObjects.Views.Entity
    ...
    'Entity implementation for table 'uvw_PreferredGatewyContactDetails'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class vPreferredGatewyContactDetails
        Inherits Base.vPreferredGatewyContactDetailsBase
