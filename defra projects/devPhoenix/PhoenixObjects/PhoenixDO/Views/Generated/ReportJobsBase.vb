...
Namespace DataObjects.Views.Base
    ...
    'Base entity implementation for table 'vReportJobs'
    '*DO NOT* modify this file.
    'Add new properties and methods to ReportJobs instead.
    Public MustInherit Class ReportJobsBase
        ...
        <EnterpriseObjects.Attributes.FieldSize(50)>  _
        Public Property ReporTypeDescription As String
            Get
        ...
        <EnterpriseObjects.Attributes.FieldSize(50)>  _
        Public Property PrintJobDescription As String
            Get
        ...
        Public Shared ReadOnly Property ServiceObject As Service.ReportJobsService
            Get
                Return CType(GetServiceObject(GetType(Service.ReportJobsService)),Service.ReportJobsService)
            End Get
        End Property
        ...
        Public Overloads Shared Function GetAll() As EntitySet.ReportJobsSet
            Return ReportJobsBase.GetAll(false, false, ReportJobsServiceBase.OrderBy.DefaultOrder)
        End Function
        
        Public Overloads Shared Function GetAll(ByVal includeHyphen As Boolean) As EntitySet.ReportJobsSet
            Return ReportJobsBase.GetAll(includeHyphen, false, ReportJobsServiceBase.OrderBy.DefaultOrder)
        End Function
        
        Public Overloads Shared Function GetAll(ByVal includeHyphen As Boolean, ByVal includeInactive As Boolean, ByVal orderBy As ReportJobsServiceBase.OrderBy) As EntitySet.ReportJobsSet
            Dim service As Service.ReportJobsService
            service = ServiceObject
            Return service.GetAll(includeHyphen, includeInactive, orderBy)
        End Function
        
        Public Overloads Shared Function GetAll(ByVal orderBy As ReportJobsServiceBase.OrderBy) As EntitySet.ReportJobsSet
            Return ReportJobsBase.GetAll(false, false, orderBy)
        End Function
    End Class
End Namespace
