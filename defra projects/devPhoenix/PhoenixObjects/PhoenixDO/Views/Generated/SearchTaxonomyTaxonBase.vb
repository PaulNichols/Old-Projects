...
Namespace DataObjects.Views.Base
    ...
    'Base entity implementation for table 'vSearchTaxonomyTaxon'
    '*DO NOT* modify this file.
    'Add new properties and methods to SearchTaxonomyTaxon instead.
    Public MustInherit Class SearchTaxonomyTaxonBase
        ...
        <EnterpriseObjects.Attributes.FieldSize(203)>  _
        Public Property SearchableName As String
            Get
        ...
        <EnterpriseObjects.Attributes.FieldSize(50)>  _
        Public Property TaxonTypeDescription As String
            Get
                If (Me.IsTaxonTypeDescriptionNull = true) Then
                    Return Nothing
                Else
        ...
        <EnterpriseObjects.Attributes.FieldSize(50)>  _
        Public Property TaxonStatusDescription As String
            Get
        ...
        Public Shared ReadOnly Property ServiceObject As Service.SearchTaxonomyTaxonService
            Get
                Return CType(GetServiceObject(GetType(Service.SearchTaxonomyTaxonService)),Service.SearchTaxonomyTaxonService)
            End Get
        End Property
        ...
        Public Function IsTaxonTypeDescriptionNull() As Boolean
            Return Me.IsNull(13)
        End Function
        
        Public Sub SetTaxonTypeDescriptionToNull()
        ...
        Public Overloads Shared Function GetAll() As EntitySet.SearchTaxonomyTaxonSet
            Return SearchTaxonomyTaxonBase.GetAll(false, false, SearchTaxonomyTaxonServiceBase.OrderBy.DefaultOrder)
        End Function
        
        Public Overloads Shared Function GetAll(ByVal includeHyphen As Boolean) As EntitySet.SearchTaxonomyTaxonSet
            Return SearchTaxonomyTaxonBase.GetAll(includeHyphen, false, SearchTaxonomyTaxonServiceBase.OrderBy.DefaultOrder)
        End Function
        
        Public Overloads Shared Function GetAll(ByVal includeHyphen As Boolean, ByVal includeInactive As Boolean, ByVal orderBy As SearchTaxonomyTaxonServiceBase.OrderBy) As EntitySet.SearchTaxonomyTaxonSet
            Dim service As Service.SearchTaxonomyTaxonService
            service = ServiceObject
            Return service.GetAll(includeHyphen, includeInactive, orderBy)
        End Function
        
        Public Overloads Shared Function GetAll(ByVal orderBy As SearchTaxonomyTaxonServiceBase.OrderBy) As EntitySet.SearchTaxonomyTaxonSet
            Return SearchTaxonomyTaxonBase.GetAll(false, false, orderBy)
        End Function
    End Class
End Namespace
