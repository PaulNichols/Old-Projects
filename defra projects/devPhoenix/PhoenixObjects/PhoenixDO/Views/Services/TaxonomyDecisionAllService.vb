...
Namespace DataObjects.Views.Service
    ...
    'Service implementation for table 'vTaxonomyDecisionAll'
    '*DO* add your modifications to this file
    Public Class TaxonomyDecisionAllService
        Inherits Base.TaxonomyDecisionAllServiceBase
        ...
        Public Shared Function GetSummaryByTaxon(ByVal KingdomID As Int32, ByVal TaxonID As Int32, ByVal TaxonTypeID As Int32) As Views.Collection.TaxonomyDecisionAllBoundCollection
            'create a command...
            Dim command As System.Data.SqlClient.SqlCommand = New System.Data.SqlClient.SqlCommand("dbo.usp_GetSummaryDecisionByTaxon")
            ...
            Dim service As Views.Service.TaxonomyDecisionAllService
            service = Views.Entity.TaxonomyDecisionAll.ServiceObject
            Dim ResultsSet As Views.EntitySet.TaxonomyDecisionAllSet = CType(service.GetEntitySet(command, GetType(Views.EntitySet.TaxonomyDecisionAllSet)), Views.EntitySet.TaxonomyDecisionAllSet)
        ...
        Public Shared Function GetHistoricByTaxon(ByVal KingdomID As Int32, ByVal TaxonID As Int32, ByVal TaxonTypeID As Int32) As Collection.TaxonomyDecisionAllBoundCollection
            'create a command...
            Dim command As System.Data.SqlClient.SqlCommand = New System.Data.SqlClient.SqlCommand("dbo.usp_GetHistoricAllDecisionByTaxon")
            command.CommandType = System.Data.CommandType.StoredProcedure
