...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyAquaticRegion'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyAquaticRegion
        Inherits Base.TaxonomyAquaticRegionBase
