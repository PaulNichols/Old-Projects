...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyPermittedListingValue'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyPermittedListingValue
        Inherits Base.TaxonomyPermittedListingValueBase
