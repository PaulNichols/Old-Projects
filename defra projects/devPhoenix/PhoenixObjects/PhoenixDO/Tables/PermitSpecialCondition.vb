...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'PermitSpecialCondition'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class PermitSpecialCondition
        Inherits Base.PermitSpecialConditionBase
