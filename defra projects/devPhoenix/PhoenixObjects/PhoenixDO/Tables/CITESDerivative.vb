...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'CITESDerivative'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class CITESDerivative
        Inherits Base.CITESDerivativeBase
