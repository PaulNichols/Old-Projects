...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'CITESExportApplication'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class CITESExportApplication
        Inherits Base.CITESExportApplicationBase
        ...
        Public Sub New(ByVal citesExportApplicationId As Integer)
            MyBase.New(citesExportApplicationId)
        End Sub
