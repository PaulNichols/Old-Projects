...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'PhoenixParameter'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class PhoenixParameter
        Inherits Base.PhoenixParameterBase
