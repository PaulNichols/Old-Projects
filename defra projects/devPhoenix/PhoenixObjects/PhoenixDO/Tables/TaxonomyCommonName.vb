...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyCommonName'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyCommonName
        Inherits Base.TaxonomyCommonNameBase
        ...
        Public Sub New(ByVal sourceTable As Integer, ByVal commonNameID As Integer)
            MyBase.New(sourceTable, commonNameID)
        End Sub
        ...
        Public Sub New(ByVal sourceTable As Integer, ByVal commonNameID As Integer, ByVal tran As System.Data.SqlClient.SqlTransaction)
            MyBase.New(sourceTable, commonNameID, tran)
        End Sub
