...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'ReturnedPermit'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class ReturnedPermit
        Inherits Base.ReturnedPermitBase
