...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomySpeciesAquaticDistribution'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomySpeciesAquaticDistribution
        Inherits Base.TaxonomySpeciesAquaticDistributionBase
