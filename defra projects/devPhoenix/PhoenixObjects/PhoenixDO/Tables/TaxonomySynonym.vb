...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomySynonym'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomySynonym
        Inherits Base.TaxonomySynonymBase
        ...
        Public Sub New(ByVal synonymSource As Integer, ByVal synonymID As Integer)
            MyBase.New(synonymSource, synonymID)
        End Sub
        ...
        Public Sub New(ByVal synonymSource As Integer, ByVal synonymID As Integer, ByVal tran As System.Data.SqlClient.SqlTransaction)
            MyBase.New(synonymSource, synonymID, tran)
        End Sub
