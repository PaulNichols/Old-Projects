...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyDataLoadMessageStatus'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyDataLoadMessageStatus
        Inherits Base.TaxonomyDataLoadMessageStatusBase
