...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyDecision'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyDecision
        Inherits Base.TaxonomyDecisionBase
