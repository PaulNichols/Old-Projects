...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyDataLoadRequestHistory'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyDataLoadRequestHistory
        Inherits Base.TaxonomyDataLoadRequestHistoryBase
