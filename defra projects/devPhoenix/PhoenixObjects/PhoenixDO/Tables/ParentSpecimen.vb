...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'ParentSpecimen'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class ParentSpecimen
        Inherits Base.ParentSpecimenBase
