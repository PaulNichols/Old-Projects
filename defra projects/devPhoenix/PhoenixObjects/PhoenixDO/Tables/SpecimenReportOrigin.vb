...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'SpecimenReportOrigin'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class SpecimenReportOrigin
        Inherits Base.SpecimenReportOriginBase
