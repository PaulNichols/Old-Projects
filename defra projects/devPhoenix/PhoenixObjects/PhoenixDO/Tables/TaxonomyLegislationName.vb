...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyLegislationName'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyLegislationName
        Inherits Base.TaxonomyLegislationNameBase
