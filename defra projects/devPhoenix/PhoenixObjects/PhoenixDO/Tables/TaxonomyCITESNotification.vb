...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyCITESNotification'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyCITESNotification
        Inherits Base.TaxonomyCITESNotificationBase
