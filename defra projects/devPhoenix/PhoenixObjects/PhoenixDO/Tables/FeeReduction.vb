...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'FeeReduction'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class FeeReduction
        Inherits Base.FeeReductionBase
