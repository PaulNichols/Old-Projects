...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'SavedApplicationSearch'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class SavedApplicationSearch
        Inherits Base.SavedApplicationSearchBase
