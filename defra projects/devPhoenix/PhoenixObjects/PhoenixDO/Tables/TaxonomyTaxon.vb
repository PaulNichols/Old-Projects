...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyTaxon'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyTaxon
        Inherits Base.TaxonomyTaxonBase
        ...
        Public Function GetRelatedNotes() As EntitySet.NoteSet
            If Id > 0 Then
                Return Entity.Note.GetForTaxon(Id)
            Else
                Return Nothing
            End If
        End Function
