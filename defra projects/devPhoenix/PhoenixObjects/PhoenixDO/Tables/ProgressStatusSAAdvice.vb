...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'ProgressStatusSAAdvice'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class ProgressStatusSAAdvice
        Inherits Base.ProgressStatusSAAdviceBase
