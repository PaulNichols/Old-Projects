...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomySpeciesCountryDistribution'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomySpeciesCountryDistribution
        Inherits Base.TaxonomySpeciesCountryDistributionBase
        ...
        Public Sub New(ByVal source As Integer, ByVal speciesCountryDistributionID As Integer)
            MyBase.New(source, speciesCountryDistributionID)
        End Sub
        ...
        Public Sub New(ByVal source As Integer, ByVal speciesCountryDistributionID As Integer, ByVal tran As System.Data.SqlClient.SqlTransaction)
            MyBase.New(source, speciesCountryDistributionID, tran)
        End Sub
