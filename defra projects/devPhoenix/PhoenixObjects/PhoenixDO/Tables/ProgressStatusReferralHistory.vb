...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'ProgressStatusReferralHistory'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class ProgressStatusReferralHistory
        Inherits Base.ProgressStatusReferralHistoryBase
