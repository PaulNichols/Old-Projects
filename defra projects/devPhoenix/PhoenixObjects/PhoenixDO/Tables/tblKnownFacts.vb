...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'tblKnownFacts'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class tblKnownFacts
        Inherits Base.tblKnownFactsBase
