...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'NotificationSpecieLink'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class NotificationSpecieLink
        Inherits Base.NotificationSpecieLinkBase
        ...
        Public Sub New(ByVal specieId As Integer, ByVal cITESNotificationId As Integer)
            MyBase.New(specieId, cITESNotificationId)
        End Sub
        ...
        Public Sub New(ByVal specieId As Integer, ByVal cITESNotificationId As Integer, ByVal tran As System.Data.SqlClient.SqlTransaction)
            MyBase.New(specieId, cITESNotificationId, tran)
        End Sub
