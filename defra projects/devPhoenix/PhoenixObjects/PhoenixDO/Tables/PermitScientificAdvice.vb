...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'PermitScientificAdvice'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class PermitScientificAdvice
        Inherits Base.PermitScientificAdviceBase
