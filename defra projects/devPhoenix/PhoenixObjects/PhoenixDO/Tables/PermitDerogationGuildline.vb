...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'PermitDerogationGuildline'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class PermitDerogationGuildline
        Inherits Base.PermitDerogationGuildlineBase
