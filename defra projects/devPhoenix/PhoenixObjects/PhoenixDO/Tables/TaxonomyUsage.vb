...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'TaxonomyUsage'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class TaxonomyUsage
        Inherits Base.TaxonomyUsageBase
