...
Namespace DataObjects.Entity
    ...
    'Entity implementation for table 'SeizureNotification'
    '*DO* add your modifications to this file
    <System.Serializable()>  _
    Public Class SeizureNotification
        Inherits Base.SeizureNotificationBase
