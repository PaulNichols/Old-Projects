...
Namespace Controls.Data
    <ToolboxBitmap(GetType(Web.UI.WebControls.TextBox)), _
    DefaultProperty("Text"), _
    System.Web.UI.ToolboxDataAttribute("<{0}:DataTextBox runat='server' CssClass='smalltext' Width='232px'></{0}:DataTextBox>")> _
    Public Class DataTextBox
        Inherits System.Web.UI.WebControls.TextBox
        Implements IDataControl, IChangableDataControl

        'Override OnLoad to handle displaying password characters from
        ...
        Protected Overrides Sub OnLoad(ByVal e As EventArgs)
            ...
            If TextMode = Web.UI.WebControls.TextBoxMode.Password Then
...
#Region "IwwWebDataControl Property Implementation"
        ...
        <Category("Data"), _
        DefaultValue("Text")> _
        Public Overridable Property BindingProperty() As String Implements IDataControl.BindingProperty
            Get
...
#Region "IwwWebDataControl Methods Implementation"
        ...
        Public Sub BindData(ByVal WebForm As Web.UI.Control) Implements IDataControl.BindData
            ...
            AddHandler Me.TextChanged, AddressOf ValueChanged
        End Sub
        ...
        Public Sub UnbindData(ByVal WebForm As Web.UI.Control) Implements IDataControl.UnbindData
            ...
            RemoveHandler Me.TextChanged, AddressOf ValueChanged
        End Sub
